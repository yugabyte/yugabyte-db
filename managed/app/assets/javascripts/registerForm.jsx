          ...
          <div className="panel panel-default login-panel">
            ...
            <div className="panel-body">
              <form id="registerForm" onSubmit={this.handleSubmit}>
                <fieldset>
                  <YBInputBox name="name" type="text" placeholder="Name" label="Name" />
                  <YBInputBox name="email" type="text" placeholder="E-mail" label="E-mail" />
                  <YBInputBox name="password" type="password" placeholder="Password" label="Password" />
