...
create table instance_info (
  ...
  edit_instance_details         clob,
  constraint pk_instance_info primary key (instance_uuid)
);

create table meta_master_entry (
  instance_uuid                 uuid not null,
  masters_json                  clob not null,
  constraint pk_meta_master_entry primary key (instance_uuid)
);
...
drop table if exists meta_master_entry;
