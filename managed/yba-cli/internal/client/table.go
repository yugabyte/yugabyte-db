...
func (a *AuthAPIClient) GetAllTables(uUUID string) (
...
func (a *AuthAPIClient) DescribeTable(uUUID, tUUID string) (
...
func (a *AuthAPIClient) GetAllNamespaces(uUUID string) (
...
func (a *AuthAPIClient) GetAllTableSpaces(uUUID string) (
