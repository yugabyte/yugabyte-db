## yba alert channel webhook delete

Delete YugabyteDB Anywhere webhook alert channel

### Synopsis

Delete an webhook alert channel in YugabyteDB Anywhere

```
yba alert channel webhook delete [flags]
```

### Examples

```
yba alert channel webhook delete --name <alert-channel-name>
```
