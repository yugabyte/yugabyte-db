## yba provider gcp instance-type remove

Delete instance type of a YugabyteDB Anywhere GCP provider

### Synopsis

Delete instance types of a YugabyteDB Anywhere GCP provider

```
yba provider gcp instance-type remove [flags]
```
