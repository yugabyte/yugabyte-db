## yba alert channel slack describe

Describe a YugabyteDB Anywhere slack alert channel

### Synopsis

Describe an slack alert channel in YugabyteDB Anywhere

```
yba alert channel slack describe [flags]
```

### Examples

```
yba alert channel slack describe --name <alert-channel-name>
```
