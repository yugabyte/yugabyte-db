## yba alert channel pagerduty delete

Delete YugabyteDB Anywhere PagerDuty alert channel

### Synopsis

Delete an PagerDuty alert channel in YugabyteDB Anywhere

```
yba alert channel pagerduty delete [flags]
```

### Examples

```
yba alert channel pagerduty delete --name <alert-channel-name>
```
