## yba provider aws instance-type list

List instance types of a YugabyteDB Anywhere AWS provider
...
```
yba provider aws instance-type list [flags]
```

### Examples

```
yba provider aws instance-type list --name <provider-name>
```
