## yba provider gcp instance-type describe

Describe instance type of a YugabyteDB Anywhere GCP provider

### Synopsis

Describe instance types of a YugabyteDB Anywhere GCP provider

```
yba provider gcp instance-type describe [flags]
```

### Examples

```
yba provider gcp instance-type describe --instance-type-name <instance-type-name>
```
