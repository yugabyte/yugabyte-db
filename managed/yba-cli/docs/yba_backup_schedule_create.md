...
```
      --schedule-name string                       [Required] Schedule name. Name of the schedule to perform universe backups
      --cron-expression string                     Cron expression to manage the backup schedules
      --schedule-frequency-in-secs int             Backup frequency to manage the backup schedules
      --incremental-backup-frequency-in-secs int   Incremental backup frequency to manage the incremental backup schedules
