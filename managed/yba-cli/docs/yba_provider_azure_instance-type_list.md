## yba provider azure instance-type list

List instance types of a YugabyteDB Anywhere Azure provider
...
```
yba provider azure instance-type list [flags]
```

### Examples

```
yba provider azure instance-type list --name <provider-name>
```
