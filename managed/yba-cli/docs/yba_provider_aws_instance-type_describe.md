## yba provider aws instance-type describe

Describe instance type of a YugabyteDB Anywhere AWS provider

### Synopsis

Describe instance types of a YugabyteDB Anywhere AWS provider

```
yba provider aws instance-type describe [flags]
```

### Examples

```
yba provider aws instance-type describe --instance-type-name <instance-type-name>
```
