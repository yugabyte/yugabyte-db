...
```
  -u, --uuid string                          [Required] The uuid of the xcluster to update.
      ...
      --parallelism int                      [Optional] Number of concurrent commands to run on nodes over SSH via "yb_backup" script. Ignored when skip-full-copy-tables is set to true. (default 8)
