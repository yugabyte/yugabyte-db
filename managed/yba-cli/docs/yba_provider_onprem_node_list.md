...
List node instances of a YugabyteDB Anywhere on-premises provider

### Synopsis

List node instance of a YugabyteDB Anywhere on-premises provider

```
yba provider onprem node list [flags]
```

### Examples

```
yba provider onprem node list --name <provider-name>
```
