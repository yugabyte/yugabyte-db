## yba storage-config azure describe

Describe an Azure YugabyteDB Anywhere storage configuration

### Synopsis

Describe an Azure storage configuration in YugabyteDB Anywhere
