## yba alert channel email list

List YugabyteDB Anywhere email alert channels

### Synopsis

List email alert channels in YugabyteDB Anywhere

```
yba alert channel email list [flags]
```
