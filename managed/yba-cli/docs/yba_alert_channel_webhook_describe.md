## yba alert channel webhook describe

Describe a YugabyteDB Anywhere webhook alert channel

### Synopsis

Describe an webhook alert channel in YugabyteDB Anywhere

```
yba alert channel webhook describe [flags]
```

### Examples

```
yba alert channel webhook describe --name <alert-channel-name>
```
