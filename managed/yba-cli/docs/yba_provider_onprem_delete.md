## yba provider onprem delete

Delete an On-premises YugabyteDB Anywhere provider

### Synopsis

Delete an On-premises provider in YugabyteDB Anywhere

```
yba provider onprem delete [flags]
```

### Examples

```
yba provider onprem delete --name <provider-name>
```
