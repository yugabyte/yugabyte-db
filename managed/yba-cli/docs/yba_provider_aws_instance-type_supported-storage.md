## yba provider aws instance-type supported-storage

List supported storage types for a YugabyteDB Anywhere AWS (EBS) instance type
...
```
yba provider aws instance-type supported-storage [flags]
```
