## yba alert channel webhook list

List YugabyteDB Anywhere webhook alert channels

### Synopsis

List webhook alert channels in YugabyteDB Anywhere

```
yba alert channel webhook list [flags]
```
