## yba alert channel slack list

List YugabyteDB Anywhere slack alert channels

### Synopsis

List slack alert channels in YugabyteDB Anywhere

```
yba alert channel slack list [flags]
```
