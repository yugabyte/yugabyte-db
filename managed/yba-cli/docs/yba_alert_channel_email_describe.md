## yba alert channel email describe

Describe a YugabyteDB Anywhere email alert channel

### Synopsis

Describe an email alert channel in YugabyteDB Anywhere

```
yba alert channel email describe [flags]
```

### Examples

```
yba alert channel email describe --name <alert-channel-name>
```
