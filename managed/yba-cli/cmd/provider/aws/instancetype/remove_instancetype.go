...
var removeInstanceTypesCmd = &cobra.Command{
	...
	Short:   "Delete instance type of a YugabyteDB Anywhere AWS provider",
	Long:    "Delete instance types of a YugabyteDB Anywhere AWS provider",
	Example: `yba provider aws instance-type remove \
