...
var addInstanceTypesCmd = &cobra.Command{
	...
	Short:   "Add an instance type to YugabyteDB Anywhere AWS provider",
	Long:    "Add an instance type to YugabyteDB Anywhere AWS provider",
	Example: `yba provider aws instance-type add \
...
func init() {
	...
	addInstanceTypesCmd.Flags().
		String("arch", "x86_64", "[Optional] Architecture of the instance type. Allowed values: x86_64, arm64/aarch64.")
	addInstanceTypesCmd.Flags().StringArray("volume", []string{},
		"[Optional] Volumes associated per node of an instance type."+
			...
			" Volume type (Defaults to EBS, Allowed values: EBS, SSD, HDD, NVME)"+
