...
var listInstanceTypesCmd = &cobra.Command{
	Use:     "list",
	Aliases: []string{"ls"},
	Short:   "List instance types of a YugabyteDB Anywhere AWS provider",
	Long:    "List instance types of a YugabyteDB Anywhere AWS provider",
	Example: `yba provider aws instance-type list --name <provider-name>`,
