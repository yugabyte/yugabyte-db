...
var addInstanceTypesCmd = &cobra.Command{
	...
	Short:   "Add an instance type to YugabyteDB Anywhere GCP provider",
	Long:    "Add an instance type to YugabyteDB Anywhere GCP provider",
	Example: `yba provider gcp instance-type add \
