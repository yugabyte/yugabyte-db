...
var describeInstanceTypesCmd = &cobra.Command{
	Use:     "describe",
	Aliases: []string{"get"},
	Short:   "Describe instance type of a YugabyteDB Anywhere GCP provider",
	Long:    "Describe instance types of a YugabyteDB Anywhere GCP provider",
	Example: `yba provider gcp instance-type describe --instance-type-name <instance-type-name>`,
