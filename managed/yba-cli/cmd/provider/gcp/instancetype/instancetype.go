...
// InstanceTypesCmd set of commands are used to perform operations on gcp instanceTypes
// in YugabyteDB Anywhere
var InstanceTypesCmd = &cobra.Command{
	Use:     "instance-type",
	Aliases: []string{"instance-types", "instancetypes", "instancetype"},
	Short:   "Manage YugabyteDB Anywhere GCP instance types",
	Long:    "Manage YugabyteDB Anywhere GCP instance types",
