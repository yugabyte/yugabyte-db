...
| "Granular level metrics" | "yb.ui.feature_flags.granular_metrics" | "UNIVERSE" | "View granular level metrics when user selects specific time period in a chart" | "Boolean" |
