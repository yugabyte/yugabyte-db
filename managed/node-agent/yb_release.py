...
NODE_AGENT_PLATFORMS = set(["linux/amd64", "linux/arm64", "linux/ppc64le"])
...
def is_ppc64le(filename):
    return "ppc64le" in filename or "ppc64" in filename
