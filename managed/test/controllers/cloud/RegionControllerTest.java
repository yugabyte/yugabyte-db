...
public class RegionControllerTest extends FakeDBApplication {
	...
	public void testListRegionsWithValidProviderUUID() {
		String authToken = customer.createAuthToken();
		Region r = Region.create(provider, "foo-region", "Foo Region", true);
	...
	public void testListRegionsWithMultiAZOption() {
		String authToken = customer.createAuthToken();
		Region r1 = Region.create(provider, "region-1", "Region 1", true);
		Region r2 = Region.create(provider, "region-2", "Region 2", false);
