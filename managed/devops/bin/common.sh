...
readonly PYTHON3_EXECUTABLES=('python3.10' 'python3.11' 'python3.12' 'python3.13' 'python3.14'
                              'python3')
readonly PYTHON3_VERSIONS=('python3.10' 'python3.11' 'python3.12' 'python3.13' 'python3.14')
readonly LINUX_PLATFORMS=('manylinux_2_28_x86_64-cp-310-cp310' 'manylinux_2_28_x86_64-cp-311-cp311'
                          ...
                          'manylinux_2_28_x86_64-cp-314-cp314')
readonly MACOS_PLATFORMS=('macosx-10.10-x86_64-cp-310-cp310' 'macosx-10.10-x86_64-cp-311-cp311'
                          ...
                          'macosx-10.10-x86_64-cp-314-cp314')
