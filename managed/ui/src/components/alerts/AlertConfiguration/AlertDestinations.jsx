  ...
  <>
    <FlexContainer>
      ...
      <FlexShrink className="pull-right">
        {!isReadOnly && (
          <RbacValidator accessRequiredOn={ApiPermissionMap.CREATE_ALERT_DESTINATION} isControl>
...
export const AlertDestinations = (props) => {
        ...
        >
          ...
          <RbacValidator accessRequiredOn={ApiPermissionMap.MODIFY_ALERT_DESTINATION} isControl>
            <MenuItem
              ...
              onClick={() => canEditDestination && onEditDestination(row)}
            >
          ...
          {!isReadOnly && (
            ...
            >
              <MenuItem
                onClick={() => canDeleteDestination && showDeleteModal(row.name)}
  ...
  return (
    <RbacValidator accessRequiredOn={ApiPermissionMap.GET_ALERT_DESTINATIONS}>
      <>
        <YBPanelItem
