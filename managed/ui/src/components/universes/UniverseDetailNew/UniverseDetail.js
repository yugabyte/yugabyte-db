...
import { UniverseResourcesNew } from '../UniverseResources';
      ...
      <Tab eventKey={"overview"} title="Overview" key="overview-tab" mountOnEnter={true} unmountOnExit={true}>
        <YBPanelItem noBackground
          header={
            <FlexContainer>
              <FlexGrow>
                <UniverseResourcesNew split='left' resources={currentUniverse.data.resources} renderType={"Display"}/>
              </FlexGrow>
              <FlexShrink>
                <div className="operating-costs">
                  <UniverseResourcesNew split='right' resources={currentUniverse.data.resources} renderType={"Display"}/>
                </div>
              </FlexShrink>
            </FlexContainer>
          }
