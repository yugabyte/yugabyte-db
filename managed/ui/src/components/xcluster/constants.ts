...
export const AUTOMATIC_DDL_REPLICATION_VERSION_THRESHOLD_STABLE = '2025.1.0.0-b167';
export const AUTOMATIC_DDL_REPLICATION_VERSION_THRESHOLD_PREVIEW = '2.25.1.0-b0';
