...
export const AlertTemplate = {
  ...
  NODE_AGENT_DOWN: 'NODE_AGENT_DOWN',
  NODE_AGENT_MISSING: 'NODE_AGENT_MISSING',
  NODE_AGENT_SERVER_CERT_EXPIRY: 'NODE_AGENT_SERVER_CERT_EXPIRY',
  NODE_AGENT_SERVER_CERT_EXPIRY_NON_UNIVERSE: 'NODE_AGENT_SERVER_CERT_EXPIRY_NON_UNIVERSE',
