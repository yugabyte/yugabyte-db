...
const MODAL_NAME = 'RestoreYbaBackupModal';
const TRANSLATION_KEY_PREFIX = 'continuousBackup.restoreYbaBackupModal';
          ...
          {customerConfigsQuery.data?.length === 0 && (
            <div className={classes.configureBackupStorageConfigBanner}>
              ...
              <div className={classes.bannerContent}>
                ...
                >
                  {t('cloudBackup.configureBackupStorageConfigPrompt.configureBackupStorageButton')}
                </YBButton>
              </div>
            </div>
          )}
