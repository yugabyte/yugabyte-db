...
export const ResilienceTypeField = <T extends FieldValues>({
    name,
}: ResilienceTypeProps<T>) => {
    const { control } = useFormContext<T>();
    const { t } = useTranslation('translation', { keyPrefix: 'createUniverseV2.resilienceAndRegions.resilienceType' });
