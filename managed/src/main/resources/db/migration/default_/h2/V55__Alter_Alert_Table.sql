...
create table alert_definition (
  ...
  constraint fk_ad_customer_uuid foreign key (customer_uuid) references customer (uuid),
  constraint fk_ad_universe_uuid foreign key (universe_uuid) references universe (universe_uuid)
);
