...
public class ErrorHandler extends DefaultHttpErrorHandler {
  ...
  protected CompletionStage<Result> onDevServerError(
    ...
    return CompletableFuture.completedFuture(handleExceptions(exception));
  }
  ...
  private Result handleExceptions(Throwable t) {
    // TODO: Handle exception that need special response (return a special apimodel, notFound(),
    // etc..)
    return ok();
  }
}
