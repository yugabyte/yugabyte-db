...
public class FreezeUniverse extends UniverseDefinitionTaskBase {
  ...
  public void initialize(ITaskParams params) {
    ...
    Objects.requireNonNull(taskParams().universeUUID, "Universe UUID cannot be null");
  }
  ...
  public void run() {
    UniverseUpdaterConfig updaterConfig =
        UniverseUpdaterConfig.builder()
            ...
            .freezeUniverse(true)
            .build();
    saveUniverseDetails(taskParams().universeUUID, getFreezeUniverseUpdater(updaterConfig));
  }
}
