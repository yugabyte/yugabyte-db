...
public class TaskExecutor {
  ...
  public RunnableTask createRunnableTask(
      TaskType taskType, ITaskParams taskParams, @Nullable UUID taskUUID) {
    ...
    return createRunnableTask(task, taskUUID, taskParams.getPreviousTaskUUID());
  }
   ...
   * @param taskUUID optional task UUID.
   */
  public RunnableTask createRunnableTask(ITask task, @Nullable UUID taskUUID) {
