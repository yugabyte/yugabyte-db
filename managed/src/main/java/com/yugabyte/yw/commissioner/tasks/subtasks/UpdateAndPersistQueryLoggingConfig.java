...
@Slf4j
public class UpdateAndPersistQueryLoggingConfig extends UniverseTaskBase {

  @Inject
  protected UpdateAndPersistQueryLoggingConfig(BaseTaskDependencies baseTaskDependencies) {
