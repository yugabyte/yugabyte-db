...
public class ModifyQueryLoggingConfig extends UpgradeTaskBase {
    ...
    runUpgrade(
        () -> {
          ...
          for (UniverseDefinitionTaskParams.Cluster curCluster : curClusters) {
            ...
            // To be added in https://yugabyte.atlassian.net/browse/PLAT-18151
  ...
  //   UpdateAndPersistQueryLoggingConfig task =
  // createTask(UpdateAndPersistQueryLoggingConfig.class);
