...
public abstract class UniverseTaskBase extends AbstractTaskBase {
  ...
  private UniverseUpdater getLockingUniverseUpdater(
      int expectedUniverseVersion, boolean checkSuccess, boolean isForceUpdate) {
  ...
  public SubTaskGroup createWaitForServersTasks(
      Collection<NodeDetails> nodes, ServerType type, long timeoutMillis) {
  ...
  public boolean instanceExists(NodeTaskParams taskParams) {
    ...
    ShellProcessHandler.ShellResponse response =
        nodeManager.nodeCommand(NodeManager.NodeCommandType.List, taskParams);
