      ...
      Universe.UniverseUpdater updater = new Universe.UniverseUpdater() {
        ...
        public void run(Universe universe) {
          ...
          if (isNodeRemovable(taskParams().nodeName, universeDetails.nodeDetailsSet)) {
            ...
            updatePlacementInfo(universeDetails.nodeDetailsSet, universeDetails.placementInfo);
            // Update userIntent to reflect new numNodes
            universeDetails.userIntent.numNodes = universeDetails.nodeDetailsSet.size();
