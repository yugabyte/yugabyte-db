...
public class XClusterConfigController extends AuthenticatedController {
              ...
              .filter(
                  xClusterConfig ->
                      !xClusterConfig
                          ...
                          .equals(sourceUniverse.getUniverseUUID()))
              .map(xClusterConfig -> xClusterConfig.getSourceUniverseUUID())
  ...
  public Result needBootstrapTable(
      UUID customerUuid, UUID sourceUniverseUuid, Http.Request request) {
