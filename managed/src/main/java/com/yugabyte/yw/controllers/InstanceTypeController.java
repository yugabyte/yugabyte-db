...
public class InstanceTypeController extends AuthenticatedController {
  ...
  @ApiOperation(
      ...
      responseContainer = "List", nickname="listOfInstanceType")
  @ApiResponses(
   ...
   */
  @ApiOperation(value = "create Instance type", response = InstanceType.class, nickname="createInstanceType")
  @ApiImplicitParams(
      @ApiImplicitParam(
          name = "instance type",
   ...
   */
  @ApiOperation(value = "delete", response = YWResults.YWSuccess.class, nickname="deleteInstanceType")
  ...
  @ApiOperation(
      ...
      response = InstanceType.class, nickname="instanceTypeDetail")
