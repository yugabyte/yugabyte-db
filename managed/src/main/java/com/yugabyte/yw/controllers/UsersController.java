...
public class UsersController extends AuthenticatedController {
   ...
   */
  @ApiOperation(value = "List of Users", response = Users.class, responseContainer = "List", nickname="ListOfUsers")
   ...
   */
  @ApiOperation(value = "Delete customer", response = YWResults.YWSuccess.class, nickname="deleteUsers")
