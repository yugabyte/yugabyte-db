...
public class UsersController extends AuthenticatedController {
  ...
  public Result create(UUID customerUUID) {
    ...
    Form<UserRegisterFormData> formData =
        formFactory.form(UserRegisterFormData.class).bindFromRequest();
    ...
    try {
      user =
          Users.create(
              formData.get().email, formData.get().password, formData.get().role, customerUUID);
      updateFeatures(user);
    } catch (Exception e) {
