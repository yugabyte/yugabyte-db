...
public interface StorageUtil {
  ...
  public static <T extends StorageUtil> T getStorageUtil(String configType) {
    ...
    switch (configType) {
      case Util.S3:
        return (T) injector.instanceOf(AWSUtil.class);
      case Util.GCS:
        return (T) injector.instanceOf(GCPUtil.class);
      case Util.AZ:
        return (T) injector.instanceOf(AZUtil.class);
      case Util.NFS:
        return (T) injector.instanceOf(NFSUtil.class);
      default:
