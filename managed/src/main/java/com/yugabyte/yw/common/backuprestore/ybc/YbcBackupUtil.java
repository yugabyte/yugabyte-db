...
public class YbcBackupUtil {
  ...
  public static TablesMetadata getTableListFromSuccessMarker(
    ...
    // Map to return
    Map<String, TablesMetadata.TableDetails> tablesToReturn = new ConcurrentHashMap<>();
    ...
    successMarker.snapshotObjectDetails.parallelStream()
        ...
        .forEach(
            sOD -> {
              ...
              tablesToReturn.put(tableName, new TablesMetadata.TableDetails(tableUUID));
      ...
      successMarker.snapshotObjectDetails.parallelStream()
          ...
          .forEach(
              sOD -> {
                ...
                TablesMetadata.TableDetails tDetails = tablesToReturn.get(parentTableName);
                ...
                tablesToReturn
                    ...
                    .indexTableRelations
                    .add(
                        new TablesMetadata.TableDetails.IndexTable(indexTableUUID, indexTableName));
              });
    }
