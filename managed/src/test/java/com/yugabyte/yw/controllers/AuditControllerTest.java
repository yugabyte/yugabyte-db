...
public class AuditControllerTest extends FakeDBApplication {
  ...
  public void setUp() {
    ...
    params.put("foo", "bar");
    audit1 = Audit.create(user1, "/test/call", "GET", params, null, null);
    taskUUID1 = UUID.randomUUID();
    taskUUID2 = UUID.randomUUID();
    audit2 = Audit.create(user1, "/test/call1", "DELETE", params, taskUUID1, null);
    audit3 = Audit.create(user2, "/test/call2", "PUT", params, taskUUID2, null);
    audit4 = Audit.create(user2, "/test/call4", "GET", params, null, null);
  }
