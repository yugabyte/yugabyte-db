...
public class PitrControllerTest extends FakeDBApplication {
  ...
  public void testListPitrConfigs() throws Exception {
    ...
    params1.universeUUID = defaultUniverse.getUniverseUUID();
    ...
    params2.universeUUID = defaultUniverse.getUniverseUUID();
    ...
    params3.universeUUID = defaultUniverse.getUniverseUUID();
  ...
  public void testDeletePitrConfig() throws Exception {
    ...
    RequestContext.put("user", new UserWithFeatures().setUser(defaultUser));
