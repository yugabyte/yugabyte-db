...
public class RuntimeConfControllerTest extends FakeDBApplication {
  ...
  public void key() {
    assertEquals(
        NOT_FOUND,
        assertYWSE(() -> getKey(defaultUniverse.universeUUID, GC_CHECK_INTERVAL_KEY)).status());
  ...
  public void keyObj() {
    ...
    assertEquals(
        NOT_FOUND,
        assertYWSE(() -> getKey(defaultUniverse.universeUUID, EXT_SCRIPT_SCHEDULE_KEY)).status());
    ...
    assertEquals(
        ...
        NOT_FOUND,
        assertYWSE(() -> deleteKey(defaultUniverse.universeUUID, EXT_SCRIPT_SCHEDULE_KEY))
            .status());
    ...
    assertEquals(
        ...
        NOT_FOUND,
        assertYWSE(() -> getKey(defaultUniverse.universeUUID, EXT_SCRIPT_KEY)).status());
  }
  ...
  public void testFailingListener() {
    ...
    assertEquals(
        ...
        assertYWSE(() -> setGCInterval(newInterval, defaultUniverse.universeUUID)).status());
    assertEquals(
        NOT_FOUND,
        assertYWSE(() -> getKey(defaultUniverse.universeUUID, GC_CHECK_INTERVAL_KEY)).status());
  }
