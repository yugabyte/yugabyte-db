...
public class UniverseManagementApiControllerImpTest extends UniverseControllerTestBase {
  ...
  private PlacementRegion getOrCreatePlacementRegion(PlacementCloud placementCloud, Region region) {
  ...
  private PlacementAZ getOrCreatePlacementAz(
  ...
  private PlacementCloud fromProvider(int numNodesToPlace, int rfTotal) {
  ...
  public void testCreateUniverseV2() throws ApiException {
    ...
    PlacementCloud placementCloud =
        fromProvider(primaryClusterSpec.getNumNodes(), primaryClusterSpec.getReplicationFactor());
  ...
  private void validateUniverseSpec(UniverseSpec v2UnivSpec, Universe dbUniv) {
    UserIntent dbUserIntent = dbUniv.getUniverseDetails().getPrimaryCluster().userIntent;
    ...
    validateUniverseNetworkginSpec(v2UnivSpec.getNetworkingSpec(), dbUniv.getUniverseDetails());
