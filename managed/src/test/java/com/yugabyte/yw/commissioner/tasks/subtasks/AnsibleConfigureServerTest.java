...
public class AnsibleConfigureServerTest extends FakeDBApplication {
  ...
  private ListMastersResponse mastersResponse;

  @Before
  public void setup() {
    defaultCustomer = ModelFactory.testCustomer();
    setupUniverse(Common.CloudType.onprem);
    mastersResponse = mock(ListMastersResponse.class);
    ...
    try {
      ...
      when(mockYBClient.listMasters()).thenReturn(mastersResponse);
    } catch (Exception e) {
      fail();
    }
    when(mastersResponse.getMasters()).thenReturn(servers);
  }
