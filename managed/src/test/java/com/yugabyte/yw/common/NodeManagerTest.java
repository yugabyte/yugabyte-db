...
public class NodeManagerTest extends FakeDBApplication {
  ...
  private CertificateInfo createCertificate(
    ...
    createTempFile("node_manager_test_ca.crt", TestUtils.readResource("platform.dev.crt"));
  ...
  public void testPrecheckCheckCertificates() throws IOException, NoSuchAlgorithmException {
    ...
    checkArguments(
        ...
        "--yba_root_cert_fingerprint",
        CertificateHelper.computeFingerprint(certificateInfo.getCertificate()),
        "--node_server_cert_path",
  ...
  public void testPrecheckCheckBothCertificatesWithClientPaths()
    ...
    checkArguments(
        ...
        "--yba_root_cert_fingerprint",
        CertificateHelper.computeFingerprint(cert.getCertificate()),
        "--node_server_cert_path",
        ...
        "--yba_client_root_cert_fingerprint",
        CertificateHelper.computeFingerprint(cert2.getCertificate()),
        "--client_server_cert_path",
