...
public class KubernetesPartitionIteratorTest {
  ...
  public void testNoBatchesOnlyMastersChanged() {
    Iterator<KubernetesPartitions.KubernetesPartition> iterator =
        getIterator(3, UniverseTaskBase.ServerType.MASTER, false, 3, 3, 1);
    assertValues(iterator, 2, 3, 2);
    assertValues(iterator, 1, 3, 1);
    assertValues(iterator, 0, 3, 0);
  ...
  public void testNoBatchesOnlyTserversChanged() {
    Iterator<KubernetesPartitions.KubernetesPartition> iterator =
        getIterator(3, UniverseTaskBase.ServerType.TSERVER, false, 3, 3, 1);
  ...
  public void testNoBatchesBothChanged() {
    ...
    Iterator<KubernetesPartitions.KubernetesPartition> iterator =
        getIterator(
            numMasters, UniverseTaskBase.ServerType.MASTER, false, numMasters, numTservers, 1);
    ...
    iterator =
        getIterator(
            numTservers, UniverseTaskBase.ServerType.TSERVER, false, numMasters, numTservers, 1);
  ...
  public void testBatch2MastersChanged() {
    Iterator<KubernetesPartitions.KubernetesPartition> iterator =
        getIterator(3, UniverseTaskBase.ServerType.MASTER, false, 3, 3, 2);
    assertValues(iterator, 2, 3, 2);
    assertValues(iterator, 1, 3, 1);
    assertValues(iterator, 0, 3, 0);
    assertFalse(iterator.hasNext());
  ...
  public void testBatch2BothChanged() {
    ...
    Iterator<KubernetesPartitions.KubernetesPartition> iterator =
        getIterator(
            numMasters, UniverseTaskBase.ServerType.MASTER, false, numMasters, numTservers, 2);
    assertValues(iterator, 2, 4, 2);
    assertValues(iterator, 1, 4, 1);
    assertValues(iterator, 0, 4, 0);
    assertFalse(iterator.hasNext());
    ...
    iterator =
        getIterator(
            numTservers, UniverseTaskBase.ServerType.TSERVER, false, numMasters, numTservers, 2);
  ...
  public void testBatch2and5TserversChanged() {
    Iterator<KubernetesPartitions.KubernetesPartition> iterator =
        getIterator(5, UniverseTaskBase.ServerType.TSERVER, false, 3, 5, 2);
  ...
  public void testBatch3and10TserversChanged() {
    Iterator<KubernetesPartitions.KubernetesPartition> iterator =
        getIterator(10, UniverseTaskBase.ServerType.TSERVER, false, 3, 10, 3);
  ...
  public void testBatch4and3TserversChanged() {
    Iterator<KubernetesPartitions.KubernetesPartition> iterator =
        getIterator(3, UniverseTaskBase.ServerType.TSERVER, false, 2, 3, 4);
    assertValues(iterator, 2, 0, 0, 1, 2);
    assertFalse(iterator.hasNext());
  }
  ...
  public void testBatch2ReadOnlyTserversChanged() {
    Iterator<KubernetesPartitions.KubernetesPartition> iterator =
        getIterator(4, UniverseTaskBase.ServerType.TSERVER, true, 0, 4, 2);
