...
public class OutputFilesComponentTest extends FakeDBApplication {
  ...
  public void setUp() throws IOException, ParseException {
    ...
    createTempFile(fakeSourceComponentPath + "master/", "master.out", "test-output-files-content");
    createTempFile(
        fakeSourceComponentPath + "tserver/", "tserver.out", "test-output-files-content");
  ...
  public void testDownloadComponentBetweenDates() throws IOException, ParseException {
    ...
    OutputFilesComponent outputFilesComponent =
        new OutputFilesComponent(mockUniverseInfoHandler, mockNodeUniverseManager);
    ...
    Boolean isDestDirCreated = new File(fakeBundlePath + "/output_files").exists();
