...
<a href='https://github.com/yugabyte/internal-devops/blob/master/bin/setup_workstation.sh'>
setup_workstation.sh --yugaware</a>.
It will install all the required dev tools + will create local PG and Prometheus docker containers,
required for YBA to run locally.
