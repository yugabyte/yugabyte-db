...
libraryDependencies += "org.yb" % "ybc-client" % "1.0.0-b37"
libraryDependencies += "org.yb" % "yb-client" % "0.8.55.7-SNAPSHOT"
libraryDependencies += "org.yb" % "yb-perf-advisor" % "1.0.0-b31" excludeAll(
