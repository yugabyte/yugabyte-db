...
SW_UPGRADE_URL = BASE_URL + \
    "/customers/{customer_uuid}/universes/{universe_uuid}/upgrade/software"
...
task_params = {
    ...
    "ybSoftwareVersion": "2.17.1.0-b377",
}
...
response = requests.post(SW_UPGRADE_URL
