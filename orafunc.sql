...
CREATE RULE noins_dual AS ON INSERT TO dual DO NOTHING;
CREATE RULE nodel_dual AS ON DELETE TO dual DO NOTHING;
CREATE RULE noupd_dual AS ON UPDATE TO dual DO NOTHING;
