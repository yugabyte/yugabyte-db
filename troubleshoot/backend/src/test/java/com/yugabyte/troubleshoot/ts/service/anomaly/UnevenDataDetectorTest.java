  ...
  public void testUnevenDataDetection() {
    ...
    String promQuery =
        "http://localhost:9090/api/v1/query_range?query="
            + "sum(max%20without%20(metric_type)(last_over_time(%7B"
            + "saved_name%3D~%22rocksdb_current_version_sst_files_size%7Clog_wal_size%22,%20"
            + "export_type%3D%22tserver_export%22,%20"
            + "universe_uuid%3D%2259b6e66f-83ed-4fff-a3c6-b93568237fab%22%7D%5B10800s%5D)))"
            + "%20by%20(exported_instance,%20table_id,%20table_name,%20namespace_name)%20and%20"
            + "topk(2147483647,%20sum(max%20without%20(metric_type)(last_over_time(%7B"
            + "saved_name%3D~%22rocksdb_current_version_sst_files_size%7Clog_wal_size%22,%20"
            + "export_type%3D%22tserver_export%22,%20"
            + "universe_uuid%3D%2259b6e66f-83ed-4fff-a3c6-b93568237fab%22%7D%5B10800s%5D"
            + "@1705600800)))%20by%20"
            + "(exported_instance,%20table_id,%20table_name,%20namespace_name))"
