...
public class DoubleConverter implements SimpleTypeConverter {
  ...
  public static DoubleConverter create(SimpleTypeConverterConfiguration configuration) {
    return new DoubleConverter(configuration);
  }

  protected DoubleConverter(SimpleTypeConverterConfiguration configuration) {}

  /** {@inheritDoc} */
  public final synchronized Double fromString(String value) {
