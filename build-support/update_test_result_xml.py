...
def main():
  ...
  parser = argparse.ArgumentParser(
    ...
    description="Updates a JUnit-formatted test result XML to include the given URL " +
      "pointing to the test log. We need this so we can navigate directly to the test log " +
      "from a test result page such as https://jenkins.dev.yugabyte.com/job/" +
      "yugabyte-ubuntu-phabricator/131/testReport/junit/(root)/ClientTest/TestInvalidPredicates/.")
