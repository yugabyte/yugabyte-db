...
SELECT * FROM create_graph('cypher_scan');
--
-- multi-line comment
--

SELECT * FROM cypher('cypher_scan', $$
/*
 * multi-line comment
 */
RETURN 0
...
SELECT * FROM cypher('cypher_scan', $$RETURN "unterminated quoted string$$) AS t(a text);
-- recover syntax highlighting "

SELECT * FROM cypher('cypher_scan', $$RETURN 'unterminated quoted string$$) AS t(a text);
-- recover syntax highlighting '

SELECT * FROM cypher('cypher_scan', $$RETURN "escape \$$) AS t(a text);
-- recover syntax highlighting "

SELECT * FROM cypher('cypher_scan', $$RETURN "high surrogate \uD835$$) AS t(a text);
-- recover syntax highlighting "
...
SELECT * FROM cypher('cypher_scan', $cypher$
RETURN $$
$cypher$) AS t(a text);
...
SELECT * FROM drop_graph('cypher_scan');
