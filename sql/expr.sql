...
SELECT * FROM create_graph('cypher_expr');
--
-- map literal
--

-- empty map
SELECT * FROM cypher('cypher_expr', $$RETURN {}$$) AS r(c agtype);

-- map of scalar values
SELECT * FROM cypher('cypher_expr', $$
...
SELECT * FROM cypher('cypher_expr', $$RETURN ['str', 1, 1.0, true, null]$$) AS r(c agtype);
...
SELECT $1, * FROM cypher('cypher_expr', $$
RETURN $var
$$) AS t(i agtype);
...
SELECT * FROM cypher('cypher_expr', $$RETURN 'str' + 'str'$$) AS r(c agtype);

-- String LHS + Integer RHS

SELECT * FROM cypher('cypher_expr', $$RETURN 'str' + 1$$) AS r(c agtype);

-- String LHS + Float RHS

SELECT * FROM cypher('cypher_expr', $$RETURN 'str' + 1.0$$) AS r(c agtype);

-- Integer LHS + String LHS

SELECT * FROM cypher('cypher_expr', $$RETURN 1 + 'str'$$) AS r(c agtype);

-- Float LHS + String RHS

SELECT * FROM cypher('cypher_expr', $$RETURN 1.0 + 'str'$$) AS r(c agtype);
...
SELECT * FROM drop_graph('cypher_expr', true);
--
-- End of tests
--
