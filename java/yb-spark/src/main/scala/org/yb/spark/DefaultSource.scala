...
class DefaultSource extends RelationProvider {
  ...
  BaseRelation = {
    ...
    new YBRelation(tableName.get, kuduMaster)(sqlContext)
  }
}
...
/**
  ...
  *
  * @param tableName YB table that we plan to read from
  * @param kuduMaster YB master addresses
  * @param sqlContext SparkSQL context
  */
@InterfaceStability.Unstable
class YBRelation(val tableName: String,
  ...
  // deserialize them.
  @transient lazy val kuduContext = new YBContext(kuduMaster)
  ...
  /**
    ...
    *
    * @return schema generated from the YB table's schema
    */
  ...
  /**
    ...
    * @return                RDD will all the results from YB
    */
