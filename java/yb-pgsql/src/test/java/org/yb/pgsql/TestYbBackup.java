...
public class TestYbBackup extends BasePgSQLTest {
  ...
  public void testBackupDropColumn() throws Exception {
    testPgRegressStyleUtil(
      ...
      "sql/yb.orig.backup_drop_column.sql",
      "db2",
      "expected/yb.orig.backup_drop_column.out",
      "sql/yb.orig.backup_drop_column_describe.sql",
      "expected/yb.orig.backup_drop_column_describe.out"
    );
  }
