  ...
  public void testSeqScan() throws Exception {
    ...
    try (Statement stmt = connection.createStatement()) {
      Checker checker = makeTopLevelBuilder()
          ...
          .storageReadOps(Checkers.equal(5))
    ...
    try (Statement stmt = connection.createStatement()) {
      testExplain(
        ...
        makeTopLevelBuilder()
            ...
            .storageReadExecutionTime(Checkers.greater(0.0))
            .storageReadOps(Checkers.equal(1))
    ...
    try (Statement stmt = connection.createStatement()) {
      ...
      testExplain(
        ...
        makeTopLevelBuilder()
          ...
          .storageReadExecutionTime(Checkers.greater(0.0))
          .storageReadOps(Checkers.equal(8))
    ...
    try (Statement stmt = connection.createStatement()) {
      ...
      testExplain(
        ...
        makeTopLevelBuilder()
            ...
            .storageReadExecutionTime(Checkers.greater(0.0))
            .storageReadOps(Checkers.equal(4))
  ...
  public void testNestedLoop() throws Exception {
    ...
    testExplain(
      ...
      makeTopLevelBuilder()
          ...
          .storageReadExecutionTime(Checkers.greater(0.0))
          .storageReadOps(Checkers.greater(((numLoops - 1) * 8) + 1))
  ...
  public void testUpdateUsingIndex() throws Exception {
    ...
    testExplain(
        ...
        makeTopLevelBuilder()
            ...
            .storageReadExecutionTime(Checkers.greater(0.0))
            .storageReadOps(Checkers.equal(2))
  ...
  public void testDeleteReturning() throws Exception {
    ...
    testExplain(
        ...
        makeTopLevelBuilder()
            ...
            .storageReadExecutionTime(Checkers.greater(0.0))
            .storageReadOps(Checkers.equal(3))
