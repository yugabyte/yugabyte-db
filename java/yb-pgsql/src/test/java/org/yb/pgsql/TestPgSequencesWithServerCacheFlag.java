...
// This class tests that there are no regressions in sequence behaviour when the
// tserver sequence cache is enabled.
@RunWith(value=YBTestRunner.class)
public class TestPgSequencesWithServerCacheFlag extends TestPgSequencesWithCacheFlag {
