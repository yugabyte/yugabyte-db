 ...
 * CDCBaseClass and add super.setUp() in the beginning of setUp() function for the class
 * <br><br>
...
public class CDCWithYugabyted {
  ...
  // Disabled for the time being, the cluster won't be destroyed after class currently
//  @AfterClass
