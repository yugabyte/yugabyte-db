...
// todo (vaibhav): refactor this once the YCQL fix lands
...
public class TestDatatypes {
  ...
  public void testYCQLInet() throws Exception {
    ...
    ExpectedRecordYCQLGeneric<?>[] expectedRecords = new ExpectedRecordYCQLGeneric[] {
      new ExpectedRecordYCQLGeneric<>(0, "", OperationType.DDL),
      new ExpectedRecordYCQLGeneric<>(1, "127.0.0.1", OperationType.INSERT),
      new ExpectedRecordYCQLGeneric<>(0, "", OperationType.DDL)
    };
  ...
  public void testUUID() throws Exception {
    ...
    ExpectedRecordYCQLGeneric<?>[] expectedRecords = new ExpectedRecordYCQLGeneric[] {
      new ExpectedRecordYCQLGeneric<>(0, UUID.randomUUID(), OperationType.DDL),
  ...
  public void testTimestamp() throws Exception {
    ...
    ExpectedRecordYCQLGeneric<?>[] expectedRecords = new ExpectedRecordYCQLGeneric[] {
      new ExpectedRecordYCQLGeneric<>(0, new Date(), OperationType.DDL),
      new ExpectedRecordYCQLGeneric<>(1, new Date(ts1.getTime()), OperationType.INSERT),
      new ExpectedRecordYCQLGeneric<>(2, new Date(ts1.getTime()), OperationType.INSERT),
      new ExpectedRecordYCQLGeneric<>(2, new Date(), OperationType.DELETE),
      new ExpectedRecordYCQLGeneric<>(3, new Date(ts2.getTime()), OperationType.INSERT),
      new ExpectedRecordYCQLGeneric<>(0, new Date(), OperationType.DDL)
    };
  ...
  public void testInteger() throws Exception {
     ...
     * i.e. ExpectedRecordGeneric<>(int-value, 2L, OperationType.SomeOperation)
     */
    ExpectedRecordYCQLGeneric<?>[] expectedRecords = new ExpectedRecordYCQLGeneric[] {
      new ExpectedRecordYCQLGeneric<>(0, 0, OperationType.DDL),
      new ExpectedRecordYCQLGeneric<>(1, 2, OperationType.INSERT),
      new ExpectedRecordYCQLGeneric<>(2, 3, OperationType.INSERT),
      new ExpectedRecordYCQLGeneric<>(4, 5, OperationType.INSERT),
      new ExpectedRecordYCQLGeneric<>(6, 7, OperationType.INSERT),
      new ExpectedRecordYCQLGeneric<>(2, 0, OperationType.DELETE),
      new ExpectedRecordYCQLGeneric<>(0, 0, OperationType.WRITE),
      new ExpectedRecordYCQLGeneric<>(4, 6, OperationType.UPDATE),
      new ExpectedRecordYCQLGeneric<>(6, 0, OperationType.DELETE),
      new ExpectedRecordYCQLGeneric<>(0, 0, OperationType.DDL),
    };
  ...
  public void testBoolean() throws Exception {
    ...
    ExpectedRecordYCQLGeneric<?>[] expectedRecords = new ExpectedRecordYCQLGeneric[] {
      new ExpectedRecordYCQLGeneric<>(0, false, OperationType.DDL),
      new ExpectedRecordYCQLGeneric<>(1, false, OperationType.INSERT),
      new ExpectedRecordYCQLGeneric<>(2, true, OperationType.INSERT),
      new ExpectedRecordYCQLGeneric<>(4, true, OperationType.INSERT),
      new ExpectedRecordYCQLGeneric<>(8, false, OperationType.INSERT),
      new ExpectedRecordYCQLGeneric<>(2, false, OperationType.DELETE),
      new ExpectedRecordYCQLGeneric<>(0, false, OperationType.WRITE),
      new ExpectedRecordYCQLGeneric<>(100, false, OperationType.INSERT),
      new ExpectedRecordYCQLGeneric<>(1, false, OperationType.DELETE),
      new ExpectedRecordYCQLGeneric<>(0, false, OperationType.WRITE),
      new ExpectedRecordYCQLGeneric<>(100, true, OperationType.UPDATE),
      new ExpectedRecordYCQLGeneric<>(4, false, OperationType.UPDATE),
      new ExpectedRecordYCQLGeneric<>(8, false, OperationType.DELETE),
      new ExpectedRecordYCQLGeneric<>(0, false, OperationType.DDL)
    };
  ...
  public void testDouble() throws Exception {
    ...
    ExpectedRecordYCQLGeneric<?>[] expectedRecords = new ExpectedRecordYCQLGeneric[] {
      new ExpectedRecordYCQLGeneric<>(0, 0, OperationType.DDL),
      new ExpectedRecordYCQLGeneric<>(1, 32.123, OperationType.INSERT),
      new ExpectedRecordYCQLGeneric<>(2, 12.345, OperationType.INSERT),
      new ExpectedRecordYCQLGeneric<>(4, 98.765, OperationType.INSERT),
      new ExpectedRecordYCQLGeneric<>(2, 0, OperationType.DELETE),
      new ExpectedRecordYCQLGeneric<>(0, 0, OperationType.WRITE),
      new ExpectedRecordYCQLGeneric<>(1, 11.223, OperationType.UPDATE),
      new ExpectedRecordYCQLGeneric<>(0, 0, OperationType.WRITE),
      new ExpectedRecordYCQLGeneric<>(4, 0, OperationType.DELETE),
      new ExpectedRecordYCQLGeneric<>(0, 0, OperationType.DDL)
    };
  ...
  public void testTime() throws Exception {
    ...
    ExpectedRecordYCQLGeneric<?>[] expectedRecords = new ExpectedRecordYCQLGeneric[] {
      new ExpectedRecordYCQLGeneric<>(0, LocalTime.MIN, OperationType.DDL),
      new ExpectedRecordYCQLGeneric<>(1, LocalTime.of(11, 0, 0), OperationType.INSERT),
      new ExpectedRecordYCQLGeneric<>(2, LocalTime.of(21, 0, 0), OperationType.INSERT),
      new ExpectedRecordYCQLGeneric<>(1, LocalTime.MIN, OperationType.DELETE),
      new ExpectedRecordYCQLGeneric<>(3, LocalTime.of(17, 30, 25), OperationType.INSERT),
      new ExpectedRecordYCQLGeneric<>(0, LocalTime.MIN, OperationType.WRITE),
      new ExpectedRecordYCQLGeneric<>(0, LocalTime.MIN, OperationType.DDL)
    };
  ...
  public void testVarint() throws Exception {
    ...
    /*
      ...
      the table, this behaviour is because YCQL uses upsert semantics where if a row is not present
      while performing an UPDATE or DELETE operation, it would be inserted first and then the
      operation would be performed.

      DO NOTE THAT even though the row is inserted first, it won't come in the CDC streamed records.
     */
    ...
    ExpectedRecordYCQLGeneric<?>[] expectedRecords = new ExpectedRecordYCQLGeneric[] {
      new ExpectedRecordYCQLGeneric<>(0, BigInteger.valueOf(0), OperationType.DDL),
      new ExpectedRecordYCQLGeneric<>(1, BigInteger.valueOf(1001), OperationType.INSERT),
      new ExpectedRecordYCQLGeneric<>(2, BigInteger.valueOf(2001), OperationType.INSERT),
      new ExpectedRecordYCQLGeneric<>(33, BigInteger.valueOf(0), OperationType.DELETE),
      new ExpectedRecordYCQLGeneric<>(2, BigInteger.valueOf(10000), OperationType.UPDATE),
      new ExpectedRecordYCQLGeneric<>(1, BigInteger.valueOf(20000), OperationType.UPDATE),
      new ExpectedRecordYCQLGeneric<>(1, BigInteger.valueOf(0), OperationType.DELETE),
      new ExpectedRecordYCQLGeneric<>(0, BigInteger.valueOf(0), OperationType.DDL)
    };
  ...
  public void testBlob() throws Exception {
    ...
    ExpectedRecordYCQLGeneric<?>[] expectedRecords = new ExpectedRecordYCQLGeneric[] {
      new ExpectedRecordYCQLGeneric<>(0, "", OperationType.DDL),
      new ExpectedRecordYCQLGeneric<>(1, "ff", OperationType.INSERT),
      new ExpectedRecordYCQLGeneric<>(2, "10ef", OperationType.INSERT),
      new ExpectedRecordYCQLGeneric<>(1, "01", OperationType.UPDATE),
      new ExpectedRecordYCQLGeneric<>(0, "", OperationType.DDL)
    };
