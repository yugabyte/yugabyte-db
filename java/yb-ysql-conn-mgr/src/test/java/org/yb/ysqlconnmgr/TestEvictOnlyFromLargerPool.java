 ...
 *
 * When inactive pools hold backends (here pinned via open transactions so
 ...
 *
 * With the up-by-two guard (the default, always-on eviction behaviour), an
...
public class TestEvictOnlyFromLargerPool extends BaseYsqlConnMgr {
  ...
  protected void customizeMiniClusterBuilder(MiniYBClusterBuilder builder) {
    ...
    builder.addCommonTServerFlag("ysql_conn_mgr_use_auth_backend", "false");
  }
