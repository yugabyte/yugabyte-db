...
public class TestCollectionTypes extends BaseCQLTest {
    ...
    private void createTable(String tableName, String keyType, String elemType) throws Exception {
    ...
    public void testCreateTable() throws Exception {
        ...
        for (String tp : validKeyTypes) {
            createTable(tableNameBase + tp, tp, tp);
            Thread.sleep(1000);
            DropTable(tableNameBase + tp);
        }

        for (String tp : nonKeyTypes) {
            createTable(tableNameBase + tp, "int", tp);
            Thread.sleep(1000);
            DropTable(tableNameBase + tp);
        }
