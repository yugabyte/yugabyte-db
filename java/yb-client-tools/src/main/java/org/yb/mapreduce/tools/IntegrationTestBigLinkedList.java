 ...
 * YB. Note that the C++ client can store bytes directly in string columns. Using longs
 ...
 * ported to YB without too much effort.
 * </li>
 * </ul>
 */
...
public class IntegrationTestBigLinkedList extends Configured implements Tool {
  ...
  static class Loop extends Configured implements Tool {
    ...
    protected void runVerify(String outputDir,
      ...
      // YB doesn't fully support snapshot consistency so we might start reading from a node that
