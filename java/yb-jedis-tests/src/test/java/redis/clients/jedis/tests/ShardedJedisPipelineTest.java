...
public class ShardedJedisPipelineTest extends BaseYBClassForJedis {
  ...
  @Test
  @Ignore public void pipeline() throws UnsupportedEncodingException {
  ...
  @Test
  @Ignore public void pipelineResponse() {
  ...
  @Ignore public void pipelineResponseWithinPipeline() {
    jedis.set("string", "foo");
  ...
  @Test
  @Ignore public void canRetrieveUnsetKey() {
    ShardedJedisPipeline p = jedis.pipelined();
  ...
  @Test
  @Ignore public void testSyncWithNoCommandQueued() {
    JedisShardInfo shardInfo1 = new JedisShardInfo(redis1.getHost(), redis1.getPort());
    JedisShardInfo shardInfo2 = new JedisShardInfo(redis2.getHost(), redis2.getPort());
    shardInfo1.setPassword("foobared");
    shardInfo2.setPassword("foobared");
