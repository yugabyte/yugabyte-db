...
public class JedisSentinelTest extends BaseYBClassForJedis {
  ...
  @Test
  @Ignore public void sentinelFailover() throws InterruptedException {
  ...
  @Test
  @Ignore public void sentinelMonitor() {
    Jedis j = new Jedis(sentinel.getHost(), sentinel.getPort());
  ...
  @Test
  @Ignore public void sentinelRemove() {
    Jedis j = new Jedis(sentinel.getHost(), sentinel.getPort());
  ...
  @Test
  @Ignore public void sentinelSet() {
    Jedis j = new Jedis(sentinel.getHost(), sentinel.getPort());
