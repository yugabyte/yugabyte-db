...
public class BinaryValuesCommandsTest extends JedisCommandTestBase {
  ...
  @Test(expected = JedisDataException.class)
  @Ignore public void decrWrongValue() {
    jedis.set(bfoo, binaryValue);
    jedis.decr(bfoo);
  }

  @Test
  @Ignore public void decr() {
  ...
  @Test(expected = JedisDataException.class)
  @Ignore public void decrByWrongValue() {
    jedis.set(bfoo, binaryValue);
    jedis.decrBy(bfoo, 2);
  }

  @Test
  @Ignore public void decrBy() {
