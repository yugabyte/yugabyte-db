...
public class PipeliningTest extends BaseYBClassForJedis {
  ...
  public void setUp() throws Exception {
    ...
    jedis = new Jedis(hnp.getHost(), hnp.getPort(), 12000);
    jedis.connect();
    jedis.auth("foobared");
    jedis.flushAll();
  }
  ...
  @Test
  @Ignore public void multiWithMassiveRequests() {
    Pipeline p = jedis.pipelined();
    p.multi();
  ...
  @Test
  @Ignore public void multiWithSync() {
    jedis.set("foo", "314");
    jedis.set("bar", "foo");
  ...
  @Test(expected = JedisDataException.class)
  @Ignore public void pipelineMultiShoudThrowJedisDataExceptionWhenAlreadyInMulti() {
    Pipeline pipeline = jedis.pipelined();
    pipeline.multi();
    pipeline.set("foo", "3");
    pipeline.multi();
  ...
  @Test
  @Ignore public void testDiscardInPipeline() {
    Pipeline pipeline = jedis.pipelined();
    pipeline.multi();
  ...
  @Test
  @Ignore public void testEvalWithBinary() {
    String script = "return 'success!'";
  ...
  @Test
  @Ignore public void testEvalKeyAndArg() {
    String key = "test";
    String arg = "3";
    String script =
  ...
  @Test
  @Ignore public void testEvalKeyAndArgWithBinary() {
    // binary
  ...
  @Test
  @Ignore public void testEvalNestedListsWithBinary() {
  ...
  @Test
  @Ignore public void testEvalsha() {
    String script = "return 'success!'";
  ...
  @Test
  @Ignore public void testEvalshaKeyAndArgWithBinary() {
    byte[] bKey = SafeEncoder.encode("test");
    byte[] bArg = SafeEncoder.encode("3");
    String script =
        "redis.call('INCRBY', KEYS[1], ARGV[1]) redis.call('INCRBY', KEYS[1], ARGV[1])";
  ...
  @Test
  @Ignore public void testEvalshaKeyAndArg() {
    String key = "test";
    String arg = "3";
    String script =
        "redis.call('INCRBY', KEYS[1], ARGV[1]) redis.call('INCRBY', KEYS[1], ARGV[1])";
  ...
  @Test
  @Ignore public void testPipelinedTransactionResponse() {
  ...
  public void testSyncWithNoCommandQueued() {
    ...
    Jedis jedis2 = new Jedis(hnp.getHost(), hnp.getPort(), 15000);
    ...
    jedis2 = new Jedis(hnp.getHost(), hnp.getPort(), 15000);
  ...
  @Test
  @Ignore public void testCloseableWithMulti() throws IOException {
    // we need to test with fresh instance of Jedis
    Jedis jedis2 = new Jedis(hnp.getHost(), hnp.getPort(), 15000);
    jedis2.auth("foobared");
