...
public class ClusterBinaryJedisCommandsTest extends BaseYBClassForJedis {
  private Jedis node1;
  ...
  public void setUp() throws InterruptedException {
    ...
    jedisCluster = new JedisCluster(jedisClusterNode, 12000, 12000, 5, "cluster",
                                    new JedisPoolConfig());
  }
  ...
  @Test
  @Ignore public void testBinaryGetAndSet() {
  ...
  @Test
  @Ignore public void testGetSlot() {
