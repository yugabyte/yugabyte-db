...
@Ignore public class ClusterScriptingCommandsTest extends BaseYBClassForJedis {
  private Jedis node1;
  ...
  @Ignore public void testJedisClusterException() {
  ...
  @SuppressWarnings("unchecked")
  @Test
  @Ignore public void testScriptLoadAndScriptExists() {
  ...
  @SuppressWarnings("unchecked")
  @Test(expected = JedisClusterException.class)
  @Ignore public void testJedisClusterException2() {
    byte[] script =
        "return {KEYS[1],KEYS[2],ARGV[1],ARGV[2],ARGV[3]}".getBytes();
  ...
  @SuppressWarnings("unchecked")
  @Test
  @Ignore public void testBinaryEval() {
  ...
  @SuppressWarnings("unchecked")
  @Test
  @Ignore public void testBinaryScriptFlush() {
    byte[] byteKey = "key1".getBytes();
    byte[] sha1 = jedisCluster.scriptLoad(
        "return redis.call('get','foo')".getBytes(), byteKey);
    assertEquals("OK", jedisCluster.scriptFlush(byteKey));
  }

  @SuppressWarnings("unchecked")
  @Test(expected = JedisDataException.class)
  @Ignore public void testBinaryScriptKill() {
    byte[] byteKey = "key1".getBytes();
  ...
  @SuppressWarnings("unchecked")
  @Test
  @Ignore public void testBinaryScriptExists() {
    byte[] byteKey = "key1".getBytes();
    byte[] sha1 = jedisCluster.scriptLoad(
        "return redis.call('get','foo')".getBytes(), byteKey);
    byte[][] arraySha1 = {sha1};
