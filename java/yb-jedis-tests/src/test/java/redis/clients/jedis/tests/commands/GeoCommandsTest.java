...
public class GeoCommandsTest extends JedisCommandTestBase {
  ...
  @Test
  @Ignore public void georadiusBinary() {
    // prepare datas
    Map<byte[], GeoCoordinate> bcoordinateMap = new HashMap<byte[], GeoCoordinate>();
  ...
  @Test
  @Ignore public void georadiusByMember() {
  ...
  @Test
  @Ignore public void georadiusByMemberBinary() {
