...
public class BitCommandsTest extends JedisCommandTestBase {
  @Test
  @Ignore public void setAndgetbit() {
  ...
  @Test
  @Ignore public void bitposBinary() {
    // binary
  ...
  @Test
  @Ignore public void bitposWithNoMatchingBitExist() {
    String foo = "foo";
  ...
  @Test
  @Ignore public void bitposWithNoMatchingBitExistWithinRange() {
    String foo = "foo";
