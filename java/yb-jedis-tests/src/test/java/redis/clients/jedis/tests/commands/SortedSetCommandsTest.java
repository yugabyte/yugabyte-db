...
public class SortedSetCommandsTest extends JedisCommandTestBase {
  ...
  @Test
  @Ignore public void zrangeByLex() {
    jedis.zadd("foo", 1, "aa");
    jedis.zadd("foo", 1, "c");
    jedis.zadd("foo", 1, "bb");
    jedis.zadd("foo", 1, "d");
  ...
  @Test
  @Ignore public void zrangeByLexBinary() {
    // binary
  ...
  @Test
  @Ignore public void zrevrangeByLex() {
    jedis.zadd("foo", 1, "aa");
    jedis.zadd("foo", 1, "c");
    jedis.zadd("foo", 1, "bb");
    jedis.zadd("foo", 1, "d");
  ...
  @Test
  @Ignore public void zrevrangeByLexBinary() {
    // binary
    jedis.zadd(bfoo, 1, ba);
    jedis.zadd(bfoo, 1, bc);
    jedis.zadd(bfoo, 1, bb);
    ...
    assertByteArraySetEquals(
        bExpected, jedis.zrevrangeByLex(bfoo, bExclusiveC, bInclusiveB));
    ...
    // with LIMIT
    assertByteArraySetEquals(
        bExpected, jedis.zrevrangeByLex(bfoo, bLexPlusInf, bLexMinusInf, 0, 2));
  }
  ...
  @Test
  @Ignore public void zincrbyWithParams() {
    jedis.del("foo");
  ...
  @Test
  @Ignore public void zlexcountBinary() {
    // Binary
    jedis.zadd(bfoo, 1, ba);
    jedis.zadd(bfoo, 1, bc);
    jedis.zadd(bfoo, 1, bb);
  ...
  @Test
  @Ignore public void zrevrangebyscore() {
    ...
    Set<String> range =
        jedis.zrevrangeByScore("foo", 3d, Double.NEGATIVE_INFINITY, 0, 1);
    Set<String> expected = new LinkedHashSet<String>();
    expected.add("c");
    ...
    Set<byte[]> brange2 = jedis.zrevrangeByScore(
        bfoo, SafeEncoder.encode("+inf"), SafeEncoder.encode("(2"));
  ...
  @Test
  @Ignore public void zrevrangebyscoreWithScores() {
    jedis.zadd("foo", 1.0d, "a");
    jedis.zadd("foo", 2.0d, "b");
    jedis.zadd("foo", 3.0d, "c");
    jedis.zadd("foo", 4.0d, "d");
    ...
    Set<Tuple> range = jedis.zrevrangeByScoreWithScores(
        "foo", 3d, Double.NEGATIVE_INFINITY, 0, 1);
    Set<Tuple> expected = new LinkedHashSet<Tuple>();
  ...
  @Test
  @Ignore public void zremrangeByRank() {
    jedis.zadd("foo", 1d, "a");
    jedis.zadd("foo", 10d, "b");
    jedis.zadd("foo", 0.1d, "c");
    jedis.zadd("foo", 2d, "a");
  ...
  @Test
  @Ignore public void zremrangeByScore() {
    jedis.zadd("foo", 1d, "a");
    jedis.zadd("foo", 10d, "b");
    jedis.zadd("foo", 0.1d, "c");
    jedis.zadd("foo", 2d, "a");
  ...
  @Test
  @Ignore public void zremrangeByLex() {
    jedis.zadd("foo", 1, "a");
    jedis.zadd("foo", 1, "b");
    jedis.zadd("foo", 1, "c");
    jedis.zadd("foo", 1, "aa");
  ...
  @Test
  @Ignore public void zremrangeByLexBinary() {
    jedis.zadd(bfoo, 1, ba);
    jedis.zadd(bfoo, 1, bc);
    jedis.zadd(bfoo, 1, bb);
  ...
  @Test
  @Ignore public void zunionstore() {
    jedis.zadd("foo", 1, "a");
    jedis.zadd("foo", 2, "b");
    jedis.zadd("bar", 2, "a");
    jedis.zadd("bar", 2, "b");
  ...
  @Test
  @Ignore public void zunionstoreParams() {
    jedis.zadd("foo", 1, "a");
    jedis.zadd("foo", 2, "b");
    jedis.zadd("bar", 2, "a");
    jedis.zadd("bar", 2, "b");
    ...
    long bresult =
        jedis.zunionstore(SafeEncoder.encode("dst"), bparams, bfoo, bbar);
  ...
  @Test
  @Ignore public void zinterstore() {
    jedis.zadd("foo", 1, "a");
    jedis.zadd("foo", 2, "b");
    jedis.zadd("bar", 2, "a");
  ...
  @Test
  @Ignore public void zintertoreParams() {
    jedis.zadd("foo", 1, "a");
    jedis.zadd("foo", 2, "b");
    jedis.zadd("bar", 2, "a");
    ...
    bparams.aggregate(ZParams.Aggregate.SUM);
    long bresult =
        jedis.zinterstore(SafeEncoder.encode("dst"), bparams, bfoo, bbar);
  ...
  @Ignore public void zscanCount() {
    ...
    ScanResult<Tuple> bResult =
        jedis.zscan(bfoo, SCAN_POINTER_START_BINARY, params);
