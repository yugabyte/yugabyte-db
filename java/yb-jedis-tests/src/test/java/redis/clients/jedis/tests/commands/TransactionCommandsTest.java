...
public class TransactionCommandsTest extends JedisCommandTestBase {
  ...
  @Test
  @Ignore public void watch() throws UnknownHostException, IOException {
  ...
  @Test
  @Ignore public void unwatch() throws UnknownHostException, IOException {
    jedis.watch("mykey");
  ...
  @Ignore public void validateWhenInMulti() {
    jedis.multi();
    jedis.ping();
  }

  @Test
  @Ignore public void discard() {
    Transaction t = jedis.multi();
  ...
  @Test
  @Ignore public void transactionResponse() {
  ...
  @Test
  @Ignore public void transactionResponseBinary() {
    jedis.set("string", "foo");
    jedis.lpush("list", "foo");
    jedis.hset("hash", "foo", "bar");
    jedis.zadd("zset", 1, "foo");
  ...
  @Test(expected = JedisDataException.class)
  @Ignore public void transactionResponseWithinPipeline() {
    jedis.set("string", "foo");
  ...
  @Test
  @Ignore public void transactionResponseWithError() {
    Transaction t = jedis.multi();
    t.set("foo", "bar");
  ...
  @Test
  @Ignore public void execGetResponse() {
    Transaction t = jedis.multi();
  ...
  @Test
  @Ignore public void testResetStateWhenInMulti() {
    jedis.auth("foobared");
  ...
  @Test
  @Ignore public void testResetStateWhenInMultiWithinPipeline() {
    jedis.auth("foobared");
  ...
  @Test
  @Ignore public void testResetStateWhenInWatch() {
    jedis.watch("mykey", "somekey");
  ...
  @Test
  @Ignore public void testResetStateWithFullyExecutedTransaction() {
