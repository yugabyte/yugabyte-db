...
public class SetCommandsTest extends JedisCommandTestBase {
  ...
  @Test
  @Ignore public void spopWithCount() {
    jedis.sadd("foo", "a");
    jedis.sadd("foo", "b");
  ...
  @Test
  @Ignore public void sinterstore() {
    jedis.sadd("foo", "a");
    jedis.sadd("foo", "b");
  ...
  @Test
  @Ignore public void sunionstore() {
    jedis.sadd("foo", "a");
    jedis.sadd("foo", "b");
  ...
  @Test
  @Ignore public void srandmember() {
    jedis.sadd("foo", "a");
    jedis.sadd("foo", "b");
