...
public class HyperLogLogCommandsTest extends JedisCommandTestBase {
  ...
  @Test
  @Ignore public void pfaddBinary() {
  ...
  @Test
  @Ignore public void pfcountBinary() {
  ...
  @Test
  @Ignore public void pfmergeBinary() {
