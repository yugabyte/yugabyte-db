...
public class YBTableInputFormat extends InputFormat<NullWritable, RowResult>
  ...
  /**
   * The reverse DNS lookup cache mapping: address from YB => hostname for Hadoop. This cache is
   ...
   * Hadoop does. This ensures we get locality if YB is running along MR/YARN.
