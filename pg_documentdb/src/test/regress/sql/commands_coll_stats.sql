...
SELECT documentdb_api.drop_collection('db', 'collstats1');

-- Non existing collection should return zero values
SELECT documentdb_api.coll_stats('db', 'collstats1');
SELECT documentdb_api.coll_stats('db', 'collstats1', 1024);

-- Create Collection
SELECT documentdb_api.create_collection('db', 'collstats1');
...
-- Add one doc
SELECT documentdb_api.insert_one('db','collstats1',' { "a" : 100 }', NULL);
...
-- Add another doc.
SELECT documentdb_api.insert_one('db','collstats1',' { "a" : 101 }', NULL);
...
-- Create Indexes
CALL documentdb_api.create_indexes('db', documentdb_test_helpers.generate_create_index_arg('collstats1', 'index_1', '{"a.$**": 1}'));
...
VACUUM ANALYZE documentdb_data.documents_3800;
...
SELECT documentdb_api.delete('db', '{"delete":"collstats1", "deletes":[{"q":{"a":{"$gte": 100}},"limit":0}]}');
...
SELECT documentdb_api.coll_stats('db', 'collstats1', 1);
SELECT documentdb_api.coll_stats('db', 'collstats1', 2);
SELECT documentdb_api.coll_stats('db', 'collstats1', 2.5);
SELECT documentdb_api.coll_stats('db', 'collstats1', 2.99);
SELECT documentdb_api.coll_stats('db', 'collstats1', 100);
SELECT documentdb_api.coll_stats('db', 'collstats1', 1024.99);
SELECT documentdb_api.coll_stats('db', 'collstats1', 2147483647);     -- INT_MAX
SELECT documentdb_api.coll_stats('db', 'collstats1', 2147483647000);  -- More than INT_MAX

-- Shard the collection
SELECT documentdb_api.shard_collection('db', 'collstats1', '{"a" : "hashed"}', false);
...
SELECT documentdb_api.coll_stats('db', 'collstats1', 0);
SELECT documentdb_api.coll_stats('db', 'collstats1', 0.99);
SELECT documentdb_api.coll_stats('db', 'collstats1', -0.2);
SELECT documentdb_api.coll_stats('db', 'collstats1', -2);
SELECT documentdb_api.coll_stats('db', 'collstats1', -2147483648);    -- INT_MIN
SELECT documentdb_api.coll_stats('db', 'collstats1', -2147483647000); -- Less than INT_MIN
