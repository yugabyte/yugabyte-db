...
SELECT collection_id AS test_sort_returning FROM helio_api_catalog.collections WHERE database_name = 'delete' AND collection_name = 'test_sort_returning' \gset
SELECT helio_api_internal.delete_worker(
