...
CREATE OR REPLACE FUNCTION helio_api_internal.bson_expression_partition_by_fields_get(document __CORE_SCHEMA__.bson, expressionSpec __CORE_SCHEMA__.bson)
 RETURNS helio_core.bson
 LANGUAGE c
 IMMUTABLE PARALLEL SAFE STRICT
