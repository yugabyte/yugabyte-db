DROP FUNCTION IF EXISTS __API_CATALOG_SCHEMA__.bson_aggregation_find;

-- This function is the Mongo find query function.
...
CREATE OR REPLACE FUNCTION __API_CATALOG_SCHEMA__.bson_aggregation_find(
    databaseName text,
    findSpec __CORE_SCHEMA__.bson,
