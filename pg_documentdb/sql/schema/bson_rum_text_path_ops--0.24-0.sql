...
CREATE OPERATOR CLASS  __API_CATALOG_SCHEMA__.bson_rum_text_path_ops
    FOR TYPE __CORE_SCHEMA__.bson using __EXTENSION_OBJECT__(_rum) AS
        ...
        FUNCTION        2       helio_api_internal.rum_bson_single_path_extract_tsvector(__CORE_SCHEMA__.bson,internal,internal,internal,internal),
        ...
        FUNCTION        11      (__CORE_SCHEMA__.bson) helio_api_internal.rum_bson_text_path_options(internal),
    STORAGE         text;