...
CREATE OPERATOR CLASS __API_CATALOG_SCHEMA__.bson_rum_exclusion_ops
    FOR TYPE __API_CATALOG_SCHEMA__.shard_key_and_document USING __EXTENSION_OBJECT__(_rum) AS
        ...
        FUNCTION	2	helio_api_internal.gin_bson_exclusion_extract_value(__API_CATALOG_SCHEMA__.shard_key_and_document, internal),
        FUNCTION	3	helio_api_internal.gin_bson_exclusion_extract_query(__API_CATALOG_SCHEMA__.shard_key_and_document, internal, int2, internal, internal, internal, internal),
        FUNCTION	4	helio_api_internal.gin_bson_exclusion_consistent(internal, int2, anyelement, int4, internal, internal),
        ...
        FUNCTION    11  (__API_CATALOG_SCHEMA__.shard_key_and_document) helio_api_internal.gin_bson_exclusion_options(internal),
    STORAGE		 uuid;