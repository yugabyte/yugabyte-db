...
If you are running a different version of YugabyteDB Anywhere, replace the version number in the command with the correct version number; do not include the [revision number](../../../releases/versioning/#release-versioning-convention).
