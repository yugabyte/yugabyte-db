...
1. Download the YugabyteDB package using the following `wget` command.
    ...
    ```sh
    $ wget https://downloads.yugabyte.com/releases/2.6.8.0/yugabyte-2.6.8.0-b15-linux-x86_64.tar.gz
    ```

1. Extract the package and then change directories to the YugabyteDB home.

    ```sh
    $ tar xvfz yugabyte-2.6.8.0-b15-linux-x86_64.tar.gz && cd yugabyte-2.6.8.0/
    ```
