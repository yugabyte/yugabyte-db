...
<ul class="nav nav-tabs-alt nav-tabs-yb">
  <li >
    <a href="/preview/explore/backup-restore/point-in-time-recovery-ysql" class="nav-link active">
      <i class="icon-postgres" aria-hidden="true"></i>
      YSQL
    </a>
  </li>
  <li >
    <a href="/preview/explore/backup-restore/point-in-time-recovery-ycql" class="nav-link">
