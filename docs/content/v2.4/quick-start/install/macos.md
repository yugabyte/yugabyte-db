...
<ul class="nav nav-tabs-alt nav-tabs-yb">
  ...
  <li >
    <a href="/preview/quick-start/install/macos" class="nav-link active">
  ...
  <li >
    <a href="/preview/quick-start/install/linux" class="nav-link">
  ...
  <li >
    <a href="/preview/quick-start/install/docker" class="nav-link">
  ...
  <li >
    <a href="/preview/quick-start/install/kubernetes" class="nav-link">
