...
--config *config-file*
: The path to the [configuration file](#advanced-flags) of the yugabyted server.
...
--config *config-file*
: The path to the [configuration file](#advanced-flags) of the yugabyted server to connect to.
...
--config *config-file*
: The path to the [configuration file](#advanced-flags) of the yugabyted server to connect to or destroy.
...
```sh
./bin/yugabyted destroy --base_dir=$HOME/yugabyte-{{< yb-version version="v2.18" >}}/node1
./bin/yugabyted destroy --base_dir=$HOME/yugabyte-{{< yb-version version="v2.18" >}}/node2
./bin/yugabyted destroy --base_dir=$HOME/yugabyte-{{< yb-version version="v2.18" >}}/node3
```
...
./bin/yugabyted start --advertise_address=127.0.0.1 \
    --base_dir=/Users/username/yugabyte-{{< yb-version version="v2.18" >}}/data1
```
...
```sh
cp $HOME/var/generated_certs/127.0.0.1/* $HOME/yugabyte-{{< yb-version version="v2.18" >}}/node1/certs
cp $HOME/var/generated_certs/127.0.0.2/* $HOME/yugabyte-{{< yb-version version="v2.18" >}}/node2/certs
cp $HOME/var/generated_certs/127.0.0.3/* $HOME/yugabyte-{{< yb-version version="v2.18" >}}/node3/certs
```
...
1. Start the first node by running the following command:
    ...
    ```sh
    ./bin/yugabyted start --secure --advertise_address=127.0.0.1 \
        --base_dir=$HOME/yugabyte-{{< yb-version version="v2.18" >}}/node1 \
...
1. Add two more nodes to the cluster using the `--join` flag, as follows:
    ...
    ./bin/yugabyted start --secure --advertise_address=127.0.0.2 \
        --join=127.0.0.1 \
        --base_dir=$HOME/yugabyte-{{< yb-version version="v2.18" >}}/node2 \
        --cloud_location=aws.us-east-1.us-east-1b
    ./bin/yugabyted start --secure --advertise_address=127.0.0.3 \
        --join=127.0.0.1 \
        --base_dir=$HOME/yugabyte-{{< yb-version version="v2.18" >}}/node3 \
