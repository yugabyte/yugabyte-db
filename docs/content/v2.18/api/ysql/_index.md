...
You can explore the basics of the YSQL API using the [Quick Start](/preview/tutorials/quick-start/macos/) steps.
...
The simplest way to achieve this ideal sandbox regime is to use your own laptop. The [Quick Start](/preview/tutorials/quick-start/macos/) section shows you how to do this.
