...
You can explore the basics of the YSQL API using the [Quick Start](/preview/tutorials/quick-start/) steps.
...
The simplest way to achieve this ideal sandbox regime is to use you own laptop. The [Quick Start](/preview/tutorials/quick-start/explore/ysql/) section shows you how to do this.
