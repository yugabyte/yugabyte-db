...
* **xCluster replication** for unidirectional and bidirectional asynchronous replication
...
| **Data residency** | All data replicated across regions | Data partitioned across regions. <br/>Partitions replicated inside region. | All data replicated inside region. <br/>Configure per-table cross-region replication. | All data replicated in primary region. <br/>Cluster-wide xCluster replication to read replicas. |
