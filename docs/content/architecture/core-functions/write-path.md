---
title: Write IO Path (Single Shard)
weight: 1020
---
...
[distributed transactions IO path](/architecture/core-functions/transactional-io-path/) section,
...
Recall from the [sharding](/architecture/concepts/sharding/) section that each key is owned
