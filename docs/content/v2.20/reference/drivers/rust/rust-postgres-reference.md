...
- `load_balance` - enable [cluster-aware load balancing](../../../../drivers-orms/smart-drivers/#cluster-aware-load-balancing) by setting this property to one of the [allowed values](../../../../drivers-orms/smart-drivers/#node-type-aware-load-balancing) other than `false`; disabled by default.
