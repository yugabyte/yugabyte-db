...
If '[Restart read required error](../../../../architecture/transactions/read-committed/#read-restart-errors)' is encountered while running `yb_index_check()`, set the following parameter and then re-run `yb_index_check()`:
