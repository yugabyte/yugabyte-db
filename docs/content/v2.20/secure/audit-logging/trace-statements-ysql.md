...
Session information is written to the PostgreSQL logs, located in the YugabyteDB base folder in the `yb-data/tserver/logs` directory. For information on inspecting logs, refer to [Understand YugabyteDB logging](/stable/explore/observability/logging/).
