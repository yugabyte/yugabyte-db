...
You can configure the smart driver with [topology load balancing](/stable/drivers-orms/smart-drivers/#topology-aware-load-balancing) to limit connections to the closest region.
