...
- [ysqlsh](/preview/yugabyte-clients/ysqlsh/) command-line connectivity to a running YugabyteDB cluster that is a target of migration.
...
1. Modify the `ddl.sql` DDL file and run it using the [ysqlsh](/preview/yugabyte-clients/ysqlsh/) command-line tool.
