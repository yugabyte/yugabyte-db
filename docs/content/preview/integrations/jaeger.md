...
The Jaeger example on this page uses a [Sample App: HotROD](https://www.jaegertracing.io/docs/1.43/getting-started/#sample-app-hotrod) to illustrate the usage of YCQL as a storage backend for jaeger.
