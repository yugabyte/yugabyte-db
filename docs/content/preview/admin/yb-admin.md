...
* Having all tablet leaders reside in a single region will reduce the number of network hops for the database to write transactions and thus increase performance and lowering latency.
...
* When picking leaders the order of precedence is placement information, leader blacklist and finally preferred zones.
