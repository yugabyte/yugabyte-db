...
1. Deploy the connector. For more information, refer to [Deployment](../../../explore/change-data-capture/using-yugabytedb-grpc-replication/debezium-connector-yugabytedb/#deployment).
