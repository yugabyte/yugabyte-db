...
- [ysqlsh](../../../yugabyte-clients/ysqlsh/) or [psql](https://www.postgresql.org/docs/current/app-psql.html)
...
1. Create the `airbnb_listing` table (you can use [ysqlsh](../../../yugabyte-clients/ysqlsh/) or another comparable SQL tool instead of psql):
