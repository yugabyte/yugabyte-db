...
1. Wait for the node to finish the initialization and connect to the container opening a database connection with the [ysqlsh](../../../yugabyte-clients/ysqlsh/) command-line tool:
