...
By default, the `idle_in_transaction_session_timeout` is set to `0`. You can set the timeout to a specific value in [ysqlsh](../../../../yugabyte-clients/ysqlsh/#starting-ysqlsh) using the following command:
