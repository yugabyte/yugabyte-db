...
- CDC is not supported on tables that are also the target of xCluster replication, see [GitHub issue 15534](https://github.com/yugabyte/yugabyte-db/issues/15534). However, both CDC and xCluster can work simultaneously on the same source tables.
