...
Create a [YugabyteDB universe](../../../quick-start/) and open two separate [ysqlsh](../../../yugabyte-clients/ysqlsh/#starting-ysqlsh) connections to it.
...
1. From an active [ysqlsh](../../../yugabyte-clients/ysqlsh/#starting-ysqlsh) shell, create a table as follows:
