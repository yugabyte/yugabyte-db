...
* The `--file-opts` CLI argument is now deprecated. Use the new [--escape-char](../../yugabyte-voyager/reference/yb-voyager-cli/#escape-char) and [--quote-char](../../yugabyte-voyager/reference/yb-voyager-cli/#quote-char) options.
...
* Added support for characters such as backspace(\b) in quote and escape character with [--file-opts](../../yugabyte-voyager/reference/yb-voyager-cli/#file-opts) in import data file.
