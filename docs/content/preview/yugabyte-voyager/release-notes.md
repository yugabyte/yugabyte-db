...
- Assessment and Schema Analysis Reports
  ...
  - Stop reporting [ALTER PARTITIONED TABLE ADD PRIMARY KEY](https://github.com/yugabyte/yb-voyager/issues/612) as an issue by default in assessment and schema analysis reports, as it has been fixed in YugabyteDB {{<release "2024.1.0.0">}} and later.
