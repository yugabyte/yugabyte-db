...
Finally, if you need to switch to the fall-forward database (because the current YugabyteDB system is not working as expected), you can use [fall-forward switchover](#fall-forward-switchover-optional) option.
