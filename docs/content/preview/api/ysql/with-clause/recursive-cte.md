...
<div class="tab-content">
  ...
  {{% includeMarkdown "../syntax_resources/with-clause/with_clause.grammar.md" %}}
  </div>
  <div id="diagram" class="tab-pane fade" role="tabpanel" aria-labelledby="diagram-tab">
  {{% includeMarkdown "../syntax_resources/with-clause/with_clause.diagram.md" %}}
  </div>
</div>
