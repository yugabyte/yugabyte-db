...
The preferred option for the present case study, because [`ysqlsh`](../../../../../../../yugabyte-clients/ysqlsh/) is chosen for running all the SQL statements, is to use the [`\copy`](../../../../../../../yugabyte-clients/ysqlsh-meta-commands/#copy-table-column-list-query-from-to-filename-program-command-stdin-stdout-pstdin-pstdout-with-option) meta-command.
