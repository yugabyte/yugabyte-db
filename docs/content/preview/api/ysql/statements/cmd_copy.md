...
<div class="tab-content">
  ...
  {{% includeMarkdown "../syntax_resources/statements/copy_from,copy_to,copy_option.grammar.md" %}}
  </div>
  <div id="diagram" class="tab-pane fade" role="tabpanel" aria-labelledby="diagram-tab">
  {{% includeMarkdown "../syntax_resources/statements/copy_from,copy_to,copy_option.diagram.md" %}}
  </div>
</div>
