...
<div class="tab-content">
  ...
  {{% includeMarkdown "../syntax_resources/statements/create_domain,domain_constraint.grammar.md" %}}
  </div>
  <div id="diagram" class="tab-pane fade" role="tabpanel" aria-labelledby="diagram-tab">
  {{% includeMarkdown "../syntax_resources/statements/create_domain,domain_constraint.diagram.md" %}}
  </div>
</div>
