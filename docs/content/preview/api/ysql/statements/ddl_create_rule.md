...
<div class="tab-content">
  ...
  {{% includeMarkdown "../syntax_resources/statements/create_rule,rule_event,command.grammar.md" %}}
  </div>
  <div id="diagram" class="tab-pane fade" role="tabpanel" aria-labelledby="diagram-tab">
  {{% includeMarkdown "../syntax_resources/statements/create_rule,rule_event,command.diagram.md" %}}
  </div>
</div>
