...
<div class="tab-content">
  ...
  {{% includeMarkdown "../syntax_resources/statements/create_sequence,sequence_name,sequence_options.grammar.md" %}}
  </div>
  <div id="diagram" class="tab-pane fade" role="tabpanel" aria-labelledby="diagram-tab">
  {{% includeMarkdown "../syntax_resources/statements/create_sequence,sequence_name,sequence_options.diagram.md" %}}
  </div>
</div>
