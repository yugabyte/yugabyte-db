...
<div class="tab-content">
  ...
  {{% includeMarkdown "../syntax_resources/statements/values,expression_list.grammar.md" %}}
  </div>
  <div id="diagram" class="tab-pane fade" role="tabpanel" aria-labelledby="diagram-tab">
  {{% includeMarkdown "../syntax_resources/statements/values,expression_list.diagram.md" %}}
  </div>
</div>
