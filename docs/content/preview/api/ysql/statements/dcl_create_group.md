...
<div class="tab-content">
  ...
  {{% includeMarkdown "../syntax_resources/statements/create_group,role_option.grammar.md" %}}
  </div>
  <div id="diagram" class="tab-pane fade" role="tabpanel" aria-labelledby="diagram-tab">
  {{% includeMarkdown "../syntax_resources/statements/create_group,role_option.diagram.md" %}}
  </div>
</div>
