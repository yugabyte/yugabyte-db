...
<div class="tab-content">
  ...
  {{% includeMarkdown "../syntax_resources/statements/analyze,table_and_columns.grammar.md" %}}
  </div>
  <div id="diagram" class="tab-pane fade" role="tabpanel" aria-labelledby="diagram-tab">
  {{% includeMarkdown "../syntax_resources/statements/analyze,table_and_columns.diagram.md" %}}
  </div>
</div>
