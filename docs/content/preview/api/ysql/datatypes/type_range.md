...
For example, to construct a multirange that consists of 2 non-overlapping ranges, you can run,
...
Range aggregation can also be performed using the `range_agg` function as :
