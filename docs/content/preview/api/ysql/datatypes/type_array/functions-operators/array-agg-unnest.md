...
if you aren't already familiar with the `\gset` meta-command, you can read a brief account of how it works in [Meta-commands](../../../../../../yugabyte-clients/ysqlsh-meta-commands/) within the major section on `ysqlsh`.
