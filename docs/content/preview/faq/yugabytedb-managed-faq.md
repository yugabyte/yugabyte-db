...
Run the [ysqlsh](../../yugabyte-clients/ysqlsh/) or [ycqlsh](../../yugabyte-clients/ycqlsh/) shell from your browser to connect to and interact with your YugabyteDB database. Cloud Shell does not require a CA certificate or any special network access configured.
...
Connect to your YugabyteDB cluster using the YugabyteDB [ysqlsh](../../yugabyte-clients/ysqlsh/) and [ycqlsh](../../yugabyte-clients/ycqlsh/) client shells installed on your computer.
