...
For YSQL, an external load balancer is recommended, or you can use a YugabyteDB smart driver. To learn more about smart drivers, refer to [YugabyteDB smart drivers for YSQL](../../drivers-orms/smart-drivers/) and the [Smart drivers FAQ](../../drivers-orms/smart-drivers-faq/).
