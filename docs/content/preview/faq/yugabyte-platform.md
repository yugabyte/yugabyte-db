...
This requirement applies only to YugabyteDB Anywhere. For a list of OSs supported by YugabyteDB, see the [Deployment checklist](../../../deploy/checklist/) for YugabyteDB.
