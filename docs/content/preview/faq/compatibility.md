...
1. [Secondary indexes](../../develop/data-modeling-ycql/#secondary-indexes) are by default strongly consistent because internally they use distributed transactions.
