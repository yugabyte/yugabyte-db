...
{{<lead link="./macos">}}
Learn more about how YugabyteDB [handles node failures](./macos).
{{</lead>}}
...
Learn more about how YugabyteDB [handles rack failures](./handling-rack-failures).
{{</lead>}}
...
Learn more about how YugabyteDB [handles zone failures](./handling-zone-failures).
{{</lead>}}
...
Learn more about how YugabyteDB [handles region failures](./handling-region-failures).
{{</lead>}}
