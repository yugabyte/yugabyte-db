...
Before you can start using the example, you need to [set up a YugabyteDB universe](../../#set-up-yugabytedb-universe). When done, create an example table with sample data, as follows:
