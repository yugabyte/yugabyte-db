...
| [Fast and consistent Secondary Indexes](../../explore/ycql-language/indexes-constraints/secondary-indexes-ycql) | Immediately consistent indexes with point lookups (no fan-out) |
| [Secondary indexes with JSONB datatype](../../explore/ycql-language/indexes-constraints/secondary-indexes-with-jsonb-ycql) | Efficient reads with consistency and flexibility in data model |
