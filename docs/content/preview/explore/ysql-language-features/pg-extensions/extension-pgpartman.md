...
Advisory locks, used in some pg_partman functions to create or drop/delete partitioned tables are not yet supported in YugabyteDB. Attempts to acquire these locks are disabled.
