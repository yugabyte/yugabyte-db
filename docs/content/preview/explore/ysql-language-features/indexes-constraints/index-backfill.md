...
1. From your local YugabyteDB installation directory, connect to the [YSQL](../../../../yugabyte-clients/ysqlsh/) shell, and create an index on an existing table as follows:
