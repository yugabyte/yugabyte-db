...
| [Colocation](colocation/) | YugabyteDB allows for closely related data to reside together via colocation. Learn how to colocate tables | Single-node<br/>local/cloud |
