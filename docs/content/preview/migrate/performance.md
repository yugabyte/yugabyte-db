...
If you use EXPERIMENTAL_FAST_EXPORT to [accelerate data export](../migrate-steps/#accelerate-data-export-optional-for-mysql-oracle-only), `--parallel-jobs` will not have any impact on performance and only one table will be exported at a time.
