...
Use [YB migration engine](../../migrate/) to automate the entire migration from PostgreSQL. Read the [Migration process overview](../migration-process-overview/) to perform an automatic migration.
