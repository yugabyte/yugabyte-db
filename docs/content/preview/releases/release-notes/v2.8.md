...
<a class="download-binary-link" href="https://downloads.yugabyte.com/releases/2.8.6.0/yugabyte-2.8.6.0-b6-darwin-x86_64.tar.gz">
  <button>
    <i class="fab fa-apple"></i><span class="download-text">macOS</span>
  </button>
</a>
&nbsp; &nbsp; &nbsp;
<a class="download-binary-link" href="https://downloads.yugabyte.com/releases/2.8.6.0/yugabyte-2.8.6.0-b6-linux-x86_64.tar.gz">
  <button>
...
<!--
&nbsp; &nbsp; &nbsp;
<a class="download-binary-link" href="https://downloads.yugabyte.com/releases/2.8.6.0/yugabyte-2.8.6.0-b6-el8-aarch64.tar.gz">
  <button>
...
```sh
docker pull yugabytedb/yugabyte:2.8.6.0-b6
```
