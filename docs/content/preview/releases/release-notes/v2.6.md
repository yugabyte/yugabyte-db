...
<a class="download-binary-link" href="https://downloads.yugabyte.com/releases/2.6.20.0/yugabyte-2.6.20.0-b10-darwin-x86_64.tar.gz">
  <button>
    <i class="fab fa-apple"></i><span class="download-text">macOS</span>
  </button>
</a>
&nbsp; &nbsp; &nbsp;
<a class="download-binary-link" href="https://downloads.yugabyte.com/releases/2.6.20.0/yugabyte-2.6.20.0-b10-linux-x86_64.tar.gz">
  <button>
...
<a class="download-binary-link" href="https://downloads.yugabyte.com/releases/2.6.19.0/yugabyte-2.6.19.0-b15-darwin-x86_64.tar.gz">
  <button>
    <i class="fab fa-apple"></i><span class="download-text">macOS</span>
  </button>
</a>
&nbsp; &nbsp; &nbsp;
<a class="download-binary-link" href="https://downloads.yugabyte.com/releases/2.6.19.0/yugabyte-2.6.19.0-b15-linux-x86_64.tar.gz">
  <button>
    <i class="fab fa-linux"></i><span class="download-text">Linux</span>
  </button>
</a>
...
<a class="download-binary-link" href="https://downloads.yugabyte.com/releases/2.6.18.0/yugabyte-2.6.18.0-b3-darwin-x86_64.tar.gz">
  <button>
    <i class="fab fa-apple"></i><span class="download-text">macOS</span>
  </button>
</a>
&nbsp; &nbsp; &nbsp;
<a class="download-binary-link" href="https://downloads.yugabyte.com/releases/2.6.18.0/yugabyte-2.6.18.0-b3-linux-x86_64.tar.gz">
  <button>
    <i class="fab fa-linux"></i><span class="download-text">Linux</span>
  </button>
</a>
