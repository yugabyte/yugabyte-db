...
## v2.17.2.0 - March 25, 2023 {#v2.17.2.0}
...
```sh
docker pull yugabytedb/yugabyte:2.17.2.0-b213
```
...
* [[14739](https://github.com/yugabyte/yugabyte-db/issues/14739)] [yugabyted] 'yugabyted configure' should work only when node is running
