...
## v2.14.6.1 - January 25, 2023 {#v2.14.6.1}

**Build:** `2.14.6.1-b2`

**Third-party licenses:** [YugabyteDB](https://downloads.yugabyte.com/releases/2.14.6.1/yugabytedb-2.14.6.1-b2-third-party-licenses.html), [YugabyteDB Anywhere](https://downloads.yugabyte.com/releases/2.14.6.1/yugabytedb-anywhere-2.14.6.1-b2-third-party-licenses.html)

### Downloads

<ul class="nav yb-pills">
  <li>
    <a href="https://downloads.yugabyte.com/releases/2.14.6.1/yugabyte-2.14.6.1-b2-darwin-x86_64.tar.gz">
        <i class="fa-brands fa-apple"></i><span>macOS</span>
    </a>
  </li>
  <li>
    <a href="https://downloads.yugabyte.com/releases/2.14.6.1/yugabyte-2.14.6.1-b2-linux-x86_64.tar.gz">
        <i class="fa-brands fa-linux"></i><span>Linux x86</span>
    </a>
  </li>
  <li>
    <a href="https://downloads.yugabyte.com/releases/2.14.6.1/yugabyte-2.14.6.1-b2-el8-aarch64.tar.gz">
...
```sh
docker pull yugabytedb/yugabyte:2.14.6.1-b2
```
...
* [PLAT-4689] [PLAT-6423] Dependency updates to address potential vulnerabilities
