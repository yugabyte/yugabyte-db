...
## v2.13.2.0 - May 12, 2022 {#v2.13.2.0}

**Build:** `2.13.2.0-b131`

### Downloads

<a class="download-binary-link" href="https://downloads.yugabyte.com/releases/2.13.2.0/yugabyte-2.13.2.0-b131-darwin-x86_64.tar.gz">
  <button>
    <i class="fab fa-apple"></i><span class="download-text">macOS</span>
  </button>
</a>
&nbsp; &nbsp; &nbsp;
<a class="download-binary-link" href="https://downloads.yugabyte.com/releases/2.13.2.0/yugabyte-2.13.2.0-b131-linux-x86_64.tar.gz">
  <button>
    <i class="fab fa-linux"></i><span class="download-text">Linux x86</span>
  </button>
</a>
&nbsp; &nbsp; &nbsp;
<a class="download-binary-link" href="https://downloads.yugabyte.com/releases/2.13.2.0/yugabyte-2.13.2.0-b131-el8-aarch64.tar.gz">
  <button>
...
```sh
docker pull yugabytedb/yugabyte:2.13.2.0-b122
```
