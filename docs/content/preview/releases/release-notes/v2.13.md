...
## v2.13.2.0 - May 16, 2022 {#v2.13.2.0}

**Build:** `2.13.2.0-b132`

### Downloads

<a class="download-binary-link" href="https://downloads.yugabyte.com/releases/2.13.2.0/yugabyte-2.13.2.0-b132-darwin-x86_64.tar.gz">
  <button>
    <i class="fab fa-apple"></i><span class="download-text">macOS</span>
  </button>
</a>
&nbsp; &nbsp; &nbsp;
<a class="download-binary-link" href="https://downloads.yugabyte.com/releases/2.13.2.0/yugabyte-2.13.2.0-b132-linux-x86_64.tar.gz">
  <button>
    <i class="fab fa-linux"></i><span class="download-text">Linux x86</span>
  </button>
</a>
&nbsp; &nbsp; &nbsp;
<a class="download-binary-link" href="https://downloads.yugabyte.com/releases/2.13.2.0/yugabyte-2.13.2.0-b132-el8-aarch64.tar.gz">
  <button>
...
```sh
docker pull yugabytedb/yugabyte:2.13.2.0-b132
```
...
* [PLAT-3469] Expand Universe for onprem failing
...
* [PLAT-3842] Backup listing fixes
...
* [Platform] [Kubernetes client] Use pullSecret from disk (#12072)
* [Platform] Only reinstall selinux-policy if the SSH port is being changed
* [Platform] Delete static IP used by a universe on universe destruction
