...
<ul class="nav yb-pills">
  <li>
    <a href="https://downloads.yugabyte.com/releases/2.17.3.0/yugabyte-v2.19.0.0-b190-darwin-x86_64.tar.gz">
...
* [[16139](https://github.com/yugabyte/yugabyte-db/issues/16139)] build: add check to detect whether cmake exists (#16921)
...
* [[15388](https://github.com/yugabyte/yugabyte-db/issues/15388)] [YSQL] Add global-DDL test cases
* [[16369](https://github.com/yugabyte/yugabyte-db/issues/16369)] [DocDB] Use default values for packed columns flags in cross feature backup tests.
* [[16797](https://github.com/yugabyte/yugabyte-db/issues/16797)] [xCluster] Adding simple broadcast topology test
* [[16805](https://github.com/yugabyte/yugabyte-db/issues/16805)] [DocDB] Split PgMiniTest into smaller ones
* [[16815](https://github.com/yugabyte/yugabyte-db/issues/16815)] test: move pgaudit regress test to contrib
* [[16816](https://github.com/yugabyte/yugabyte-db/issues/16816)] test: port onek2, tenk2 regress test queries
* [[16831](https://github.com/yugabyte/yugabyte-db/issues/16831)] test: improve porting of pgaudit regress test
* [[16926](https://github.com/yugabyte/yugabyte-db/issues/16926)] [YSQL] make some regress test indexes ASC
* [[16943](https://github.com/yugabyte/yugabyte-db/issues/16943)] [xCluster] Convert all transactional xCluster tests to new mode, switch xcluster_safe_time, xcluster_ysql-test tests to use consistent WAL mode
* [[16972](https://github.com/yugabyte/yugabyte-db/issues/16972)] [YSQL] Move catalog version related tests out of pg_libpq-test.cc
* [[17161](https://github.com/yugabyte/yugabyte-db/issues/17161)] [YCQL] Fixed TestJsonIndex.testIndexEscapeName test
* [[17233](https://github.com/yugabyte/yugabyte-db/issues/17233)] [CDCSDK] Add time based retry for Get/Set Checkpoint RPC calls in ctests
* [[17252](https://github.com/yugabyte/yugabyte-db/issues/17252)] [YSQL] Reverting changes to Postgres regress tests
* [[6987](https://github.com/yugabyte/yugabyte-db/issues/6987)] test: remove some redundant regress test queries
* [[6987](https://github.com/yugabyte/yugabyte-db/issues/6987)] [YSQL] add yb_dep_ regress tests for dependencies
