...
## v2.19.2.0 - September 5, 2023 {#v2.19.2.0}
...
<ul class="nav yb-pills">
  <li>
    <a href="https://downloads.yugabyte.com/releases/2.19.2.0/yugabyte-2.19.2.0-b111-darwin-x86_64.tar.gz">
      <i class="fa-brands fa-apple"></i>
      <span>macOS</span>
    </a>
  </li>
  <li>
    <a href="https://downloads.yugabyte.com/releases/2.19.2.0/yugabyte-2.19.2.0-b111-linux-x86_64.tar.gz">
      <i class="fa-brands fa-linux"></i>
      <span>Linux x86</span>
    </a>
  </li>
  <li>
    <a href="https://downloads.yugabyte.com/releases/2.19.2.0/yugabyte-2.19.2.0-b111-el8-aarch64.tar.gz">
      <i class="fa-brands fa-linux"></i>
      <span>Linux ARM</span>
    </a>
  </li>
...
```sh
docker pull yugabytedb/yugabyte:2.19.2.0-b111
```
...
* [[10429](https://github.com/yugabyte/yugabyte-db/issues/10429)] [YSQL] Follow-up adding a test case
...
* [[16926](https://github.com/yugabyte/yugabyte-db/issues/16926)] test: add missed "ASC" to pg_regress index
* [[16927](https://github.com/yugabyte/yugabyte-db/issues/16927)] [YSQL] Uncomment test statements that are now working
...
* [[18136](https://github.com/yugabyte/yugabyte-db/issues/18136)] [xCluster] Async tasks to download snapshot files
* [[18136](https://github.com/yugabyte/yugabyte-db/issues/18136)] [xCluster] New endpoint to bootstrap and setup replication automatically
* [[18136](https://github.com/yugabyte/yugabyte-db/issues/18136)] [xCluster] SetupNamespaceReplicationWithBootstrap create snapshot on producer and import on consumer for
...
* [[18547](https://github.com/yugabyte/yugabyte-db/issues/18547)] [xCluster] Make SetupReplicationWithBootstrapAsync
...
* [[18552](https://github.com/yugabyte/yugabyte-db/issues/18552)] [xCluster] Speedup test setup
...
* [[18570](https://github.com/yugabyte/yugabyte-db/issues/18570)] [YSQL] Distinct pushdown support for join queries
* [[18570](https://github.com/yugabyte/yugabyte-db/issues/18570)] [YSQL] Separate distinct pushdown related API into a separate file
...
* [[18612](https://github.com/yugabyte/yugabyte-db/issues/18612)] Limit Java test method timeout to 30 minutes
