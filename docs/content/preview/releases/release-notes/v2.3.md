...
* Redirect from login back to index if session is already validated. Logout should redirect to log in endpoint. [#5019](https://github.com/yugabyte/yugabyte-db/issues/5019)
