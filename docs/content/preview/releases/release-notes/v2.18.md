...
* Using pg_stat_statements, it is now possible to get a latency histogram of a query. Refer to pg_stat_statements ( https://docs.yugabyte.com/preview/explore/query-1-performance/pg-stat-statements/ ) for more details.
