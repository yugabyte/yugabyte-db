...
* Introduces sorting capabilities to BNL nodes offering more efficient ordering for BNL queries while also adding the `yb_bnl_optimize_first_batch` GUC flag for better control. {{<issue 19589>}}
