...
* In Read Commited Isolation, limit the number of retry attemps when the aborted query is retried. {{<issue 20359>}}
...
* In Read Commited Isolation, immediately abort transactions when conflict is detected. {{<issue 20329>}}
