...
<ul class="nav yb-pills">
 <li>
   <a href="https://downloads.yugabyte.com/releases/2.18.5.0/yugabyte-2.18.5.0-b60-darwin-x86_64.tar.gz">
     <i class="fa-brands fa-apple"></i>
     <span>macOS</span>
   </a>
 </li>
 <li>
   <a href="https://downloads.yugabyte.com/releases/2.18.5.0/yugabyte-2.18.5.0-b60-linux-x86_64.tar.gz">
     <i class="fa-brands fa-linux"></i>
     <span>Linux x86</span>
   </a>
 </li>
 <li>
   <a href="https://downloads.yugabyte.com/releases/2.18.5.0/yugabyte-2.18.5.0-b60-el8-aarch64.tar.gz">
     <i class="fa-brands fa-linux"></i>
     <span>Linux ARM</span>
   </a>
 </li>
...
```sh
docker pull yugabytedb/yugabyte:2.18.5.0-b60
```
...
* [[15273](https://github.com/yugabyte/yugabyte-db/issues/15273)] [DocDB] Replace `glog/logging.h` includes with `yb/util/logging.h` and print the verbose level for VLOG
* [[17508](https://github.com/yugabyte/yugabyte-db/issues/17508)] [YSQL] Enhance auto_explain to print distributed stats in explain analyze
...
* [[19457](https://github.com/yugabyte/yugabyte-db/issues/19457)] [YSQL] Backups: Modify YSQLDump to generate create index NONCONCURRENTLY
...
* [[14419](https://github.com/yugabyte/yugabyte-db/issues/14419)] [YSQL] Import 'Reject substituting extension schemas or owners matching ["$'\]'.
* [[16181](https://github.com/yugabyte/yugabyte-db/issues/16181)] [DocDB] Add Version info to AutoFlag not found error
...
* [[18000](https://github.com/yugabyte/yugabyte-db/issues/18000)] [YSQL] Avoid postmaster crash during reaper LWLockQueueSelf
...
* [[19509](https://github.com/yugabyte/yugabyte-db/issues/19509)] [YSQL] Fix YB does not release LWLocks on AbortTransaction
* [[19514](https://github.com/yugabyte/yugabyte-db/issues/19514)] [DocDB] Do not ignore replicas on dead tservers in under-replicated endpoint
* [[19524](https://github.com/yugabyte/yugabyte-db/issues/19524)] [xCluster] Check for null pointer of CDCTabletMetrics
...
* [[19672](https://github.com/yugabyte/yugabyte-db/issues/19672)] [YSQL] Avoid segmentation fault in stats collector after Postmaster reset
* [[19691](https://github.com/yugabyte/yugabyte-db/issues/19691)] [DocDB] Added SST files tail check for zero bytes
* [[19727](https://github.com/yugabyte/yugabyte-db/issues/19727)] [DocDB] Fix use-after-free issue in RefinedStream::Connected failure path
* [[19732](https://github.com/yugabyte/yugabyte-db/issues/19732)] [YSQL] Import 'pgcrypto: Check for error return of px_cipher_decrypt()'
* [[19733](https://github.com/yugabyte/yugabyte-db/issues/19733)] [YSQL] Import 'Disable OpenSSL EVP digest padding in pgcrypto'
* [[19734](https://github.com/yugabyte/yugabyte-db/issues/19734)] [YSQL] Import 'Add alternative output for OpenSSL 3 without legacy loaded'
* [[19737](https://github.com/yugabyte/yugabyte-db/issues/19737)] [YSQL] Fix post-process not running on alternative expected outputs for pg_regress
...
* [[19846](https://github.com/yugabyte/yugabyte-db/issues/19846)] [DocDB] Round-robin drive selection during tablet creation for wals/data dirs
* [[19876](https://github.com/yugabyte/yugabyte-db/issues/19876)] [DocDB] Add more debug info for investigating read path failure with error Expecting hybrid time
* [[19879](https://github.com/yugabyte/yugabyte-db/issues/19879)] [DocDB] Fix (namespace-level) CDC stream deletion path when dropping a ysql database
* [[19904](https://github.com/yugabyte/yugabyte-db/issues/19904)] [DocDB] Fix Tablets_overhead mem_tracker for Master and TServer
...
* [DB-8759] [yugabyted] Fix tablet page not loading when leader master fails
