...
## v2.18.2.0 - August 5, 2023 {#v2.18.2.0}

**Build:** `2.18.2.0-b99`

**Third-party licenses:** [YugabyteDB](https://downloads.yugabyte.com/releases/2.18.2.0/yugabytedb-2.18.2.0-b99-third-party-licenses.html), [YugabyteDB Anywhere](https://downloads.yugabyte.com/releases/2.18.2.0/yugabytedb-anywhere-2.18.2.0-b99-third-party-licenses.html)

### Downloads

<ul class="nav yb-pills">
 <li>
   <a href="https://downloads.yugabyte.com/releases/2.18.2.0/yugabyte-2.18.2.0-b99-darwin-x86_64.tar.gz">
     <i class="fa-brands fa-apple"></i>
     <span>macOS</span>
   </a>
 </li>
 <li>
   <a href="https://downloads.yugabyte.com/releases/2.18.2.0/yugabyte-2.18.2.0-b99-linux-x86_64.tar.gz">
     <i class="fa-brands fa-linux"></i>
     <span>Linux x86</span>
   </a>
 </li>
 <li>
   <a href="https://downloads.yugabyte.com/releases/2.18.2.0/yugabyte-2.18.2.0-b99-el8-aarch64.tar.gz">
     <i class="fa-brands fa-linux"></i>
     <span>Linux ARM</span>
   </a>
 </li>
...
```sh
docker pull yugabytedb/yugabyte:2.18.2.0-b99
```
