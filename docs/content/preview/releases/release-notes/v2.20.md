...
* Support for ALTER COLUMN TYPE with on-disk changes. Expand ALTER TABLE capabilities with a broader range of data type modifications, including changes to the type itself, not just size increments.
