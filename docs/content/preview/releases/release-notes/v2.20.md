...
* Alleviates database deletion failures by skipping replication checks for dropped tables during the database drop process, addressing errors related to missing streams. {{<issue 21070>}}
...
* Disables the packed row feature for colocated tables to prevent the surfacing of issue 20638 that causes subsequent write failures after certain compactions. {{<issue 21047>}}
