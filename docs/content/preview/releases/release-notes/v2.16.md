...
## v2.16.8.0 - September 15, 2023 {#v2.16.8.0}

**Build:** `2.16.8.0-b7`

**Third-party licenses:** [YugabyteDB](https://downloads.yugabyte.com/releases/2.16.8.0/yugabytedb-2.16.8.0-b7-third-party-licenses.html), [YugabyteDB Anywhere](https://downloads.yugabyte.com/releases/2.16.8.0/yugabytedb-anywhere-2.16.8.0-b7-third-party-licenses.html)

### Downloads

<ul class="nav yb-pills">
  <li>
    <a href="https://downloads.yugabyte.com/releases/2.16.8.0/yugabyte-2.16.8.0-b7-darwin-x86_64.tar.gz">
        <i class="fa-brands fa-apple"></i><span>macOS</span>
    </a>
  </li>
  <li>
    <a href="https://downloads.yugabyte.com/releases/2.16.8.0/yugabyte-2.16.8.0-b7-linux-x86_64.tar.gz">
        <i class="fa-brands fa-linux"></i><span>Linux x86</span>
    </a>
  </li>
  <li>
    <a href="https://downloads.yugabyte.com/releases/2.16.8.0/yugabyte-2.16.8.0-b7-el8-aarch64.tar.gz">
...
```sh
docker pull yugabytedb/yugabyte:2.16.8.0-b7
```
