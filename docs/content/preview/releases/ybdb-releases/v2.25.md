...
* YugabyteDB now supports the ability to compute multivariate statistics using the [*CREATE STATISTICS*](../../../develop/pg15-features) command. This feature allows the query planner to use cross-column correlation statistics to generate better query plans. {{<tags/feature/tp>}} {{<issue 13598>}}
