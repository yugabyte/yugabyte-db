...
In addition, the Active Session History, which provides real-time and historical views of system activity, is now enabled by default. For more information, refer to [Active Session History](../../../explore/observability/active-session-history/) (ASH) documentation.
