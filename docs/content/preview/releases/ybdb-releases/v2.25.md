...
YugabyteDB now supports [in-place zero downtime upgrade from a PostgreSQL 11](../../../manage/upgrade-deployment/)-compatible (v2024.2.2) release to a PostgreSQL 15-compatible (v2.25.1) release. This capability allows PostgreSQL major version upgrade without any downtime or interruption to the application.

### New features

* [PostgreSQL Anonymizer](../../../explore/ysql-language-features/pg-extensions/extension-pganon/), which masks or replaces personally identifiable information (PII) or commercially sensitive data, is now bundled with YugabyteDB. {{<tags/feature/tp idea="1497">}} <!-- IDEA-1497 -->
