...
* [xCluster observability](/stable/yugabyte-platform/alerts-monitoring/alert-policy-templates/#xcluster-config-tables-are-in-bad-state). Added ability for users to monitor xCluster metrics like Replication Lag, Safetime Lag, and replication errors, with support runbooks for troubleshooting via YB-Master/YB-TServer UIs, YugabyteDB Anywhere dashboards, and logs. {{<tags/feature/ea>}}
