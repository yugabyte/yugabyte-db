...
<ul class="nav yb-pills">
  <li>
    <a href="https://downloads.yugabyte.com/releases/2024.2.0.0/yugabyte-2024.2.0.0-b135-darwin-x86_64.tar.gz">
      <i class="fa-brands fa-apple"></i>
      <span>macOS</span>
    </a>
  </li>
  <li>
    <a href="https://downloads.yugabyte.com/releases/2024.2.0.0/yugabyte-2024.2.0.0-b135-linux-x86_64.tar.gz">
      <i class="fa-brands fa-linux"></i>
      <span>Linux x86</span>
    </a>
  </li>
  <li>
    <a href="https://downloads.yugabyte.com/releases/2024.2.0.0/yugabyte-2024.2.0.0-b135-el8-aarch64.tar.gz">
      <i class="fa-brands fa-linux"></i>
      <span>Linux ARM</span>
    </a>
  </li>
...
* [Colocated tables with tablespaces](/stable/explore/colocation/#colocated-tables-with-tablespaces). Added the ability to assign tablespaces to colocated tables. This eliminates the need for trade-offs, allowing organizations to adhere to compliance requirements while benefiting from the efficiency of colocated tables and relations. By ensuring all colocated tables in a tablespace reside in the same tablet, this feature optimizes both data management and operational efficiency. {{<tags/feature/ea>}}
...
* Catalog caching. Provides ability to find catalog tables which can be pre-loaded to improve latency for first query in connection or after a DDL change in the cluster. {{<tags/feature/ea>}}
...
<!-- No docs given, so linking it to existing built-in connection manager-->
...
* Reuses Tservers `yb::client` in `CDCService` to reduce resource usage and fix optimization issues. {{<issue 22893>}}
...
* Refactors xCluster replication setup, bootstrap, alter, and delete functions for better organization. {{<issue 23183>}}
* Ensures debug builds can restart from release builds by making column ID representations consistent. {{<issue 21093>}}
* Refactors code for clearer maintenance and separation of XCluster and CDCSDK functionalities. {{<issue 23301>}}
...
* Refactors tablet splitting logic to enhance system organization and management. {{<issue 22603>}},{{<issue 19715>}}
...
* Eliminates memory leaks in YSQL's cache system for improved database stability. {{<issue 22262>}}
...
* Refactors `yb_cost_index` to enhance readability, performance, and ease PG15 merging. {{<issue 21672>}}
...
* Reenables rechecking for RowCompareExpressions to enhance accuracy with NULL inputs. {{<issue 22075>}}
