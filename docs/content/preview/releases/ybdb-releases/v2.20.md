...
## v2.20.2.2 - March 22, 2024 {#v2.20.2.2}
...
This is a [YugabyteDB Anywhere-only release](https://docs.yugabyte.com/preview/releases/yba-releases/v2.20/#v2.20.2.2), with no changes to the database.
...
This is a [YugabyteDB Anywhere-only release](https://docs.yugabyte.com/preview/releases/yba-releases/v2.20/#v2.20.0.2), with no changes to the database.
