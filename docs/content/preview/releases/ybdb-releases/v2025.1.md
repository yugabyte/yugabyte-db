...
Improves query performance for colocated tables by allowing PostgreSQL to leverage multiple CPUs, leading to faster query execution times. For more information, refer to [Parallel queries](/stable/additional-features/advanced-features/parallel-query/).
