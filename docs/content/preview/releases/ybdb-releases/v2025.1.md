...
<ul class="nav yb-pills">
  ...
  <li>
    <a href="https://downloads.yugabyte.com/releases/2025.1.0.0/yugabyte-2025.1.0.0-b168-darwin-arm63.tar.gz">
      <i class="fa-brands fa-apple"></i>
      <span>macOS ARM</span>
    </a>
  </li>
...
- [YSQL lease mechanism](/stable/architecture/transactions/concurrency-control/#ysql-lease-mechanism-for-dml-and-ddl-concurrency). Enabled a robust lease mechanism between YB-TServer and YB-Master to enhance fault tolerance and data consistency during network partitions. {{<tags/feature/ga>}}
