...
<ul class="nav yb-pills">
  <li>
    <a href="https://downloads.yugabyte.com/releases/2025.1.1.0/yugabyte-2025.1.1.0-b196-darwin-x86_64.tar.gz">
      <i class="fa-brands fa-apple"></i>
      <span>macOS x86</span>
    </a>
  </li>
  <li>
    <a href="https://downloads.yugabyte.com/releases/2025.1.1.0/yugabyte-2025.1.1.0-b196-darwin-arm64.tar.gz">
      <i class="fa-brands fa-apple"></i>
      <span>macOS ARM</span>
    </a>
  </li>
  <li>
    <a href="https://downloads.yugabyte.com/releases/2025.1.1.0/yugabyte-2025.1.1.0-b196-linux-x86_64.tar.gz">
      <i class="fa-brands fa-linux"></i>
      <span>Linux x86</span>
    </a>
  </li>
  <li>
    <a href="https://downloads.yugabyte.com/releases/2025.1.1.0/yugabyte-2025.1.1.0-b196-el8-aarch64.tar.gz">
      <i class="fa-brands fa-linux"></i>
      <span>Linux ARM</span>
    </a>
  </li>
...
```sh
docker pull yugabytedb/yugabyte:2025.1.1.0-b196
```
...
For more information, refer to [Table-level locks](/stable/explore/transactions/explicit-locking/#table-level-locks).
...
For more information, refer to [Change data capture (CDC)](/stable/additional-features/change-data-capture/).
...
* Added support for SCRAM-based password authentication in [Connection pooling](/stable/additional-features/connection-manager-ysql/ycm-setup/#authentication-methods), enhancing security beyond the previously supported MD5 method. {{<tags/feature/ea idea="2194">}}

* [Query diagnostics](/stable/explore/query-1-performance/query-diagnostics/). You can use a new YSQL function `yb_query_diagnostics`, to create a diagnostics bundle for a normalised YSQL query for a time range to speed up troubleshooting. The bundle contains critical data like the EXPLAIN PLAN, bind variables, pg_statement_stats, schema details, and Active Session History. {{<tags/feature/ea idea="1591">}}
...
* Enables specific PostgreSQL isolation tests requiring advisory lock support. {{<issue 27518>}}
...
- Execution for queries using [InsertOnConflict clause](/preview/develop/best-practices-develop/data-modeling-perf/#upsert-multiple-rows-wherever-possible) are optimized for efficient execution for YugabyteDB distributed architecture. {{<tags/feature/ga idea="1455">}}
...
- [PostgreSQL Anonymizer](/preview/additional-features/pg-extensions/extension-pganon/) extension, which masks or replaces personally identifiable information (PII) or commercially sensitive data, is now bundled with Yugabyte. {{<tags/feature/ga idea="1497">}}
