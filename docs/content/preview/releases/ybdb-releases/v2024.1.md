...
- yugabyted
  ...
  - [Backup/restore support with TLS enabled](/stable/reference/configuration/yugabyted/#restore). In secure mode, yugabyted cluster supports taking full backup/restores.
