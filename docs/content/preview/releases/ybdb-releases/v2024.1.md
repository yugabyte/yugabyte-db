...
- [PG syntax for CDC](/preview/explore/change-data-capture/using-logical-replication/). Added Support for PG-Compatible Logical Replication with Publication and Replication Slot API. <!-- IDEA-805 -->
