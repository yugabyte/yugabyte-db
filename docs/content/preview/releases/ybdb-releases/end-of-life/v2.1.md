...
<ul class="nav yb-pills">
  <li>
    <a href="https://software.yugabyte.com/yugabyte-2.1.0.0-darwin.tar.gz">
        <i class="fa-brands fa-apple"></i><span>macOS</span>
    </a>
  </li>
  <li>
    <a href="https://software.yugabyte.com/yugabyte-2.1.0.0-linux.tar.gz">
...
<ul class="nav yb-pills">
  <li>
    <a href="https://software.yugabyte.com/yugabyte-2.1.1.0-darwin.tar.gz">
        <i class="fa-brands fa-apple"></i><span>macOS</span>
    </a>
  </li>
  <li>
    <a href="https://software.yugabyte.com/yugabyte-2.1.1.0-linux.tar.gz">
        <i class="fa-brands fa-linux"></i><span>Linux</span>
    </a>
  </li>
</ul>
...
<ul class="nav yb-pills">
  <li>
    <a href="https://software.yugabyte.com/yugabyte-2.1.2.0-darwin.tar.gz">
        <i class="fa-brands fa-apple"></i><span>macOS</span>
    </a>
  </li>
  <li>
    <a href="https://software.yugabyte.com/yugabyte-2.1.2.0-linux.tar.gz">
        <i class="fa-brands fa-linux"></i><span>Linux</span>
    </a>
  </li>
</ul>
...
<ul class="nav yb-pills">
  <li>
    <a href="https://software.yugabyte.com/yugabyte-2.1.3.0-darwin.tar.gz">
        <i class="fa-brands fa-apple"></i><span>macOS</span>
    </a>
  </li>
  <li>
    <a href="https://software.yugabyte.com/yugabyte-2.1.3.0-linux.tar.gz">
        <i class="fa-brands fa-linux"></i><span>Linux</span>
    </a>
  </li>
</ul>
...
<ul class="nav yb-pills">
  <li>
    <a href="https://software.yugabyte.com/yugabyte-2.1.4.0-darwin.tar.gz">
        <i class="fa-brands fa-apple"></i><span>macOS</span>
    </a>
  </li>
  <li>
    <a href="https://software.yugabyte.com/yugabyte-2.1.4.0-linux.tar.gz">
        <i class="fa-brands fa-linux"></i><span>Linux</span>
    </a>
  </li>
</ul>
...
**New to YugabyteDB?** Follow [Quick start](/preview/tutorials/quick-start/macos/) to get started and running in less than five minutes.
...
<ul class="nav yb-pills">
  <li>
    <a href="https://software.yugabyte.com/yugabyte-2.1.5.0-darwin.tar.gz">
        <i class="fa-brands fa-apple"></i><span>macOS</span>
    </a>
  </li>
  <li>
    <a href="https://software.yugabyte.com/yugabyte-2.1.5.0-linux.tar.gz">
        <i class="fa-brands fa-linux"></i><span>Linux</span>
    </a>
  </li>
</ul>
...
<ul class="nav yb-pills">
  <li>
    <a href="https://software.yugabyte.com/yugabyte-2.1.6.0-darwin.tar.gz">
        <i class="fa-brands fa-apple"></i><span>macOS</span>
    </a>
  </li>
  <li>
    <a href="https://software.yugabyte.com/yugabyte-2.1.6.0-linux.tar.gz">
        <i class="fa-brands fa-linux"></i><span>Linux</span>
    </a>
  </li>
</ul>
...
<ul class="nav yb-pills">
  <li>
    <a href="https://software.yugabyte.com/yugabyte-2.1.8.2-darwin.tar.gz">
        <i class="fa-brands fa-apple"></i><span>macOS</span>
    </a>
  </li>
  <li>
    <a href="https://software.yugabyte.com/yugabyte-2.1.8.2-linux.tar.gz">
        <i class="fa-brands fa-linux"></i><span>Linux</span>
    </a>
  </li>
</ul>
