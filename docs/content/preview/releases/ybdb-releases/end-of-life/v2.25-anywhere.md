...
* [PostgreSQL Anonymizer](../../../additional-features/pg-extensions/extension-pganon/) extension, which masks or replaces personally identifiable information (PII) or commercially sensitive data, is now bundled with YugabyteDB. {{<tags/feature/tp idea="1497">}} <!-- IDEA-1497 -->

* YugabyteDB now supports the ability to compute multivariate statistics using the [CREATE STATISTICS](https://www.postgresql.org/docs/15/sql-createstatistics.html) command. Part of [PostgreSQL 15](/preview/api/ysql/pg15-features), this feature allows the query planner to use cross-column correlation statistics to generate better query plans. {{<tags/feature/tp>}} {{<issue 13598>}}
