...
## v2.18.9.0 - August 14, 2024 {#v2.18.9.0}
...
* [Faster nested loops with batching](../../../explore/ysql-language-features/join-strategies/#batched-nested-loop-join-bnl). Requests to YB-TServers are batched during joins using a new join execution method referenced as Batched Nested Loop, and derived from classic nested loop joins. {{<badge/ea>}}
