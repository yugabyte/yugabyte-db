...
* [YSQL Connection Manager](../../../explore/going-beyond-sql/connection-mgr-ysql/) {{<badge/tp>}}, a built-in server side connection pooling mechanism that overcomes SQL support limitations of some popular pooling mechanisms such as PgBouncer and Odyssey.
