...
- The table or index involved in xCluster replication is [range sharded](../../../architecture/docdb-sharding/sharding/#range-sharding). ([Hash sharded](../../../architecture/docdb-sharding/sharding/#hash-sharding) tables or indexes are not affected by this issue).
