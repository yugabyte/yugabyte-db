...
1. Upgrade YugabyteDB Anywhere to the latest version of your current branch using Replicated.
1. Upgrade YugabyteDB Anywhere to the latest v2.18 using Replicated.
