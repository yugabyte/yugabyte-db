...
YugabyteDB Anywhere will end support for Replicated installation at the end of 2024. The 2024.1 release is not available for installation using Replicated.

If you have a Replicated installation, you must migrate from Replicated to YBA Installer before upgrading YBA to v2024.1. See [Migrate from Replicated](../../../yugabyte-platform/install-yugabyte-platform/migrate-replicated/).
{{</warning>}}
