...
- [Database registration simplification](../../../yugabyte-platform/manage-deployments/ybdb-releases/). Simplification of process for registering database versions (and their binaries) with YBA. For internet-connected, it's fully automated. For air-gapped, the UX has been dramatically simplified. {{<badge/ea>}}
