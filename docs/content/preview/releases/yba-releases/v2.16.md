...
* Expands the YBA to include the `ap-south-2` region and updates AWS AMIs to version 8.8, providing more flexibility for customers setting up DR environments. PLAT-10407
