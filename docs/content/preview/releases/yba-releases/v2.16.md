...
YugabyteDB database releases prior to v2.16.1.1 contain a ...

If you're using a previous 2.16 database version and can't upgrade YBA and your database immediately ...
{{< /warning >}}
