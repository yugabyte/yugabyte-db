...
## v2.19.3.0 - October 24, 2023 {#v2.19.3.0}

**Build:** `2.19.3.0-b139`

**Third-party licenses:** [YugabyteDB](https://downloads.yugabyte.com/releases/2.19.3.0/yugabytedb-2.19.3.0-b139-third-party-licenses.html), [YugabyteDB Anywhere](https://downloads.yugabyte.com/releases/2.19.3.0/yugabytedb-anywhere-2.19.0.0-b139-third-party-licenses.html)
...
* [PLAT-10311] [PLAT-7272] Fix Disable Enable button while enableYSQL is disabled, gflags reverted to NPE while validating flags
...
* [PLAT-10406] Fix YBC backup config object creation for encrypted universes
...
* [PLAT-10436] Ignore backup metadata validation during restore in case backup config is empty
...
* [PLAT] Fix kubernetes operator config in the helm chart to work with latest runtime config changes
