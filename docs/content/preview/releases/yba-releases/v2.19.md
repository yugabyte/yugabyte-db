...
<!-- **Third-party licenses:** [YugabyteDB](https://downloads.yugabyte.com/releases/2.19.0.0/yugabytedb-2.19.0.0-b187-third-party-licenses.html), [YugabyteDB Anywhere](https://downloads.yugabyte.com/releases/2.19.0.0/yugabytedb-anywhere-2.19.0.0-b187-third-party-licenses.html) -->

### Docker

```sh
docker pull yugabytedb/yugabyte:2.19.0.0-b187
```
...
* [PLAT-4624] Add GFLAGS for raft interval in case of multiregion deployment
...
* [PLAT-7425] [SSO]Unit test for new runtime config for OIDC
...
* [PLAT-7729] Fixing go dependancies on node-agent and yba-installer
* [PLAT-7729] Fixing golang and java dependancies
...
* [PLAT-7837] Adds AZ name/code validation for onprem provider
...
* [PLAT-8034] [Master] KMS Config is not displayed in Backup Details Page
...
* [PLAT-8127] Stop ybc process during deletion of Universe for onprem universes
...
* [PLAT-8190] [Platform]Back to back disk resize will render the universe unusable
...
* [PLAT-8363] Fix DB migration version
* [PLAT-8363] Put alert rule strings in double quotes
* [PLAT-8366] [PLAT-8387] Scheduled backup configs are not displayed in UI.
* [PLAT-8369] Software upgrade on a ybc universe causing controller container to get removed
* [PLAT-8373] Remove pre-populate zone kube config logic
...
* [PLAT-8397] Node stop/removal must ensure the number of tservers does not drop below quorum for dedicated masters
...
* [PLAT-8406] Change runtime config for boolean fields from dropdown to toggle
...
* [PLAT-8421] [Part -2] Making DestroyKubernetesUniverse retryable
* [PLAT-8421] Making CreateKubernetesUniverse support abort and retry operations.
...
* [PLAT-8469] Run perf advisor script on TServer nodes only
...
* [PLAT-8498] Incorrect throttle parameter values for dedicated nodes/K8s pods
...
* [PLAT-8532] Fix : Universe name validation missing for GCP and kubernetes universe
...
* [PLAT-8582] Perform comprehensive Azure storage config validation by writing/listing/deleting
...
* [PLAT-8832] Upgrade YBC version to 2.0.0.0-b1
...
* [PLAT-7960] retry AWS volume mod + print failure status msg
