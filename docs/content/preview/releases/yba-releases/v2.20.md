...
The impacted releases contain a correctness issue for queries using SELECT DISTINCT clause. To encounter this issue, both of the following conditions need to be true:
...
The queries may return incorrect results when the following conditions are true:
