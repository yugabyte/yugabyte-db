...
* [Delphix integration](../../../integrations/delphix/). Use YugabyteDB with Delphix for continuous data (Data Virtualization) and continuous compliance (Data Masking) capabilities.
* [OS Patching for CSPs](/stable/yugabyte-platform/manage-deployments/upgrade-nodes-csp/). PLAT-9012
* Support different proxy setting for each region. {{<badge/ea>}} PLAT-12604
* [Tesco] Support for directly specified images in Azure provider. PLAT-12814
* [Roll back a YugabyteDB upgrade in YBA](/stable/yugabyte-platform/manage-deployments/upgrade-software-install/). {{<badge/ea>}}
* Request to Productize the ysql client. {{<badge/ea>}}
