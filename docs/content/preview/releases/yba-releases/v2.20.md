...
* Automated [Linux OS patching](../../../yugabyte-platform/manage-deployments/upgrade-nodes/) and upgrades for on-prem. You can now utilize safety-improved YugabyteDB  Anywhere APIs when automating you rolling patch scripts for Linux OSs (typically, for OS security, and minor or major OS upgrades). PLAT-10591, PLAT-10988

* REST API versioning and clean-up. REST API simplification and streamlining for most important APIs. PLAT-11133

* YugabyteDB Anywhere (YBA) and YugabyteDB version compatibility list. You can now independently upgrade YBA without upgrading the YugabyteDB universes. All supported YugabyteDB versions are compatible. PLAT-11260
