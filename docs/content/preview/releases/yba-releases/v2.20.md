...
* Replaces multi-statement queries with single statements to prevent crashes and adds re-checks to avoid false positives in health checks. PLAT-15726,PLAT-15735 
