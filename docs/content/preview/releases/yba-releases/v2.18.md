...
## v2.18.0.1 - May 24, 2023 {#v2.18.0.1}

**Build:** `2.18.0.1-b1`

**Third-party licenses:** [YugabyteDB](https://downloads.yugabyte.com/releases/2.18.0.1/yugabytedb-2.18.0.1-b1-third-party-licenses.html), [YugabyteDB Anywhere](https://downloads.yugabyte.com/releases/2.18.0.0/yugabytedb-anywhere-2.18.0.0-b1-third-party-licenses.html)

### Docker

```sh
docker pull yugabytedb/yugabyte:2.18.0.1-b1
```
