...
## v2.18.3.0 - September 7, 2023 {#v2.18.3.0}

**Build:** `2.18.3.0-b59`

**Third-party licenses:** [YugabyteDB](https://downloads.yugabyte.com/releases/2.18.3.0/yugabytedb-2.18.3.0-b59-third-party-licenses.html), [YugabyteDB Anywhere](https://downloads.yugabyte.com/releases/2.18.3.0/yugabytedb-anywhere-2.18.3.0-b59-third-party-licenses.html)
...
* Use the YugabyteDB Anywhere trust store to manage custom and self-signed certificates for OIDC. YBA uses the trust store to verify the authenticity of TLS certificates.
...
* [PLAT-8984] Add UI support to configure DB APIs
...
* Support for GCP [instance templates](https://cloud.google.com/compute/docs/instance-templates). When deploying universes on GCP using a provider configured with a template, instances are created based on template parameters, allowing customizations such as GCP encrypted memory and disk, TPM, solo tenancy, and more.
