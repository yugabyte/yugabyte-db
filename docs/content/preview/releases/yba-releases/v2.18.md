...
* Improvements to xCluster replication, including:
...
* Enhanced LDAP support. Account administrators can now map YugabyteDB Anywhere roles to Active Directory groups, and members of these groups will inherit role permissions automatically.
