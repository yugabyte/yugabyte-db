...
## v2.18.0.0 - May 11, 2023 {#2.18.0.0}

**Build:** `2.18.0.0-b63`

**Third-party licenses:** [YugabyteDB](https://downloads.yugabyte.com/releases/2.18.0.0/yugabytedb-2.18.0.0-b63-third-party-licenses.html), [YugabyteDB Anywhere](https://downloads.yugabyte.com/releases/2.18.0.0/yugabytedb-anywhere-2.18.0.0-b63-third-party-licenses.html)

### Docker

```sh
docker pull yugabytedb/yugabyte:2.18.0.0-b63
```
