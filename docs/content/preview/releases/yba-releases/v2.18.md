...
* Enhanced LDAP support. Account administrators can now map roles to Active Directory groups, and members of these groups will inherit role permissions automatically.
