...
## v2.18.0.1 - May 25, 2023 {#v2.18.0.1}

**Build:** `2.18.0.1-b3`

**Third-party licenses:** [YugabyteDB](https://downloads.yugabyte.com/releases/2.18.0.1/yugabytedb-2.18.0.1-b3-third-party-licenses.html), [YugabyteDB Anywhere](https://downloads.yugabyte.com/releases/2.18.0.0/yugabytedb-anywhere-2.18.0.0-b3-third-party-licenses.html)

### Docker

```sh
docker pull yugabytedb/yugabyte:2.18.0.1-b3
```
...
* [PLAT-8359] [2.17.3.0-b345] Current state of a stopped node is "Unreachable"
