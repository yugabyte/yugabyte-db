...
**Third-party licenses:** [YugabyteDB](https://downloads.yugabyte.com/releases/2.18.1.0/yugabytedb-2.18.1.0-b90-third-party-licenses.html), [YugabyteDB Anywhere](https://downloads.yugabyte.com/releases/2.18.1.0/yugabytedb-anywhere-2.18.1.0-b90-third-party-licenses.html)

### Docker

```sh
docker pull yugabytedb/yugabyte:2.18.1.0-b90
```
...
* Improvements to [read replicas](../../../yugabyte-platform/create-deployments/read-replicas/), including:
  * Dynamically change the number of replicas in a universe's read-replica cluster
  * Assign independent configuration flags to read replica clusters. (By default, read replicas are assigned the same flags as the primary cluster.)
...
* [PLAT-5341] [PLAT-9340] [Azure] Add ability to create use resources across different resource groups
...
* [PLAT-7997] Add YBC to AMI and ensure auto update in Ansible script
