...
**Build:** `2024.2.1.0-b184`

**Third-party licenses:** [YugabyteDB](https://downloads.yugabyte.com/releases/2024.2.0.0/yugabytedb-2024.2.1.0-b184-third-party-licenses.html), [YugabyteDB Anywhere](https://downloads.yugabyte.com/releases/2024.2.0.0/yugabytedb-anywhere-2024.2.1.0-b184-third-party-licenses.html)

### Download

<ul class="nav yb-pills">
 <li>
   <a href="https://downloads.yugabyte.com/releases/2024.2.0.0/yba_installer_full-2024.2.1.0-b184-linux-x86_64.tar.gz">
...
* [Fire clock sync alert](/stable/yugabyte-platform/prepare/server-nodes-software/) when Network Time Protocol Daemon (ntpd) is not enabled or not running on a node of a YugabyteDB universe. {{<tags/feature/ga idea="910">}} <!-- IDEA-910 -->
