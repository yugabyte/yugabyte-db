...
The preflight check requires a symlink from python to a Python 3 binary to verify your Python version. If the link is missing, the preflight check fails, even if a compatible Python 3.x version is installed.
