...
## v2024.2.5.0 - August 28, 2025 {#v2024.2.5.0}
...
- [GUI updates to automatically provision on-premises nodes](/v2024.2/yugabyte-platform/prepare/server-nodes-software/software-on-prem/) {{<tags/feature/ga idea="2081">}}. YBA's launch screen includes new graphics and text to simplify node provisioning, addressing common user confusion in the "Create Provider" dialog and improving the out-of-box experience.
...
- [Configurable common names for K8s](/v2024.2/yugabyte-platform/security/enable-encryption-in-transit/add-certificate-kubernetes/#configurable-common-names) {{<tags/feature/ga idea="2065">}}. You can configure a custom common name suffix for K8s cert-manager.
