...
A solution would be to use a connection pooler or enable [Connection Pooling](../../explore/going-beyond-sql/connection-mgr-ysql/). Depending on your use case, you may also want to consider scaling your cluster.
