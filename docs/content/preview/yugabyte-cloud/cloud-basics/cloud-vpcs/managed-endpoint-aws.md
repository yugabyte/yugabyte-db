...
- **Host** - The host name of the PSE. You will use this to connect to your cluster. The host name of a PSE for AWS always ends in `aws.ybdb.io`. The PSE Host is also displayed in YugabyteDB Managed on the cluster **Settings** tab under **Connection Parameters**.
