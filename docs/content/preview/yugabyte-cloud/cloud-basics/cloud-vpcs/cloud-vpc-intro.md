...
- Peered application VPCs.
  ...
  - AWS and GCP only.
  - Required for smart load balancing features of [YugabyteDB smart drivers](/preview/develop/drivers-orms/smart-drivers/#using-smart-drivers-with-yugabytedb-aeon).
...
|  | Provider | Secure private network | [Add IPs to allow list](../../../cloud-secure-clusters/add-connections/) | [Smart driver load balancing](/preview/develop/drivers-orms/smart-drivers/#using-smart-drivers-with-yugabytedb-aeon) |
| :--- | :--- | :--- | :--- | :--- |
