...
| YB-Master Consensus Latency (ms)    | Latency of consensus update operations multiple Raft group consensus update operations.  | |
...
| YB-Master CPU Usage                 | The master server CPU utilization.                           | The master server should not use a full CPU. |
<!--
