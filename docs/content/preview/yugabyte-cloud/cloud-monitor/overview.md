...
| YB-Master WAL Bytes (MB/Sec))     | The number of megabytes read from and written to the WAL per second, after the tablet start. | You may consider this information while examining other metrics. |
