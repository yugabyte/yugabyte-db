...
| ------- | ------------------------ | ------------------------ | ---------------------|
| YugabyteDB PGX Driver [Recommended] | [Documentation](yb-pgx)<br />[Hello World App](../../develop/build-apps/additional-examples/go/ysql-yb-pgx/)<br /> [Reference Page](../../reference/drivers/go/yb-pgx-reference/) | [v4](https://pkg.go.dev/github.com/yugabyte/pgx) | 2.8 and above
| PGX Driver | [Documentation](pgx)<br />[Hello World App](../../develop/build-apps/additional-examples/go/ysql-pgx/)<br /> [Reference Page](../../reference/drivers/go/pgx-reference/) | [v4](https://pkg.go.dev/github.com/jackc/pgx) | 2.8 and above
| PQ Driver | [Documentation](pq)<br />[Hello World App](../../develop/build-apps/additional-examples/go/ysql-pq/)<br />[Reference Page](../../reference/drivers/go/pq-reference/) | [v1.10.2](https://github.com/lib/pq/releases/tag/v1.10.2) | 2.6 and above

| Project | Documentation and Guides | Example Apps |
| ------- | ------------------------ | ------------ |
| GORM [Recommended] | [Documentation](gorm) | [Hello World](../../develop/build-apps/additional-examples/go/ysql-gorm) |
| GO-PG | [Documentation](pg) | [Hello World](../../develop/build-apps/additional-examples/go/ysql-pg) |
