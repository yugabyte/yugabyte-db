...
Learn how to establish a connection to a YugabyteDB database and begin basic CRUD operations using the steps on the [Build an application](../../../develop/build-apps/additional-examples/csharp/ysql-entity-framework/) page.
