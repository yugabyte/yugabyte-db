...
| ysql_conn_mgr_max_phy_conn_percent | Maximum percentage of `ysql_max_connections` that the YSQL Connection Manager can use for its physical connections. A value of 85 establishes a soft limit of 0.85 * ysql_max_connections on physical connections.<br>Default: 85 |
