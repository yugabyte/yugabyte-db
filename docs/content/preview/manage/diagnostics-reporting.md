...
The data is transferred over a secure connection. And no data stored in YugabyteDB or personally identifiable information is collected or reported. 
...
- Number of tables
- Number of tablets
- Cluster configuration (gflags - numerical or non-sesitive only)
