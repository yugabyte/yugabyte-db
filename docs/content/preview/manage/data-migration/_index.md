...
To import data into a YSQL database manually, you can use [ysqlsh](../../yugabyte-clients/ysqlsh/) tool or use the [COPY FROM](../../api/ysql/the-sql-language/statements/cmd_copy/) command to import CSV files into YugabyteDB.
