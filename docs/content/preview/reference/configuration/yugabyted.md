...
Certificates are generated in the `<HOME>/var/generated_certs/<hostname>` directory. Copy these certificates to the respective node's `<base_dir>/certs` directory.
