...
For a tutorial on building a sample C application with libpq, refer to [Build a C application](../../../develop/build-apps/additional-examples/c/ysql/).
...
For a tutorial on building a sample C++ application with libpqxx, refer to [Build a C++ application](../../../develop/build-apps/additional-examples/cpp/ysql/).
...
To follow a tutorial on building a sample C# application with Npgsql, see [Build a C# application](../../../develop/build-apps/additional-examples/csharp/ysql/).
...
For a tutorial on building a sample Go application with pq, see [Build a Go application](../../../develop/build-apps/additional-examples/go/ysql-pq/).
...
For a tutorial on building a sample Java application with the Yugabyte JDBC driver, see [Build a Java application](../../../develop/build-apps/additional-examples/java/ysql-yb-jdbc/).
...
For a tutorial on building a sample Java application with the PostgreSQL JDBC Driver, see [Build a Java application](../../../develop/build-apps/additional-examples/java/ysql-jdbc/).
...
For a tutorial on building a sample Node.js application with node-postgres, see [Build a Node.js application](../../../develop/build-apps/additional-examples/nodejs/ysql-pg/).
...
For a tutorial on building a sample PHP application with php-pgsql, see [Build a PHP application](../../../develop/build-apps/additional-examples/php/ysql/).
...
For a tutorial on building a sample Python application that uses psycopg2, see [Build a Python application](../../../develop/build-apps/additional-examples/python/ysql-psycopg2).
...
For a tutorial on building a sample Python application that uses aiopg, see [Build a Python application](../../../develop/build-apps/additional-examples/python/ysql-aiopg).
...
For a tutorial on building a sample Ruby application with pg, see [Build a Ruby application](../../../develop/build-apps/additional-examples/ruby/ysql-pg).
...
For a tutorial on building a sample Ruby application with Rust-Postgres, see [Build a Rust application](../../../develop/build-apps-ysql-rust).
