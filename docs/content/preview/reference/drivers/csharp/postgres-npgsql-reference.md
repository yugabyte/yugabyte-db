...
Learn how to establish a connection to YugabyteDB database and begin CRUD operations using the steps from [Build a C# application](../../../../develop/build-apps/additional-examples/csharp/ysql).
...
[Sample C# application with SSL](/preview/develop/build-apps/additional-examples/csharp/ysql/#create-a-sample-c-application-with-ssl)
