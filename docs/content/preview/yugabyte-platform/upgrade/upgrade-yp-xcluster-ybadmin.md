...
If you have upgraded YugabyteDB Anywhere to version 2.12 or later and asynchronous replication for your universes was set up via `yb-admin` instead of the UI, you need to synchronize the replication after performing the upgrade.
