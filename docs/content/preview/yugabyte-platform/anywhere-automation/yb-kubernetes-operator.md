...
- Yugabyte Kubernetes Operator is in [Tech Preview](/preview/releases/versioning/#feature-availability), and it is recommended to use the YugabyteDB Helm charts for production deployments.
