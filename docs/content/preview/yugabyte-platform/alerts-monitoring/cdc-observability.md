...
description: Learn how YugabyteDB Anywhere monitors, captures, and emits database change events for better visibility and insights into data changes.
headcontent: Use CDC replication slots to capture and emit database change events.
menu:
