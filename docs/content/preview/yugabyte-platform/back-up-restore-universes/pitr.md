...
2. Find the database or keyspace whose snapshot you want to recover, click **...** to display its actions, and select **Recover to a Point in Time**.
...
2. Find the database or keyspace for which you to disable PITR, click **...** to display its actions, and then select **Disable Point-in-Time Recovery**.
