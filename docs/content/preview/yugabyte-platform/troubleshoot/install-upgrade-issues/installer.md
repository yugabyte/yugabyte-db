...
Workaround: Refer to [Migration and high availability](/v2.20/yugabyte-platform/install-yugabyte-platform/install-yugabyte-platform/migrate-replicated/#in-place-migration-and-high-availability).
