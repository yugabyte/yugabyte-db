...
| Total YSQL Connections | Information pending                                          | Information pending                                          | ![img](/images/yp/metrics100.png) |
...
| **Graph**             | **Description**     | **Alert Guidance**  | **Example**                       |
| --------------------- | ------------------- | ------------------- | --------------------------------- |
| Total YSQL Ops / sec  | Information pending | Information pending | ![img](/images/yp/metrics101.png) |
| YSQL Op Latency (Avg) | Information pending | Information pending | ![img](/images/yp/metrics102.png) |
...
| Average Latency                     | The average latency (in milliseconds) of various RPC services, provided by Master server | This metric is informational and should not be subject to alerting. You may consider this information while examining alerts on other metrics. | ![img](/images/yp/metrics76.png) |
...
| Master TSService Reads Latency      | The average latency (in milliseconds) of YSQL reads of the Postgres system tables. | This metric is informational and should not be subject to alerting. You may consider this information while examining alerts on other metrics. | ![img](/images/yp/metrics77.png) |
...
| Master TSService Writes Latency     | The average latency (in milliseconds) of YSQL writes to the Postgres system tables (during DDL). | This metric is informational and should not be subject to alerting. You may consider this information while examining alerts on other metrics. | ![img](/images/yp/metrics78.png) |
...
| UpdateConsensus Latency             | Latency (in milliseconds) of consensus update operations.    | This metric is informational and should not be subject to alerting. You may consider this information while examining alerts on other metrics. | ![img](/images/yp/metrics79.png) |
...
| MultiRaftUpdateConsensus Latency    | Latency (in milliseconds) of multiple Raft group consensus update operations. | This metric is informational and should not be subject to alerting. You may consider this information while examining alerts on other metrics. | ![img](/images/yp/metrics81.png) |
...
| Transaction pool cache hits | Information pending                                          | Information pending                                          | ![img](/images/yp/metrics105.png) |
