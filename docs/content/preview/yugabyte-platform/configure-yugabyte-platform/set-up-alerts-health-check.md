...
To review alerts that have triggered, refer to [Alerts](../../alerts-monitoring/alert/). To view performance metrics, refer to [Use metrics](../../alerts-monitoring/anywhere-metrics/).
