...
1         Tue Apr 21 17:29:01 2020  deployed  yugabyte-{{<yb-version version="v2024.1" format="short">}}  {{<yb-version version="v2024.1" format="build">}}  Install complete
```
...
```sh
helm install yugabyte -f https://raw.githubusercontent.com/yugabyte/charts/master/stable/yugabyte/expose-all.yaml --version {{<yb-version version="v2024.1" format="short">}} --namespace yb-demo --name yb-demo \
