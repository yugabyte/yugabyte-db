...
* If the client application uses a smart driver, set the [topology keys](/stable/drivers-orms/smart-drivers/#topology-aware-load-balancing) to target the preferred zones.
