...
Specify `true` if tables for this database should be colocated on a single tablet by default. See [Colocated tables](../../../../../additional-features/colocation/) for details on when colocated tables are beneficial.
