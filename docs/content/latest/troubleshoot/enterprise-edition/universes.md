...
The page shows a number of interactive metrics graphs that capture the state of the YugabyteDB Universe over time.

![YugabyteDB Metrics Page](/images/troubleshooting/check-metrics.png)
