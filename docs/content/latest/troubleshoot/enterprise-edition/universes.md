...
## Metrics Page
In the [Admin Console](../../../deploy/enterprise-edition/admin-console/), click on the [Universe](../../../architecture/concepts/universe/#universe) page, then go to the Metrics tab.
...
## Nodes Status
In the [Admin Console](../../../deploy/enterprise-edition/admin-console/), click on the [Universe](../../../architecture/concepts/universe/#universe) page, then go to the Nodes tab.
