---
title: Ecosystem integrations using YugabyteDB
headerTitle: Ecosystem integrations
linkTitle: Ecosystem integrations
description: Integrate YugabyteDB with Apache Kafka, Apache Spark, JanusGraph, KairosDB, Presto, and Metabase.
...
<div class="row">
  ...
  <div class="col-12 col-md-6 col-lg-12 col-xl-6">
    <a class="section-link icon-offset" href="apache-spark/">
      <div class="head">
      ...
      <div class="body">
        Powerful analytics processing engine integrated with the YCQL API.
      </div>
    </a>
  </div>
  ...
  <div class="col-12 col-md-6 col-lg-12 col-xl-6">
    <a class="section-link icon-offset" href="kairosdb/">
      ...
      <div class="body">
        Fast time series metrics API that uses Cassandra-compatible YugabyteDB as it's underlying distributed database.
      </div>
    </a>
  </div>
