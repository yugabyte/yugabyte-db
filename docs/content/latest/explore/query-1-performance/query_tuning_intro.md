...
**2. View live queries using pg_stat_activity**
...
For more information, see [Viewing live queries with `pg_stat_activity`](pg-stat-activity.md).

**3. Understand what your queries are doing with EXPLAIN**
...
**4. Evaluate the query for optimization**
...
**5. Optimize YSQL queries using pg_hint_plan**
