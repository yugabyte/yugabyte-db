...
For AWS deployments specifically, a <a href="../public-clouds/aws#manual-deployment">step-by-step guide</a> to deploying a YugabyteDB cluster is also available. These steps can be easily adopted for on-premise deployments or deployments in other clouds.
