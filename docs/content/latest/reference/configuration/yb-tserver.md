...
Number of seconds to retain log files. Log files older than this value will be deleted even if they contain unreplicated CDC entries. If 0, this flag will be ignored. This flag is _also_ ignored if a log segment contains entries that haven't been flushed to RocksDB.
