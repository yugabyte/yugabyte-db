...
The [YB-TServer](../../../architecture/concepts/yb-tserver/) service stores and manages data for client applications. Its binary `yb-tserver` is located in the `bin` directory of YugabyteDB home. 
