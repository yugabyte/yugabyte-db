...
The above command will build the release configuration, put the C++ binaries in `build/release-clang-dynamic-ninja`, and will also create the `build/latest` symlink to that directory.
