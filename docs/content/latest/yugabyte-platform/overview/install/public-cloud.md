...
<map name="image-map">
    ...
    <area target="_blank" alt="Azure prep environment" title="Azure prep environment" href="/latest/yugabyte-platform/install-yugabyte-platform/prepare-environment/azure/" coords="590,404,746,480" shape="rect">
