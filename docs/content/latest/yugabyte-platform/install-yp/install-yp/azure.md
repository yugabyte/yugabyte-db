...
<ul class="nav nav-tabs-alt nav-tabs-yb">
  ...
  <li>
    <a href="/latest/yugabyte-platform/install-yp/install-yp/azure" class="nav-link active">
  ...
  <li>
    <a href="/latest/yugabyte-platform/install-yp/install-yp/on-premises" class="nav-link">
