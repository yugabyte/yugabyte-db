---
title: Install Yugabyte Platform - Kubernetes
headerTitle: Install Yugabyte Platform - Kubernetes
...
<ul class="nav nav-tabs-alt nav-tabs-yb">
  ...
  <li>
    <a href="/latest/yugabyte-platform/install-yp/install-yugabyte-platform/kubernetes" class="nav-link active">
