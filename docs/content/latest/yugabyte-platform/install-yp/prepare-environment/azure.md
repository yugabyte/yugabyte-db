---
title: Prepare the Microsoft Azure cloud environment
headerTitle: Prepare the Microsoft Azure cloud environment
...
<ul class="nav nav-tabs-alt nav-tabs-yb">
  ...
  <li>
    <a href="/latest/yugabyte-platform/install-yp/prepare-environment/azure" class="nav-link active">
