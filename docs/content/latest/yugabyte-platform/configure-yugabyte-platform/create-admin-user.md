...
After you click **Submit**, you are automatically logged into the Yugabyte Platform Admin UI. Proceed to [configuring cloud providers](../set-up-cloud-provider/aws).
