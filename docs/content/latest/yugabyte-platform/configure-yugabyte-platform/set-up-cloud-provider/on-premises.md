---
title: Set up the on-premises data center
headerTitle: Set up the on-premise provider
linkTitle: Set up the cloud provider
description: Set up the on-premises data center.
aliases:
...
<ul class="nav nav-tabs-alt nav-tabs-yb">
  ...
  <li>
    <a href="/latest/yugabyte-platform/configure-yugabyte-platform/set-up-provider/on-premises" class="nav-link active">
