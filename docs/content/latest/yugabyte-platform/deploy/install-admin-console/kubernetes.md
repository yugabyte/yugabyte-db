...
```sh
$ helm install yw-test yugabytedb/yugaware --version 2.3.2 -n yw-test --wait
```
...
```sh
$ helm upgrade yw-test yugabytedb/yugaware --version 2.3.2 --set image.tag=2.3.2.0-b37 -n yw-test
```
