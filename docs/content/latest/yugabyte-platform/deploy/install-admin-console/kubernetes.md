...
ugabytedb/yugabyte	2.2.0        	2.2.0.0	YugabyteDB is the high-performance distributed ..
```
...
```sh
$ helm upgrade yw-test yugabytedb/yugaware --version 2.2.0 --set image.tag=2.2.0.0-b74 -n yw-test
```
