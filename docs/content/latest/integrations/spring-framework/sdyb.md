...
In general, Spring Data modules are used for accessing databases and performing various tasks via Java APIs. This eliminates the need to learn a database-specific query language.

Specifically, Spring Data YugabyteDB modules provide support for YugabyteDB YSQL and YCQL APIs and enable you to build cloud-native applications.

This document describes how to use Spring Data YugabyteDB (SDYB) with YSQL and YCQL.

## Spring Data YugabyteDB and YSQL

In general, Spring Data modules are used for accessing databases and performing various tasks via Java APIs. This eliminates the need to learn a database-specific query language.

Specifically, Spring Data YugabyteDB modules provide support for YugabyteDB YSQL and YCQL APIs for building modern cloud native applications. For  application developers, Spring Data YugabyteDB will bridge the gap for  learning the distributed SQL concepts with familiarity and ease of  Spring Data APIs.
