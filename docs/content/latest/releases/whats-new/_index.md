...
- Update to support Helm 3 deployments. Note: Helm 2 is no longer supported. For details on migrating, see [Migrate from Helm 2 to Helm 3](../../manage/enterprise-edition/migrate-to-helm3/). [#4416]((https://github.com/yugabyte/yugabyte-db/issues/4416))
