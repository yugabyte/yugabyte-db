...
## v2.6.14.0 - Feb 14, 2022 {#v2.6.14.0}

**Build:** `2.6.13.0-b5`

### Downloads

<a class="download-binary-link" href="https://downloads.yugabyte.com/releases/2.6.14.0/yugabyte-2.6.14.0-b3-darwin-x86_64.tar.gz">
  <button>
    <i class="fab fa-apple"></i><span class="download-text">macOS</span>
  </button>
</a>
&nbsp; &nbsp; &nbsp;
<a class="download-binary-link" href="https://downloads.yugabyte.com/releases/2.6.14.0/yugabyte-2.6.14.0-b3-linux-x86_64.tar.gz">
  <button>
...
```sh
docker pull yugabytedb/yugabyte:2.6.14.0-b3
```
