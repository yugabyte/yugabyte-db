...
* install-yugabyte-platform - allow specifying homeDir, automatically exclude installing s3cmd and ntp. [#3834](https://github.com/yugabyte/yugabyte-db/issues/3834)
...
* Correctly disable ntp install for install-yugabyte-platform
