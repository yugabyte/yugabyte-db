...
* [YW][#3211] Add ESC key binding to document to close any modal on the screen by calling the onHide callback.[#3211](https://github.com/yugabyte/yugabyte-db/issues/3211)
* [YW][#3332] Add default value for currentProvider and fix eslint warnings. [#3332](https://github.com/yugabyte/yugabyte-db/issues/3332)
* [YW][#3680] Enable multi-table backups in CreateBackups modal. [#3680](https://github.com/yugabyte/yugabyte-db/issues/3680)
