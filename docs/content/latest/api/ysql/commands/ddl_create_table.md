...
#### storage_param
<svg class="rrdiagram" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" width="306" height="50" viewbox="0 0 306 50"><path class="connector" d="M0 22h15m134 0h30m30 0h10m52 0h20m-127 0q5 0 5 5v8q0 5 5 5h102q5 0 5-5v-8q0-5 5-5m5 0h15"/><polygon points="0,29 5,22 0,15" style="fill:black;stroke-width:0"/><a xlink:href="../grammar_diagrams#storage-parameter"><rect class="rule" x="15" y="5" width="134" height="25"/><text class="text" x="25" y="22">storage_parameter</text></a><rect class="literal" x="179" y="5" width="30" height="25" rx="7"/><text class="text" x="189" y="22">=</text><a xlink:href="../grammar_diagrams#value"><rect class="rule" x="219" y="5" width="52" height="25"/><text class="text" x="229" y="22">value</text></a><polygon points="302,29 306,29 306,15 302,15" style="fill:black;stroke-width:0"/></svg>

### Grammar
```
create_table ::= CREATE TABLE [ IF NOT EXISTS ] table_name ( [ table_elem [, ...] ] ) [ WITH ( storage_param [, ... ] ) | WITHOUT OIDS ]
...
storage_param ::= storage_parameter [ = value ]
```
