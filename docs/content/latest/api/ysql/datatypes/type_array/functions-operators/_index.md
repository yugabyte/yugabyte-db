...
| [@>](./comparison/#the-and-operators) | | Returns `true` if the LHS array contains the RHS array—i.e. if every distinct value in the RHS array is found among the LHS array's distinct values. |
| [<@](./comparison/#the-and-operators) | | Returns `true` if the LHS array is contained by the RHS array—i.e. if every distinct value in the LHS array is found among the RHS array's distinct values. |
