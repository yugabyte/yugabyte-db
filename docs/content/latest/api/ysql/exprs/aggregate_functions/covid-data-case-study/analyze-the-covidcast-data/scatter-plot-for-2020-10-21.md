...
It uses the function `normal_rand()`, brought by the [tablefunc](../../../../../extensions/#tablefunc) extension to add pseudorandomly generated normally distributed noise the the y-axis values produced by the _"y = m*x + c"_ formula for the straight line.
