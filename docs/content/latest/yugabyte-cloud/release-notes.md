...
- Ability to select the version of YugabyteDB to install on a cluster when creating standard clusters. You can select a [stable or edge release](../cloud-faq/#what-version-of-yugabytedb-does-my-cluster-run-on).
