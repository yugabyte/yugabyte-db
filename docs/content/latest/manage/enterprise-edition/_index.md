...
Universe is a cluster of YugaByte DB instances grouped together to form one logical distributed database. All instances belonging to a single Universe run on the same type of cloud provider node. 
