...
Do not use Readline for line editing and do not use the command history. This can be used to turn off tab expansion when cutting and pasting.
...
Sets the [environment variable](#environment-variables) *name* to *value*, or if *value* is not supplied, unsets the environment variable. Example:
