...
<div class="row">
 ...
 <div class="col-12 col-md-6 col-lg-12 col-xl-6">
    <a class="section-link icon-offset" href="backups/">
      <div class="head">
        <img class="icon" src="/images/section_icons/explore/high_performance.png" aria-hidden="true" />
        <div class="title">Snapshots, backups and PITR</div>
      </div>
      <div class="body">
        Efficient backup and restore operations using RocksDB snapshots.
      </div>
    </a>
  </div>>
