...
| Flag | Description |
| :--- | :---------- |
| [allowed_v225_flags_csv](../../../reference/configuration/yb-tserver/#allowed-preview-flags-csv) | Set the value of this flag to include `ysql_yb_enable_query_diagnostics`. |
