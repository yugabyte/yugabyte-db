...
A solution would be to use a connection pooler or enable built-in [Connection Pooling](../../additional-features/connection-manager-ysql/). Depending on your use case, you may also want to consider scaling your cluster.
