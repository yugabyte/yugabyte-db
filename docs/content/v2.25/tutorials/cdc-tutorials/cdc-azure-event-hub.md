...
1. Add data and tables to YugabyteDB. After this is done, [create the CDC Stream ID using the yb-admin command](/stable/integrations/cdc/debezium/#create-a-database-stream-id).
