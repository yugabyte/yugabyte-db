...
To update cron-based universes, in YugabyteDB Anywhere v2024.2.8 or later, navigate to the universe and choose **Actions>Upgrade to Systemd**. If you are running a version earlier than v2024.2.8 and you want to upgrade to v2025.2 or later, first upgrade to v2024.2.8 or later and update your universes to systemd.
