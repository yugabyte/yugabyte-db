...
When add a new column with a (non-volatile) default expression, make sure to perform the schema modification on the target with the *computed* default value.
