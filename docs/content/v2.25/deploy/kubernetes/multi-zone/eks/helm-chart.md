...
```sh
$ helm search repo yugabytedb/yugabyte --version {{<yb-version version="v2.25" format="short">}}
```

```output
NAME                 CHART VERSION  APP VERSION   DESCRIPTION
yugabytedb/yugabyte  {{<yb-version version="v2.25" format="short">}}          {{<yb-version version="v2.25" format="build">}}  YugabyteDB is the high-performance distributed ...
```
