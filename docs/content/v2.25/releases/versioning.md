...
Configuration of preview feature-specific flags is restricted to those listed in the [allowed_v225_flags_csv](../../reference/configuration/yb-master/#allowed-preview-flags-csv) flag. This measure acts as a safeguard, ensuring users are aware they are modifying settings for preview features.
{{</tip>}}
