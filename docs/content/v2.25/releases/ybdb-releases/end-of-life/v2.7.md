...
menu:
  v2.25_releases:
    ...
    weight: 2910
aliases:
  - /stable/releases/release-notes/v2.7/
rightNav:
  hideH4: true
type: docs
---
...
<ul class="nav yb-pills">
  ...
  <li>
   <a  href="https://software.yugabyte.com/yugabyte-2.7.2.0-linux.tar.gz">
...
<ul class="nav yb-pills">
    <li>
        <a href="https://software.yugabyte.com/yugabyte-2.7.1.1-darwin.tar.gz">
            <i class="fa-brands fa-apple"></i>macOS</a>
    </li>
    <li>
        <a href="https://software.yugabyte.com/yugabyte-2.7.1.1-linux.tar.gz">
...
<ul class="nav yb-pills">
  <li>
    <a href="https://software.yugabyte.com/yugabyte-2.7.0.0-darwin.tar.gz">
      <i class="fa-brands fa-apple"></i>
      <span>macOS</span>
    </a>
  </li>
    <li>
     <a class="download-binary-link" href="https://software.yugabyte.com/yugabyte-2.7.0.0-linux.tar.gz">
      <i class="fa-brands fa-linux"></i>Linux
    </a>
  </li>
</ul>
