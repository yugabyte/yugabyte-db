...
- Currently, [auth-method](https://docs.yugabyte.com/stable/secure/authentication/host-based-authentication/#auth-method) `cert` is not supported for host-based authentication. {{<issue 20658>}}
...
- Salted Challenge Response Authentication Mechanism ([SCRAM](https://docs.yugabyte.com/stable/secure/authentication/password-authentication/#scram-sha-256)) is not supported with YSQL Connection Manager. {{<issue 25870>}}
