...
{{< note title="Note" >}}
For v2024.2.1 and earlier, follow the same steps as described in [Add YCQL indexes in bidirectional replication](#add-ycql-indexes-in-bidirectional-replication).
{{< /note >}}
