...
- **Smart driver**: YugabyteDB ships a [smart driver](/stable/drivers-orms/smart-drivers/) in multiple languages that can automatically distribute connections to the various nodes in the cluster with minimum configuration.
