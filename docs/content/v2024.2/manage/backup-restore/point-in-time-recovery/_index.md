...
description: Recover from logical SQL or CQL errors using Clone, Rewind, and Restore to a point in time
headcontent: Recover from logical errors quickly with little or no data movement
aliases:
  - /v2024.2/manage/backup-restore/point-in-time-restore
  - /v2024.2/manage/backup-restore/point-in-time-restore-ycql
  - /v2024.2/yugabyte-platform/back-up-restore-universes/point-in-time
menu:
  v2024.2:
...
YugabyteDB provides three complementary ways to work with a point in time:
...
|      | Clone to PIT | Rewind to PIT | Restore to PIT |
| :--- | :----------- | :------------ | :------------- |
| Target cluster | Original | Original | Original or alternate |
| Database affected | New cloned database | Original database | Restored database |
| Crosses DDL boundaries | Yes | Yes | No |
| Newest recoverable time | Seconds ago | Seconds ago | Time of last [snapshot/backup](../snapshot-ysql/) |
| Typical retention | Hours to days (primary storage) | Hours to days (primary storage) | Hours to months (backup storage) |
| APIs | YSQL and YCQL | YSQL and YCQL | YSQL and YCQL |
...
|      | Clone to PIT | Rewind to PIT | Restore to PIT |
| :--- | :----------- | :------------ | :------------- |
| YugabyteDB | SQL and yb-admin | yb-admin | Advanced (yb-admin) |
| YugabyteDB Anywhere | Not in UI | Yes | Yes |
| YugabyteDB Aeon | Yes | No | No |
...
- [Restore to PIT](../../../yugabyte-platform/back-up-restore-universes/restore-universe-data/#restore-a-pitr-enabled-backup). Enable and manage Restore using the YugabyteDB Anywhere UI.
...
YugabyteDB Aeon supports [Clone to PIT](/stable/yugabyte-cloud/cloud-clusters/aeon-pitr/). Enable and manage Clone using the YugabyteDB Aeon UI.
