...
[Restore to PIT](../restore/) restores a specific snapshot and also does not require a schedule, though a schedule is one way to produce the snapshots you restore.
