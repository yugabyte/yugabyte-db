...
| `as_root` | If you ran yb-ctl as root, this is automatically set to true. Otherwise it is false. Note that you can't switch between running yb-ctl as root and non-root. | {{<icon/partial>}} |
