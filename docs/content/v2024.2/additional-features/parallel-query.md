...
Currently, YugabyteDB supports parallel queries for [colocated tables](../colocation/); support for [hash- and range-sharded](../../architecture/docdb-sharding/sharding/) tables is planned.
