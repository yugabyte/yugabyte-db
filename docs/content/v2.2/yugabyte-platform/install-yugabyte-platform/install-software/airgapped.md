...
<ul class="nav nav-tabs-alt nav-tabs-yb">
  ...
  <li>
    <a href="/v2.2/yugabyte-platform/install-yugabyte-platform/install-software/kubernetes" class="nav-link">
  ...
  <li >
    <a href="/v2.2/yugabyte-platform/install-yugabyte-platform/install-software/airgapped" class="nav-link active">
