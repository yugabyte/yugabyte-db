...
<ul class="nav nav-tabs-alt nav-tabs-yb">
  ...
  <li >
    <a href="/v2.2/explore/fault-tolerance/macos" class="nav-link">
  ...
  <li >
    <a href="/v2.2/explore/fault-tolerance/linux" class="nav-link">
  ...
  <li >
    <a href="/v2.2/explore/fault-tolerance/docker" class="nav-link">
  ...
  <li >
    <a href="/v2.2/explore/fault-tolerance/kubernetes" class="nav-link active">
