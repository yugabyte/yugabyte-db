...
- Upgrade - Update the nodes in the universe with the new database version.
...
1. Choose the **Rolling Upgrade** option and define the delay between nodes restarting.
