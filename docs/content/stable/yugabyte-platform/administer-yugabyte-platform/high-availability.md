...
If you use the [YugabyteDB Kubernetes Operator](../../anywhere-automation/yb-kubernetes-operator/) and deploy YBA across separate Kubernetes clusters, [Operator HA](../operator-high-availability/) synchronizes operator custom resources and secrets to the standby cluster during promotion.
