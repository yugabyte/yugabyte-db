...
(For information on configuring user authentication for your YugabyteDB Anywhere instance, refer to [Configure authentication](../../administer-yugabyte-platform/ldap-authentication/).)
