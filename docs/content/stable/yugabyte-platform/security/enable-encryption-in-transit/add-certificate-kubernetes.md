...
If your certificate issuer (for example, for `aws-privateca-issuer`) requires the certificate to include the common name, set the following [override](../../../scale-deployments/edit-helm-overrides/) for the provider region:
