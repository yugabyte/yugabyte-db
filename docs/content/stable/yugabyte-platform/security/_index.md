...
You enable authentication for the YSQL and YCQL APIs when you deploy a universe. See [Enable database authorization](authorization-platform/#enable-database-endpoints-and-authorization).
