...
To support master key rotation, if you upgrade to YBA 2.18.0 or later, add the kms:Encrypt action to any existing keys that are used by any AWS KMS configurations, if not already present.
