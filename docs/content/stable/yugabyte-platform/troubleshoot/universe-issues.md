...
For more detailed logs, you can change node agent logging by setting the **Node Agent Server Log Level Per Request** Global Runtime Configuration option (config key `yb.node_agent.server.request_log_level`) to one of the following:
