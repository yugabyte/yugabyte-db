...
- [Configure cloud permissions](./cloud-permissions/)
  ...
  If you are using a public cloud provider (AWS, GCP, Azure, or OCI) or Kubernetes, you need to configure your cloud environment with the appropriate users and security permissions required by YugabyteDB Anywhere.
