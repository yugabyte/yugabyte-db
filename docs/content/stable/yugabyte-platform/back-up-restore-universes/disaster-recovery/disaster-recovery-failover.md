...
At this point, the DR configuration is halted and needs to be set up again.
...
In both cases, repairing of DR involves making a full copy of the databases through the backup-restore process.
