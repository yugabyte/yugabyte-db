...
Semi-automatic mode is used for any xCluster DR configuration when both DR primary and replica are running YugabyteDB {{<release "2024.1">}} to {{<release "2025.2.0">}}.
