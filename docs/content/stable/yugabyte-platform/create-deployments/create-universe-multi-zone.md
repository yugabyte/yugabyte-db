...
{{< note title="EBS volume encryption" >}}
- You can use AWS EBS volume-level encryption and YugabyteDB Anywhere envelope [Encryption at rest](../../security/enable-encryption-at-rest/) (EAR) as this is a cloud provider level option. Both cloud volume encryption and YugabyteDB Anywhere's EAR can be enabled simultaneously with different KMS configs.
