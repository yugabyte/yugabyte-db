...
* Added [CDC Logical Replication support](/v2025.1/additional-features/change-data-capture/using-logical-replication/) for xCluster feature where both CDC and xCluster can work simultaneously on the same source tables. {{<tags/feature/ea idea="82">}}
