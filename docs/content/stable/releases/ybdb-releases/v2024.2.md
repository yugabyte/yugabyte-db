...
## v2024.2.10.0 - June 29, 2026 {#v2024.2.10.0}

**Build:** `2024.2.10.0-b57`

**Third-party licenses:** [YugabyteDB](https://downloads.yugabyte.com/releases/2024.2.10.0/yugabytedb-2024.2.10.0-b57-third-party-licenses.html), [YugabyteDB Anywhere](https://downloads.yugabyte.com/releases/2024.2.10.0/yugabytedb-anywhere-2024.2.10.0-b57-third-party-licenses.html)

### Downloads

<ul class="nav yb-pills">
  <li>
    <a href="https://software.yugabyte.com/releases/2024.2.10.0/yugabyte-2024.2.10.0-b57-darwin-x86_64.tar.gz">
      <i class="fa-brands fa-apple"></i>
      <span>macOS x86</span>
    </a>
  </li>
    <li>
    <a href="https://software.yugabyte.com/releases/2024.2.10.0/yugabyte-2024.2.10.0-b57-darwin-arm64.tar.gz">
      <i class="fa-brands fa-apple"></i>
      <span>macOS ARM</span>
    </a>
  </li>
  <li>
    <a href="https://software.yugabyte.com/releases/2024.2.10.0/yugabyte-2024.2.10.0-b57-linux-x86_64.tar.gz">
      <i class="fa-brands fa-linux"></i>
      <span>Linux x86</span>
    </a>
  </li>
  <li>
    <a href="https://software.yugabyte.com/releases/2024.2.10.0/yugabyte-2024.2.10.0-b57-el8-aarch64.tar.gz">
      <i class="fa-brands fa-linux"></i>
      <span>Linux ARM</span>
    </a>
  </li>
...
```sh
docker pull yugabytedb/yugabyte:2024.2.10.0-b57
```
...
* Enables leader stepdown to a preferred zone's replica when removing a leader-hosting replica. {{<issue 19884>}},{{<issue 30446>}}
...
* Enables local RPC calls in CDC Virtual WAL for efficiency when appropriate flag is set. {{<issue 20945>}}

#### yugabyted

* Updates cqlsh to version v3.10-yb-22 to support Python 3.12. {{<issue 30154>}}
...
* Removes unnecessary assertion from `testFastpathIntentdbSeeks` to prevent failure in release builds. {{<issue 23650>}}
...
* Prevents incorrect results when using `SELECT DISTINCT` with bitmap scans. {{<issue 32166>}}
...
* Fixes incorrect PgResponseCache invalidation after RPC deadline. {{<issue 31870>}}
* Fixes potential deadlock by releasing the lock before invoking callbacks. {{<issue 24553>}}
...
* Prevents re-application of external writes after an ungraceful restart in xCluster, avoiding silent data loss. {{<issue 31899>}}
...
* Reduces catalog read requests by batching `pg_statistic` lookups during query planning. {{<issue 32128>}}

#### DocDB

* Restores essential flag declarations to fix compilation errors. {{<issue 28504>}}
...
<ul class="nav yb-pills">
  <li>
    <a href="https://software.yugabyte.com/releases/2024.2.9.1/yugabyte-2024.2.9.1-b8-darwin-x86_64.tar.gz">
      <i class="fa-brands fa-apple"></i>
      <span>macOS x86</span>
    </a>
  </li>
    <li>
    <a href="https://software.yugabyte.com/releases/2024.2.9.1/yugabyte-2024.2.9.1-b8-darwin-arm64.tar.gz">
      <i class="fa-brands fa-apple"></i>
      <span>macOS ARM</span>
    </a>
  </li>
  <li>
    <a href="https://software.yugabyte.com/releases/2024.2.9.1/yugabyte-2024.2.9.1-b8-linux-x86_64.tar.gz">
      <i class="fa-brands fa-linux"></i>
      <span>Linux x86</span>
    </a>
  </li>
  <li>
    <a href="https://software.yugabyte.com/releases/2024.2.9.1/yugabyte-2024.2.9.1-b8-el8-aarch64.tar.gz">
      <i class="fa-brands fa-linux"></i>
      <span>Linux ARM</span>
    </a>
  </li>
...
```sh
docker pull yugabytedb/yugabyte:2024.2.9.1-b8
```
...
* Replaces `LOG(ERROR)` with `LOG(WARNING)` or `LOG(DFATAL)` in CDC code for better test failure detection. {{<issue 27042>}}

#### CDC

* Enables capturing before images for DML operations within the same transaction using the new flag `cdc_enable_intra_transactional_before_image`. {{<issue 29209>}}
* Enhances CDC restart time handling to progress when there's no new data to stream. {{<issue 31091>}}
* Introduces a new `yb-ts-cli` command, `cdc_release_barriers_on_tablet` to release CDC retention barriers on a specific tablet. {{<issue 31187>}}
...
<ul class="nav yb-pills">
  <li>
    <a href="https://software.yugabyte.com/releases/2024.2.9.0/yugabyte-2024.2.9.0-b55-darwin-x86_64.tar.gz">
      <i class="fa-brands fa-apple"></i>
      <span>macOS x86</span>
    </a>
  </li>
    <li>
    <a href="https://software.yugabyte.com/releases/2024.2.9.0/yugabyte-2024.2.9.0-b55-darwin-arm64.tar.gz">
      <i class="fa-brands fa-apple"></i>
      <span>macOS ARM</span>
    </a>
  </li>
  <li>
    <a href="https://software.yugabyte.com/releases/2024.2.9.0/yugabyte-2024.2.9.0-b55-linux-x86_64.tar.gz">
      <i class="fa-brands fa-linux"></i>
      <span>Linux x86</span>
    </a>
  </li>
  <li>
    <a href="https://software.yugabyte.com/releases/2024.2.9.0/yugabyte-2024.2.9.0-b55-el8-aarch64.tar.gz">
      <i class="fa-brands fa-linux"></i>
      <span>Linux ARM</span>
    </a>
  </li>
...
```sh
docker pull yugabytedb/yugabyte:2024.2.9.0-b55
```
...
* Ensures file safety during checkpoints by explicitly flushing key files like MANIFEST and CURRENT. {{<issue 30146>}}
