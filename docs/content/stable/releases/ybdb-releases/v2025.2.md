...
- Improves [cluster balancer](/stable/architecture/docdb-sharding/cluster-balancing/#monitoring-cluster-balancer-progress) observability and throughput by prioritizing recovery of leaderless tablets and production databases. {{<tags/feature/ga idea="1328">}}
