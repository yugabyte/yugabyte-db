...
## v2025.2.3.1 - June 1, 2026 {#v2025.2.3.1}
...
* Adds the `ysql_enable_concurrent_ddl` YB-TServer flag to toggle concurrent DDL within a database. Requires `enable_object_locking_for_table_locks` and is disabled by default. {{<issue 31225>}}
