...
**Build:** `2025.2.6.0-b78`

**Third-party licenses:** [YugabyteDB](https://downloads.yugabyte.com/releases/2025.2.6.0/yugabytedb-2025.2.6.0-b78-third-party-licenses.html), [YugabyteDB Anywhere](https://downloads.yugabyte.com/releases/2025.2.6.0/yugabytedb-anywhere-2025.2.6.0-b78-third-party-licenses.html)

### Downloads

{{< release-downloads version="2025.2.6.0" build="78" >}}
...
* Renames flag `yb_fetch_target_tuple` to `yb_skip_fetch_target_tuple` to safely activate optimizations only when explicitly set. {{<issue 32474>}}
...
* Reduces OOM risk with chunked compaction and a new flag, `vector_index_compaction_chunk_max_mem_store_size_mb` for memory budget control.{{<issue 31542>}}
...
* Reduces cost estimations for faster BNL join plans, enhancing the optimizer's selection process. {{<issue 30490>}},{{<issue 30580>}}
