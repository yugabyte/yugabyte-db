...
## v2025.2.1.0 - February 10, 2026 {#v2025.2.1.0}
...
| {{<tags/feature/ea idea="1807">}}[AWS ClockBound support](/stable/deploy/manual-deployment/system-config/#configure-clockbound) | The [ClockBound](https://github.com/aws/clock-bound) daemon improves clock accuracy by several orders of magnitude.<hr style="margin: 0.5em 0;">**To use**: When deploying, run the `configure_clockbound.sh` script in the bin directory of your YugabyteDB home directory. |
| {{<tags/feature/tp idea="2275">}} [Bucket-based indexes](/stable/explore/ysql-language-features/indexes-constraints/bucket-index-ysql) | Addresses write-path hotspots for ascending/descending indexes while maintaining optimal performance for order-based queries.<hr style="margin: 0.5em 0;">**To use**: Disabled by default. Set `yb_enable_derived_saops` to true and `yb_max_saop_merge_streams` to 64. |
...
**Build:** `2025.2.0.0-b141`

**Third-party licenses:** [YugabyteDB](https://downloads.yugabyte.com/releases/2025.2.0.0/yugabytedb-2025.2.0.0-b141-third-party-licenses.html), [YugabyteDB Anywhere](https://downloads.yugabyte.com/releases/2025.2.0.0/yugabytedb-anywhere-2025.2.0.0-b141-third-party-licenses.html)

### Downloads

<ul class="nav yb-pills">
  <li>
    <a href="https://downloads.yugabyte.com/releases/2025.2.0.0/yugabyte-2025.2.0.0-b141-darwin-x86_64.tar.gz">
      <i class="fa-brands fa-apple"></i>
      <span>macOS x86</span>
    </a>
  </li>
  <li>
    <a href="https://downloads.yugabyte.com/releases/2025.2.0.0/yugabyte-2025.2.0.0-b141-darwin-arm64.tar.gz">
      <i class="fa-brands fa-apple"></i>
      <span>macOS ARM</span>
    </a>
  </li>
  <li>
    <a href="https://downloads.yugabyte.com/releases/2025.2.0.0/yugabyte-2025.2.0.0-b141-linux-x86_64.tar.gz">
      <i class="fa-brands fa-linux"></i>
      <span>Linux x86</span>
    </a>
  </li>
  <li>
    <a href="https://downloads.yugabyte.com/releases/2025.2.0.0/yugabyte-2025.2.0.0-b141-el8-aarch64.tar.gz">
      <i class="fa-brands fa-linux"></i>
      <span>Linux ARM</span>
    </a>
  </li>
...
```sh
docker pull yugabytedb/yugabyte:2025.2.0.0-b141
```
