...
Note that, apart from the exceptions noted, upgrading existing universes does not change the defaults for any of these features. If you have enabled Enhanced PostgreSQL Compatibility Mode on your universe, all of these features are already enabled.
