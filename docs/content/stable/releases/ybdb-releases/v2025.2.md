...
* Adds support for Apache AGE extension to handle graph data. {{<issue 30056>}}
* Adds support for Apache AGE graph extension to enable graph database capabilities. {{<issue 30056>}}
* Automatically enables `pg_dist_rag` when starting T-server with `enable_dist_rag_service=true`. {{<issue 29954>}}
...
* Adds extensive tests for LISTEN/NOTIFY functionality in various scenarios. {{<issue 1872>}}
