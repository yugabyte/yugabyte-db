...
| {{<tags/feature/ea idea="1516">}}[Parallel queries](/stable/additional-features/parallel-query/) | Adds support for hash- and range-sharded tables with parallel queries, allowing PostgreSQL to leverage multiple CPUs, leading to faster query execution times.<hr style="margin: 0.5em 0;">**To use**: Feature enabled by default. |
