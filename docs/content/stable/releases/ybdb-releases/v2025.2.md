...
| {{<tags/feature/ga idea="1516">}}[Parallel queries](/stable/additional-features/parallel-query/) | Improves query performance for colocated, hash, and range sharded tables by allowing PostgreSQL to leverage multiple CPUs, leading to faster query execution times.<hr style="margin: 0.5em 0;">**To use**: Feature enabled by default. |
