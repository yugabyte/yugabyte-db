...
## v2025.2.5.2 - July 28, 2026 {#v2025.2.5.2}

**Build:** `2025.2.5.2-b3`

**Third-party licenses:** [YugabyteDB](https://downloads.yugabyte.com/releases/2025.2.5.2/yugabytedb-2025.2.5.2-b3-third-party-licenses.html), [YugabyteDB Anywhere](https://downloads.yugabyte.com/releases/2025.2.5.2/yugabytedb-anywhere-2025.2.5.2-b3-third-party-licenses.html)

### Downloads

{{< release-downloads version="2025.2.5.2" build="3" >}}

### Improvements

#### CDC

* Enables optional extended intent retention for CDC, controlled by two new flags, `cdc_enable_time_based_intent_retention` and `cdc_min_sec_to_retain_intent`. {{<issue 32685>}}
