...
* Dynamically adjusts `outstanding_tablet_split_limit_per_tserver` and `full_compaction_pool_max_threads` based on CPU count, optimizing tablet splitting and compaction concurrency on up to 7 cores. {{<issue 30966>}}
