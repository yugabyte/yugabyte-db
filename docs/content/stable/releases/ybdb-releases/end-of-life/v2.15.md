...
menu:
  stable_releases:
    ...
    weight: 2850
aliases:
  - /preview/releases/ybdb-releases/v2.15/
rightNav:
  hideH4: true
type: docs
---
...
* [[13499](https://github.com/yugabyte/yugabyte-db/issues/13499)] [[13899](https://github.com/yugabyte/yugabyte-db/issues/13899)] [YSQL] Fix errors with IN query when values in search arrays overflow
...
* [[12554](https://github.com/yugabyte/yugabyte-db/issues/12554)] [xCluster] Fix Replication in For Transactions Spanning Multiple Write Batches
...
* [xCluster] Fix Replication in For Transactions Spanning Multiple Write Batches
