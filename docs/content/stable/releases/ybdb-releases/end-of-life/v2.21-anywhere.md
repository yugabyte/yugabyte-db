...
aliases:
  - /stable/releases/yba-release-notes/preview-release/
  - /preview/releases/yba-releases/v2.21/
menu:
  stable_releases:
...
<ul class="nav nav-tabs-alt nav-tabs-yb">
  <li >
    <a href="../v2.21/" class="nav-link">
    <img src="/icons/database.svg" alt="Server Icon"><span>YugabyteDB</span>
    </a>
  </li>
    <li >
    <a href="../v2.21-anywhere/" class="nav-link active">
...
This is a [YugabyteDB-only release](../v2.21/#v2.21.0.1), with no changes to YugabyteDB Anywhere.
