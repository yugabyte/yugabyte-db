...
* Stores the node agent provisioning package version on the disk and compares it during preflight, ensuring proper node_exporter installation. PLAT-14995,PLAT-14974,PLAT-14802
...
* Enables user to configure logging level for for node agent provisioning and fixes minor bugs causing provisioning installation failure. PLAT-15153,PLAT-15132
...
* Introduces a reboot-required module for node agent provisioning. PLAT-14564
...
* Allows passing the region_name during node agent provisioning installation, fixing installation failures. PLAT-15325
* Revises disk mount preflight checks and enhances check output formatting. PLAT-15133,PLAT-15332
* Sets 755 permissions on node-agent service file to ensure it restarts after node reboot when using node agent provisioning. PLAT-15345
