...
aliases:
  - /stable/releases/ybdb-releases/v2.25/
menu:
  stable_releases:
    identifier: v2.25
    parent: end-of-life
...
YugabyteDB now supports [Inspect at PIT](/stable/manage/backup-restore/point-in-time-recovery/inspect/) (time-travel queries), allowing users to run queries as if they were executed at a specified point in the past. This capability enables historical data analysis, auditing, and debugging, without requiring separate backups or snapshots, enhancing data visibility in a running database.
