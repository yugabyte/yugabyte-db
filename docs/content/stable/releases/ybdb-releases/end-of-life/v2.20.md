---
title: What's new in the v2.20 LTS release series
headerTitle: What's new in the v2.20 LTS release series
...
aliases:
  - /stable/releases/ybdb-releases/v2.20/
menu:
  stable_releases:
    identifier: v2.20
    parent: end-of-life
...
<ul class="nav nav-tabs-alt nav-tabs-yb">
  <li >
    <a href="../v2.20/" class="nav-link active">
    <img src="/icons/database.svg" alt="Server Icon"><span>YugabyteDB</span>
    </a>
  </li>
    <li >
    <a href="../v2.20-anywhere/" class="nav-link">
...
{{<ta 20648>}} Impacts: v2.20.0.0 to 2.20.1.2 - Index update can be wrongly applied on batch writes

{{<ta 20827>}} Impacts: v2.20.1.0 to 2.20.1.3 - Correctness issue for queries using SELECT DISTINCT
