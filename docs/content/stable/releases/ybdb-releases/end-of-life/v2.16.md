...
* Avails a more robust stats collector to prevent crashes when a query is terminated while holding a LWLock, ensuring uninterrupted analytics data gathering. {{<issue 19572>}}
