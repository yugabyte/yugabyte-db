...
* Upgrades Prometheus to version 3.12.0, enhancing security by addressing critical and high-severity CVEs. PLAT-21229
...
* Ensures accurate systemd scope detection and handling, avoiding unnecessary daemon reloads and node stalls. PLAT-21468
