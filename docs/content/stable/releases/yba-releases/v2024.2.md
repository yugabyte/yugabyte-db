...
To prepare for v2025.2, update your node provisioning automation and workflows to support the [node agent script](/v2024.2/yugabyte-platform/prepare/server-nodes-software/software-on-prem/).

To migrate universe nodes to the new automated provisioning, you can follow the [node patching procedure](/v2024.2/yugabyte-platform/manage-deployments/upgrade-nodes/).
...
<ul class="nav yb-pills">
 <li>
   <a href="https://downloads.yugabyte.com/releases/2024.2.10.0/yba_installer_full-2024.2.10.0-b57-linux-x86_64.tar.gz">
...
* Fixes memory limit configuration to prevent system crashes on dedicated nodes. PLAT-20584,PLAT-20683
* Fixes service management on mixed-systemd nodes to prevent master start failures. PLAT-20752
...
* Upgrades Prometheus to version 3.12.0, enhancing security by addressing critical vulnerabilities. PLAT-21229
* Upgrades Prometheus to 3.12.0 to fix critical and high-severity CVEs. PLAT-21229
* Automates changing the installation directory to the Yugabyte user's home directory. PLAT-20566
...
* Pins the base image in pex builder to ensure consistent builds. PLAT-20901
...
<ul class="nav yb-pills">
 <li>
   <a href="https://downloads.yugabyte.com/releases/2024.2.9.1/yba_installer_full-2024.2.9.1-b8-linux-x86_64.tar.gz">
     <i class="fa-brands fa-linux"></i>
     <span>Linux x86</span>
   </a>
 </li>
...
* Adds wildcard support for OIDC redirect URIs, with a new `oidc_callback_mode` flag for easy configuration. PLAT-20661
...
<ul class="nav yb-pills">
 <li>
   <a href="https://downloads.yugabyte.com/releases/2024.2.9.0/yba_installer_full-2024.2.9.0-b55-linux-x86_64.tar.gz">
     <i class="fa-brands fa-linux"></i>
     <span>Linux x86</span>
   </a>
 </li>
...
* Ensures the DR failover API payload type matches backend expectations. PLAT-18713
* Changes Prometheus OS user to non-interactive for enhanced security. PLAT-19810
* Simplifies systemd handling by removing sudo check and installing service during node-agent installation. PLAT-18881
...
* Resolves an issue with the INI template in the node agent provisioning branch. PLAT-19898
* Adds node agent provisioning support for SLES 15 SP7 by integrating zypper and skipping unnecessary checks. PLAT-19908
* Stores `ynp_version` file in a hidden `.yugabyte` folder to prevent accidental deletion. PLAT-20033
