...
{{< release-downloads version="2026.1.1.0" build="70" type="yba" >}}

### New features

#### Core Database

* *FIPS 140-2 Compliance* - YugabyteDB and YugabyteDB Anywhere (K8s only) now support FIPS 140-2–compliant encryption when configured during initial installation. <!-- IDEA-1247 -->
...
* Ensures software upgrade rollback tasks are idempotent and adds fault tolerance tests. PLAT-19851
...
* Ensures `node_exporter` restarts if updated during YNP provisioning. PLAT-21095
