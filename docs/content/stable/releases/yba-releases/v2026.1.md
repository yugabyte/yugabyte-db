...
{{% highlight-card title="OIDC-based authentication in YCQL" link="/stable/yugabyte-platform/security/authentication/oidc-authentication-aad/" maturity="ga" %}}
...
{{% highlight-card title="Kubernetes Operator enhancements" link="/stable/yugabyte-platform/anywhere-automation/yb-kubernetes-operator/#import-universe" maturity="ga" %}}
...
{{% highlight-card title="Kubernetes Operator High Availability" link="/stable/yugabyte-platform/administer-yugabyte-platform/operator-high-availability/" maturity="ea" %}}
