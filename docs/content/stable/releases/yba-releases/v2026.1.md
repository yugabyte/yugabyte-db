...
| {{<tags/feature/ga idea="2459">}}[Full move for Kubernetes universes](/stable/yugabyte-platform/scale-deployments/kubernetes-full-move/) | Added support for changing storage attributes of Kubernetes nodes, including volume count, storage class, and volume size on existing universes. This done via a "full move", where a new pod for each TServer node is added and data is migrated from the old pods to the new ones. <br /> <img src="/icons/connect.svg" style="height: 1em; display: inline; margin: 0 0.25em 0 0; vertical-align: middle;" /> **To use**: Full move for Kubernetes universes requires YugabyteDB v2026.1.0.0 or later on the universe. Based on how your universe is managed, see [Non-operator universes](/stable/yugabyte-platform/scale-deployments/kubernetes-full-move/#non-operator-universes) or [Operator universes](/stable/yugabyte-platform/scale-deployments/kubernetes-full-move/#operator-universes).|
