...
**Build:** `2026.1.0.0-b103`

**Third-party licenses:** [YugabyteDB](https://downloads.yugabyte.com/releases/2026.1.0.0/yugabytedb-2026.1.0.0-b103-third-party-licenses.html), [YugabyteDB Anywhere](https://downloads.yugabyte.com/releases/2026.1.0.0/yugabytedb-anywhere-2026.1.0.0-b103-third-party-licenses.html)

### Download

<ul class="nav yb-pills">
 <li>
   <a href="https://downloads.yugabyte.com/releases/2026.1.0.0/yba_installer_full-2026.1.0.0-b103-linux-x86_64.tar.gz">
...
* Redacts secrets asynchronously, avoiding YBA startup delays and ensuring efficient processing. PLAT-19624
* Fixes the issue causing YBA startup delays due to lengthy R__Redact_Secrets_From_Audit migration. PLAT-19624
...
* Respects the `skip_tls_verify` setting in YNP. PLAT-19864
* Enables respecting `skip_tls_verify` in YNP connections. PLAT-19864
...
* Ensures node removal is safe by refactoring prechecks and improving error messages. PLAT-18690
* Allows for node removal checks and updates Swagger files for accuracy. PLAT-18690
* Ensures proper checks are in place for node removal. PLAT-18690
...
* Ensures software upgrade progress is visible in the paginated task list API. PLAT-20535
* Enables viewing software upgrade progress directly in the paginated task list response. PLAT-20535
...
* Allows importing universes to the operator only if not shared with non-operator universes. PLAT-12874
...
* Adds `Not preferred` option for leaderPreference in placements. PLAT-19459
...
* Adds resource usage tracking to each reconciler. PLAT-19713
...
* Ensures CLI commands for editing replica regions now function correctly. PLAT-20206
* Fixes region and zone editing issues in CLI, ensuring flags work correctly. PLAT-20206
