...
YugabyteDB Anywhere v2025.2 (available late 2025) will not support legacy node provisioning for on-premises universes. Before upgrading to 2025.2, be sure to update your node provisioning workflows to support the [node agent script](../software-on-prem/#run-the-provisioning-script).
