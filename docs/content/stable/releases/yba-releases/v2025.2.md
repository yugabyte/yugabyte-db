...
* Kubernetes
  ...
  * [Kubernetes immutability](/v2025.2/yugabyte-platform/create-deployments/create-universe-multi-zone-kubernetes/#deploy-immutable-yb-contoller-ybc). Added support to deploy code via immutable Helm images instead of at runtime, eliminating the use of 'kubectl cp' to push executables into the pod or container. {{<tags/feature/ga idea="1264">}}
