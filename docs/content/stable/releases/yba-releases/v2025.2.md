...
<ul class="nav yb-pills">
 <li>
   <a href="https://downloads.yugabyte.com/releases/2025.2.0.0/yba_installer_full-2025.2.0.0-b130-linux-x86_64.tar.gz">
...
* Enhances [ClockBound](/stable/yugabyte-platform/create-deployments/create-universe-multi-zone/#configure-clockbound-optional) health checks to include systemd status and log analysis. {{<tags/feature/ea idea="2133">}}
