...
{{< release-downloads version="2025.2.6.0" build="109" type="yba" >}}
...
* Upgrades Apache Mina core to 2.2.8, addressing critical CVEs for enhanced security. PLAT-21761
...
* Upgrade Go dependencies in YBA to fix 11 CVEs, addressing security review concerns. PLAT-21555
...
* Upgrade Prometheus to 3.13.1, addressing security vulnerabilities, and Postgres to 14.23 for enhanced security and stability. PLAT-21546,PLAT-21720
...
* Upgrade azcopy to version 10.32.7 and update Go dependencies to address security vulnerabilities. PLAT-22062
