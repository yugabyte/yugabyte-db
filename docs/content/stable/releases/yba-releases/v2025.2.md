...
* Documents renamed YSQL Connection Manager gflags for universes with built-in connection pooling (`ysql_conn_mgr_internal_conn_user`, `ysql_conn_mgr_reserve_internal_conns`, `ysql_conn_mgr_enable_prep_stmt_close`). Deprecated `ysql_conn_mgr_username`, `ysql_conn_mgr_password`, `ysql_conn_mgr_max_phy_conn_percent`, and `ysql_conn_mgr_deallocate_if_invalid_prep_stmt`.
