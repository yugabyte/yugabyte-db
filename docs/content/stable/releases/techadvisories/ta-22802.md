...
description: DDL operations may cause inconsistencies between the PostgreSQL system catalog and the underlying DocDB schema.
...
| :------------------------- | :------------------ | :---------------- | :------- |
| {{<product "ysql">}}       | [v2.14.0.0](/stable/releases/ybdb-releases/end-of-life/v2.14/#v2.14.0.0), [v2.16.0.0](/stable/releases/ybdb-releases/end-of-life/v2.16/#v2.16.0.0), {{<release "2.18.0.0, 2.20.0.0">}} | {{<issue 22802>}}, {{<issue 16712>}} | {{<release "2024.1">}}      |
