...
- Salted Challenge Response Authentication ([SCRAM](https://docs.yugabyte.com/preview/secure/authentication/password-authentication/#scram-sha-256)) Mechanism is not supported with YSQL Connection Manager [#25870](https://github.com/yugabyte/yugabyte-db/issues/25870)
