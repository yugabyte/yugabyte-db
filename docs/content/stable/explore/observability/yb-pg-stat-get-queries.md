...
- Refer to [Cluster-wide database views](../cluster-wide-db-views/) to query terminated queries across every live YB-TServer from a single session (`gv$yb_terminated_queries`).
