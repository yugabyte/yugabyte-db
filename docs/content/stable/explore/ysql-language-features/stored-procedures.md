...
To create a stored procedure in YSQL, use the [`CREATE PROCEDURE`](../../../api/ysql/statements/ddl_create_procedure/) statement, which has the following syntax:
...
To invoke a stored procedure, use the [`CALL`](../../../api/ysql/statements/cmd_call/) statement, which has the following syntax:
...
To remove a stored procedure, use the [`DROP PROCEDURE`](../../../api/ysql/statements/ddl_drop_procedure/) statement, which has the following syntax:
