...
1. Enable CDC using the [yb-admin](../../../../admin/yb-admin/) CLI utility to administer your YugabyteDB cluster. The following command enables CDC on all the schemas and tables in the YugabyteDB database.
