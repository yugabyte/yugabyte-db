...
Starting in YugabyteDB v2026.1.2, YugabyteDB Docker images are STIG-compliant and hardened, and Helm deployments run as a non-root user (UID 10001) by default.
