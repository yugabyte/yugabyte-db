...
1. Wait until [xCluster safe time](../async-transactional-setup-semi-automatic/#verify-replication) on Standby (B) is greater than the current time obtained on Primary (A).
