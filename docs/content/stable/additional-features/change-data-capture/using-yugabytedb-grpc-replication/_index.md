...
{{<tags/feature/ea idea="2762">}}Starting in v2026.1.1.0, create and manage gRPC CDC streams with the PostgreSQL replication-slot interface (`yb_grpc` plugin). See [Create a gRPC CDC stream](./cdc-get-started/#create-a-grpc-cdc-stream).
