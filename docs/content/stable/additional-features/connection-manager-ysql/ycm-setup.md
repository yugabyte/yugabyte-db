...
| ysql_conn_mgr_tcmalloc_gc_interval | Interval (in seconds) between TCMalloc page-heap GC checks in YSQL Connection Manager. Set to 0 to disable periodic GC.<br>Default: 300. v2025.2.4.0 and later only. |
