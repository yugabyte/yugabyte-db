...
| [pg_duckdb](extension-pgduckdb/){{<tags/feature/tp>}} | Pre-bundled | Embeds the DuckDB analytics engine for data-lake I/O. Import Parquet, CSV, and JSON from object stores or the local file system into YugabyteDB tables, and export query results to lake files. |
