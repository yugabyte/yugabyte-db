...
Dumps taken with ysql_dump or ysql_dumpall (v2025.2.7.0 or later, v2026.1.2.0 or later) begin with the [`\restrict`](../../../api/ysqlsh-meta-commands/#restrict-restrict-key) meta-command. Replay them with ysqlsh from the same or a later version. See [ysql_dump Notes](../../../admin/ysql-dump/#notes).
