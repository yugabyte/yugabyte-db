...
1. {{<tags/feature/ea idea="1455">}}To optimize performance, you can set the [yb_insert_on_conflict_read_batch_size](../../../../../reference/configuration/yb-tserver/#yb-insert-on-conflict-read-batch-size) configuration parameter to use `INSERT .. ON CONFLICT` statements. Otherwise, use basic `INSERT` statements if possible.
