...
2. Set the following configuration-related constants:
    ...
    - **SSL_MODE** - the SSL mode to use. YugabyteDB Aeon [requires SSL connections](/stable/yugabyte-cloud/cloud-secure-clusters/cloud-authentication/); use `SslMode::Require`.
...
[Rust-Postgres driver](/stable/develop/drivers-orms/rust/yb-rust-postgres/)
