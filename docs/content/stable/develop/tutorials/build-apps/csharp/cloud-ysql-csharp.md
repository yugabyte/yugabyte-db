...
2. Set the following configuration-related parameters:
    ...
    - **urlBuilder.SslMode** - the SSL mode to use. YugabyteDB Aeon [requires SSL connections](/stable/yugabyte-cloud/cloud-secure-clusters/cloud-authentication/); use `SslMode.VerifyFull`.
...
[Npgsql driver](/stable/develop/drivers-orms/csharp/postgres-npgsql/)
