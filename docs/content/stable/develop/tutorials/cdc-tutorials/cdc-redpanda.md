...
| --- | --- | --- |
| 1 | CDC Enabled and [Create the Stream ID](/stable/integrations/cdc/debezium/) for specific YSQL database. | YugabyteDB |
...
If you're running a Windows Machine then you can [leverage Docker on Windows with YugabyteDB](/stable/quick-start/docker/).
