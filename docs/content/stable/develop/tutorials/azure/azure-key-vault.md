...
1. Install the [YugabyteDB node-postgres smart driver](/stable/develop/drivers-orms/nodejs/yugabyte-node-driver/).
...
You can also use Azure Key Vault to store customer managed keys for encrypting clusters in YugabyteDB Aeon - see [Encryption at rest](/stable/yugabyte-cloud/cloud-secure-clusters/managed-ear/).
