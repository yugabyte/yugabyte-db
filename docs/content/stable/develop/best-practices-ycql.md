...
Each element inside a collection ends up as a [separate key value](../../architecture/docdb/architecture/docdb/data-model/#examples) in DocDB adding per-element overhead.
