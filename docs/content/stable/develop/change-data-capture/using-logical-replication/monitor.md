...
| restart_lsn | pg_lsn | The Log Sequence Number ([LSN](../advanced-topic/#using-the-hybrid-time-lsn)) of the oldest change record which still might be required by the consumer of this slot and thus won't be automatically removed during checkpoints. |
