...
For a tutorial on building a sample Ruby application with Rust-Postgres, see [Build a Rust application](/stable/develop/tutorials/build-apps/rust/cloud-ysql-rust/).
