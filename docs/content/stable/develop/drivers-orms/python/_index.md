...
| ------- | ------------------------ | ------------------------ | ---------------------|
| Yugabyte Psycopg2 Smart Driver [Recommended] | [Documentation](yugabyte-psycopg2/) <br /> [Reference](yugabyte-psycopg2-reference/)| 2.9.3.5 | 2.8 and above |
| Yugabyte Psycopg3 Smart Driver | [Documentation](yugabyte-psycopg3/) <br /> [Reference](yugabyte-psycopg3-reference/) | 3.3.4.1rc1 (pre-release) | 2.20 and above |
