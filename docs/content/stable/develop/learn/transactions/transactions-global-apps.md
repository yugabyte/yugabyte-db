...
You can also do this by marking zones as [preferred](../../../../yugabyte-platform/create-deployments/create-universes-overview/#preferred-region) when creating or editing a universe in [YugabyteDB Anywhere](../../../../yugabyte-platform/), or [setting the region as preferred](/stable/yugabyte-cloud/cloud-basics/create-clusters/create-clusters-multisync/#preferred-region) in YugabyteDB Aeon.
