...
Advisory locks available in v2025.1 or later, and enabled by default. Y To enable and configure advisory locks, use the [Advisory lock flags](../../../reference/configuration/yb-tserver/#advisory-lock-flags).
