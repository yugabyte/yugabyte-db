...
You can also use the legacy [yb-admin](../../../admin/yb-admin/#create-change-data-stream) `create_change_data_stream` command to create streams.
...
See [Create a gRPC CDC stream](../../../additional-features/change-data-capture/using-yugabytedb-grpc-replication/cdc-get-started/#create-a-grpc-cdc-stream).
