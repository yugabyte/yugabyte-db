...
### xCluster replication of Materialized Views is not supported
Setting up xCluster replication for materialized views is currently not supported. While setting up replication for a database, materialized views need to be excluded. Yugabyte Anywhere automatically excludes Materialized views from replication setup.
