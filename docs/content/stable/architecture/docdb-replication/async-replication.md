...
Setting up xCluster replication for materialized views is currently not supported. While setting up replication for a database, materialized view need to be excluded. Yugabyte Anywhere automatically excludes Materialized views from replication setup.
