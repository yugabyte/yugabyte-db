...
{{< warning title="Removed Oracle live migration" >}}

[Live migration](../migrate/live-migrate/) from Oracle databases, including [live migration with fall-forward](../migrate/live-fall-forward/) and [live migration with fall-back](../migrate/live-fall-back/), is no longer supported. Oracle remains supported for [offline migration](../migrate/migrate-steps/). Live migration continues to be available for PostgreSQL source databases.
