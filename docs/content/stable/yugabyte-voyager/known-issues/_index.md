...
| Unsupported data types | Data migration is unsupported for some data types, such as BLOB. For others such as ANY and BFile, both schema and data migration is unsupported. Refer to [datatype mapping](../reference/datatype-mapping-oracle/) for the detailed list of data types. | |
