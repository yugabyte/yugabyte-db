...
| CLOB | TEXT | Data migration is allowed to a limit of 235MB per file. Live migration from Oracle is not supported. |
| NCLOB | TEXT | Data migration is allowed to a limit of 235MB per file. Live migration from Oracle is not supported. |
...
| REF | | Not supported. |
| Nested tables | Composite type |  Unsupported when used with [BETA_FAST_DATA_EXPORT](../../migrate/migrate-steps/#accelerate-data-export-for-mysql-and-oracle).|
