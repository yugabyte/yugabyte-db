...
| Spring Data YugabyteDB  | 2.3.0   | Full | [CRUD](/stable/integrations/spring-framework/sdyb/#examples) |
| Spring Data JPA         | 2.6.3   | Full | [CRUD](/stable/integrations/spring-framework/sd-jpa/#fundamentals) |
...
| PostgreSQL Psycopg3 Driver | [3.2.9](https://github.com/psycopg/psycopg) | Full | [CRUD](/stable/drivers-orms/python/postgres-psycopg3/) |
