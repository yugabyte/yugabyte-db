...
{{<tags/feature/ea idea="2762">}}Prefer creating the stream with the PostgreSQL replication-slot interface and the `yb_grpc` plugin (v2026.1.1.0+, after upgrade finalization):
...
Alternatively, [yb-admin](../../../admin/yb-admin#change-data-capture-cdc-commands) can still create a stream ID (deprecated):
