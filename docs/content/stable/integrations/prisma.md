...
The [Hello World Example](/stable/develop/drivers-orms/nodejs/prisma/) uses the current Prisma ORM.
...
If you are new to YugabyteDB, you can be up and running with YugabyteDB in under five minutes by following the steps in [Quick start](/stable/quick-start/macos/).
