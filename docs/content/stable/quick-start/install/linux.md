...
1. Download the YugabyteDB package using the following `wget` command.
    ...
    ```sh
    $ wget https://downloads.yugabyte.com/releases/2.8.2.0/yugabyte-2.8.2.0-b47-linux-x86_64.tar.gz
    ```
    ...
    ```sh
    $ wget https://downloads.yugabyte.com/releases/2.8.2.0/yugabyte-2.8.2.0-b47-el8-aarch64.tar.gz
    ```

1. Extract the package and then change directories to the YugabyteDB home.

    ```sh
    $ tar xvfz yugabyte-2.8.2.0-b47-linux-x86_64.tar.gz && cd yugabyte-2.8.2.0/
    ```
