...
If you are using bucket indexing and have configured suitable parameters, EXPLAIN output includes additional fields. Refer to [Bucket indexes](../../../../../develop/data-modeling/indexes-constraints/bucket-index-ysql/).
