...
| [xmlagg()](../../../datatypes/type_xml/) | Concatenates XML values. See [XML data type and functions](../../../datatypes/type_xml/) and the [PostgreSQL xmlagg() documentation](https://www.postgresql.org/docs/15/functions-aggregate.html). |
