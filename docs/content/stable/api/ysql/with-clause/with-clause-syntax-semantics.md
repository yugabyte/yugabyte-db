...
<div class="tab-content">
  ...
  {{% includeMarkdown "../syntax_resources/with-clause/with_clause,common_table_expression.grammar.md" %}}
  </div>
  <div id="diagram" class="tab-pane fade" role="tabpanel" aria-labelledby="diagram-tab">
  {{% includeMarkdown "../syntax_resources/with-clause/with_clause,common_table_expression.diagram.md" %}}
  </div>
</div>
