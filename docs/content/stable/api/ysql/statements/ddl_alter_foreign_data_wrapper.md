...
<div class="tab-content">
  ...
  {{% includeMarkdown "../syntax_resources/statements/alter_foreign_data_wrapper.grammar.md" %}}
  </div>
  <div id="diagram" class="tab-pane fade" role="tabpanel" aria-labelledby="diagram-tab">
  {{% includeMarkdown "../syntax_resources/statements/alter_foreign_data_wrapper.diagram.md" %}}
  </div>
</div>
