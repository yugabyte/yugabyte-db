...
<div class="tab-content">
  ...
  {{% includeMarkdown "../syntax_resources/statements/delete,returning_clause.grammar.md" %}}
  </div>
  <div id="diagram" class="tab-pane fade" role="tabpanel" aria-labelledby="diagram-tab">
  {{% includeMarkdown "../syntax_resources/statements/delete,returning_clause.diagram.md" %}}
  </div>
</div>
