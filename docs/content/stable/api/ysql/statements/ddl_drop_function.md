...
<div class="tab-content">
  ...
  {{% includeMarkdown "../syntax_resources/statements/drop_function,subprogram_signature,arg_decl.grammar.md" %}}
  </div>
  <div id="diagram" class="tab-pane fade" role="tabpanel" aria-labelledby="diagram-tab">
  {{% includeMarkdown "../syntax_resources/statements/drop_function,subprogram_signature,arg_decl.diagram.md" %}}
  </div>
</div>
