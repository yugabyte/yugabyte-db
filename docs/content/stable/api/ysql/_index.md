...
The simplest way to achieve this ideal sandbox regime is to use your own laptop. The [Quick Start](/preview/tutorials/quick-start/explore/ysql/) section shows you how to do this.
