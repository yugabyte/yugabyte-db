...
The data collected depends on the collection level set. See the [section](/manage/diagnostics-reporting/#configuration-flags) below on how to change the collection level.
