...
For information on internal load balancing to power geo-distributed applications, see [YugabyteDB JDBC Driver](/preview/reference/drivers/java/yugabyte-jdbc-reference/).
