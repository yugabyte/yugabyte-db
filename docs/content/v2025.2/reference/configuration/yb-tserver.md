...
Enables the [pg_duckdb](../../../additional-features/pg-extensions/extension-pgduckdb/) extension for data-lake I/O (Parquet, CSV, and JSON import and export). Available in v2025.2.6.0 and later.
