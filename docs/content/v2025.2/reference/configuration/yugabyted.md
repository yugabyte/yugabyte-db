...
For example, if you installed v{{< yb-version version="v2025.2"  format="short">}}, extract the `ybc-2.2.0.3-b17-linux-x86_64.tar.gz` file into the `ybc` folder as follows:
...
```sh
cp $HOME/var/generated_certs/127.0.0.1/* $HOME/yugabyte-{{< yb-version version="v2025.2" >}}/node1/certs
cp $HOME/var/generated_certs/127.0.0.2/* $HOME/yugabyte-{{< yb-version version="v2025.2" >}}/node2/certs
cp $HOME/var/generated_certs/127.0.0.3/* $HOME/yugabyte-{{< yb-version version="v2025.2" >}}/node3/certs
```
...
./bin/yugabyted configure encrypt_at_rest \
    --enable \
    --base_dir=$HOME/yugabyte-{{< yb-version version="v2025.2" >}}/node1
```
...
```sh
./bin/yugabyted destroy --base_dir=$HOME/yugabyte-{{< yb-version version="v2025.2" >}}/node1
./bin/yugabyted destroy --base_dir=$HOME/yugabyte-{{< yb-version version="v2025.2" >}}/node2
./bin/yugabyted destroy --base_dir=$HOME/yugabyte-{{< yb-version version="v2025.2" >}}/node3
```
...
./bin/yugabyted start --advertise_address=127.0.0.1 \
    --base_dir=/Users/username/yugabyte-{{< yb-version version="v2025.2" >}}/data1
```
...
1. Add two more nodes to the universe using the `--join` flag, as follows:
    ...
    ./bin/yugabyted start --secure --advertise_address=127.0.0.2 \
        --join=127.0.0.1 \
        --base_dir=$HOME/yugabyte-{{< yb-version version="v2025.2" >}}/node2 \
        --cloud_location=aws.us-east-1.us-east-1b
    ./bin/yugabyted start --secure --advertise_address=127.0.0.3 \
        --join=127.0.0.1 \
        --base_dir=$HOME/yugabyte-{{< yb-version version="v2025.2" >}}/node3 \
...
docker run -d --name yugabytedb-node1 --hostname yugabytedb-node1 --net yb-network \
    ...
    yugabytedb/yugabyte:{{< yb-version version="v2025.2" format="build">}} \
    bin/yugabyted start \
...
```sh
cp $HOME/var/generated_certs/127.0.0.4/* $HOME/yugabyte-{{< yb-version version="v2025.2" >}}/node4/certs
cp $HOME/var/generated_certs/127.0.0.5/* $HOME/yugabyte-{{< yb-version version="v2025.2" >}}/nod45/certs
cp $HOME/var/generated_certs/127.0.0.6/* $HOME/yugabyte-{{< yb-version version="v2025.2" >}}/node6/certs
cp $HOME/var/generated_certs/127.0.0.7/* $HOME/yugabyte-{{< yb-version version="v2025.2" >}}/node7/certs
cp $HOME/var/generated_certs/127.0.0.8/* $HOME/yugabyte-{{< yb-version version="v2025.2" >}}/node8/certs
```
...
1. Add read replica nodes using the `--join` and `--read_replica` flags, as follows:
    ...
    ./bin/yugabyted start \
        ...
        --join=127.0.0.1 \
        --base_dir=$HOME/yugabyte-{{< yb-version version="v2025.2" >}}/node4 \
    ...
    ./bin/yugabyted start \
        ...
        --join=127.0.0.1 \
        --base_dir=$HOME/yugabyte-{{< yb-version version="v2025.2" >}}/node5 \
        --cloud_location=aws.us-east-1.us-east-1d \
        --read_replica
    ...
    ./bin/yugabyted start \
        ...
        --join=127.0.0.1 \
        --base_dir=$HOME/yugabyte-{{< yb-version version="v2025.2" >}}/node6 \
    ...
    ./bin/yugabyted start \
        ...
        --join=127.0.0.1 \
        --base_dir=$HOME/yugabyte-{{< yb-version version="v2025.2" >}}/node7 \
    ...
    ./bin/yugabyted start \
        ...
        --join=127.0.0.1 \
        --base_dir=$HOME/yugabyte-{{< yb-version version="v2025.2" >}}/node8 \
        --cloud_location=aws.us-east-1.us-east-1f \
        --read_replica
    ```
...
```sh
./bin/yugabyted destroy --base_dir=$HOME/yugabyte-{{< yb-version version="v2025.2" >}}/node4
./bin/yugabyted destroy --base_dir=$HOME/yugabyte-{{< yb-version version="v2025.2" >}}/node5
./bin/yugabyted destroy --base_dir=$HOME/yugabyte-{{< yb-version version="v2025.2" >}}/node6
./bin/yugabyted destroy --base_dir=$HOME/yugabyte-{{< yb-version version="v2025.2" >}}/node7
./bin/yugabyted destroy --base_dir=$HOME/yugabyte-{{< yb-version version="v2025.2" >}}/node8
```

After destroying the nodes, run the `configure_read_replica delete` command to delete the read replica configuration:

```sh
./bin/yugabyted configure_read_replica delete --base_dir=$HOME/yugabyte-{{< yb-version version="v2025.2" >}}/node1
```
