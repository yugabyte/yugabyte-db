...
For example, if you installed v{{< yb-version version="v2025.2">}}, extract the `ybc-2.2.0.3-b17-linux-x86_64.tar.gz` file into the `ybc` folder as follows:

```sh
cd yugabyte-{{< yb-version version="v2025.2" >}}
