...
- Run the following command to search for the version.
  ...
  ```sh
  helm search repo yugabytedb/yugaware --version {{<yb-version version="v2025.2" format="short">}}
  ```
  ...
  yugabytedb/yugaware             {{<yb-version version="v2025.2" format="short">}}          {{<yb-version version="v2025.2" format="build">}}    YugaWare is YugaByte Database's Orchestration a...
  ```

- Fetch images tag from `values.yaml` as tags may vary depending on the version.

  ```sh
  helm show values yugabytedb/yugaware --version {{<yb-version version="v2025.2" format="short">}}
  ```
...
- Pull images to your machine.
  ...
  ```sh
  docker pull quay.io/yugabyte/yugaware:{{<yb-version version="v2025.2" format="build">}}
...
- Tag the local images to your target registry. The following example uses Google Artifact Registry.
  ...
  ```sh
  docker tag quay.io/yugabyte/yugaware:{{<yb-version version="v2025.2" format="build">}} us-central1-docker.pkg.dev/yugabytedb-test-384308/yugabytepoc/yugabyte/yugaware:{{<yb-version version="v2025.2" format="build">}}
...
- Push images to the private container registry.
  ...
  ```sh
  docker push us-central1-docker.pkg.dev/yugabytedb-test-384308/yugabytepoc/yugabyte/yugaware:{{<yb-version version="v2025.2" format="build">}}
