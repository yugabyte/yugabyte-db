...
1. Execute the following command to add the [YugabyteDB charts](https://charts.yugabyte.com/) repository:
    ...
    ```shell
    helm search repo yugabytedb/yugaware-openshift --version {{<yb-version version="v2025.2" format="short">}}
    ```
    ...
    yugabytedb/yugaware-openshift {{<yb-version version="v2025.2" format="short">}}          {{<yb-version version="v2025.2" format="build">}}  YugaWare is YugaByte Database's Orchestration a...
    ```
