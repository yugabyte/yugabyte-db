...
1. Download and extract the YugabyteDB Anywhere CLI by entering the following commands:
    ...
    ```sh
    wget https://downloads.yugabyte.com/releases/{{<yb-version version="v2025.2" format="long">}}/yba_cli-{{<yb-version     version="stable" format="build">}}-linux-amd64.tar.gz
    tar -xf yba_cli-{{<yb-version version="v2025.2" format="build">}}-linux-amd64.tar.gz
    cd yba_cli-{{<yb-version version="v2025.2" format="build">}}-linux-amd64/
    ```
