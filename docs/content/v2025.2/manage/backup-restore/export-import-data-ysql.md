...
Dumps taken with ysql_dump or ysql_dumpall in v2025.2.7.0+ or v2026.1.2+ begin with the [`\restrict`](../../../api/ysqlsh-meta-commands/#restrict-restrict) meta-command. Replay them with ysqlsh from the same or a later version. See [ysql_dump Notes](../../../admin/ysql-dump/#notes).
