...
aliases:
  - /v2025.2/manage/backup-restore/export-import-data/
menu:
  v2025.2:
...
Dumps taken with ysql_dump or ysql_dumpall 2025.2.7.0, 2026.1.2.0, or later begin with the [`\restrict`](../../../api/ysqlsh-meta-commands/#restrict-restrict-key) meta-command. Replay them with ysqlsh from the same or a later version. See [ysql_dump Notes](../../../admin/ysql-dump/#notes).
