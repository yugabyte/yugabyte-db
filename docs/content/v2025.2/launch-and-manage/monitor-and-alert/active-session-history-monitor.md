...
| wait_event_aux_description | text | Information about what type of auxiliary data the wait event contains. For example, if the wait event contains a tablet ID (first 15 characters), table ID (first 15 characters), or RPC name. |
...
| Wait Event | Type | <div style="width:100px">Aux</div> | Description |
| :--------- | :--- | :-- | :---------- |
| VectorIndex_Search | CPU | Tablet ID | The vector index is performing an approximate nearest neighbor search. <br> Supported in v2025.2.5.0 or later, and v2026.1.1.0 or later.|
