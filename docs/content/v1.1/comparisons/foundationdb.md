...
Following are the key areas of difference between YugabyteDB 1.1 (released September 2018) and FoundationDB 6.0 (released November 2018).
...
The following post(s) cover some more details around how YugabyteDB differs from FoundationDB.
