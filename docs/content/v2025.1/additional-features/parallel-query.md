...
Currently, YugabyteDB supports parallel queries for [colocated tables](../colocation/); support for [hash- and range-sharded](../../architecture/docdb-sharding/sharding/) tables is available in v2025.2.
