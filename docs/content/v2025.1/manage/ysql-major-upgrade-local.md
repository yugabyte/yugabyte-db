...
Use the [pg_upgrade](https://www.postgresql.org/docs/15/pgupgrade.html) tool provided with v2025.1 and later (in the `postgres/bin` directory) to make sure your cluster is compatible with the new version.
