...
Starting from YugabyteDB v2025.1.1.0, this flag supports dynamic updates: when set at runtime, it sends a `SIGHUP` signal to the postmaster process to reload the configuration without requiring a server restart.
