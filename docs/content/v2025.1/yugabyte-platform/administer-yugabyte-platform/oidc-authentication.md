...
When registering YugabyteDB Anywhere as a client application with your IdP, you must provide a callback (redirect) URI. This is the URL the IdP redirects users to after authentication:
