...
For restoring from a backup to a point in time, on the original or an alternate universe, see [Restore from backup](../restore-universe-data/#restore-a-pitr-enabled-backup).
