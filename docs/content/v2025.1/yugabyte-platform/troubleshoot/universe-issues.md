...
You can also create "Custom Queries" by providing PromQL expressions will be run and the result will be stored in the support bundle under the corresponding folder name.
