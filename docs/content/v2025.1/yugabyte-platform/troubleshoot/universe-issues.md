...
You can also create "Custom Queries" by providing PromQL expressions; their results will be stored in the support bundle under the corresponding folder name.
