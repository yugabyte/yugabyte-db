...
SELECT create_parent('partman_test.id_taptest_table_123456789012345678901234567890123456789012345', 'col1', 'id', '10');
...
SELECT hasnt_table('partman_test', 'id_taptest_table_123456789012345678901234567890123456789012_p60', 'Check id_taptest_table_123456789012345678901234567890123456789012_p60 doesn''t exists yet');
...
SELECT undo_partition_id('partman_test.id_taptest_table_123456789012345678901234567890123456789012345', 10);
