...
SELECT results_eq('SELECT partition_data_time(''partman_test.time_dynamic_table'', p_batch_count := 5)::int', ARRAY[10], 'Check that partitioning function returns correct count of rows moved');
