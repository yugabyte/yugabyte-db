...
SELECT create_parent('partman_test.time_static_table', 'col3', 'time-custom', '30 seconds');
...
SELECT has_table('partman_test', 'time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0), 'YYYY_MM_DD_HH24MISS'), 
                'Check time_static_table_'||to_char(date_trunc('minute', CURRENT_TIMESTAMP), 'YYYY_MM_DD_HH24MISS')||' exists');
SELECT has_table('partman_test', 'time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)+'30 secs'::interval, 'YYYY_MM_DD_HH24MISS'), 
    'Check time_static_table_'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
...
SELECT hasnt_table('partman_test', 'time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
...
SELECT col_is_pk('partman_test', 'time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0), 'YYYY_MM_DD_HH24MISS'), ARRAY['col1'], 
    'Check for primary key in time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0), 'YYYY_MM_DD_HH24MISS'));
SELECT col_is_pk('partman_test', 'time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
...
SELECT table_privs_are('partman_test', 'time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0), 'YYYY_MM_DD_HH24MISS'), 'partman_basic', 
    ARRAY['SELECT','INSERT','UPDATE'], 
    'Check partman_basic privileges of time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0), 'YYYY_MM_DD_HH24MISS'));
SELECT table_privs_are('partman_test', 'time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
...
SELECT table_privs_are('partman_test', 'time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
    ...
    'Check partman_revoke privileges of time_static_table_'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0), 'YYYY_MM_DD_HH24MISS'));
SELECT table_privs_are('partman_test', 'time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)+'30 secs'::interval, 'YYYY_MM_DD_HH24MISS'), 'partman_revoke', 
    ARRAY['SELECT', 'INSERT', 'UPDATE', 'DELETE', 'TRUNCATE', 'REFERENCES', 'TRIGGER'], 
    'Check partman_revoke privileges of time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)+'30 secs'::interval, 'YYYY_MM_DD_HH24MISS'));
SELECT table_privs_are('partman_test', 'time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
...
SELECT results_eq('SELECT count(*)::int FROM partman_test.time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0), 'YYYY_MM_DD_HH24MISS'), 
    ARRAY[10], 'Check count from time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0), 'YYYY_MM_DD_HH24MISS'));

REVOKE INSERT, UPDATE, DELETE, TRUNCATE, REFERENCES, TRIGGER ON partman_test.time_static_table FROM partman_revoke;
INSERT INTO partman_test.time_static_table (col1, col3) VALUES (generate_series(11,20), CURRENT_TIMESTAMP + '30 secs'::interval);
INSERT INTO partman_test.time_static_table (col1, col3) VALUES (generate_series(21,25), CURRENT_TIMESTAMP + '60 secs'::interval);
INSERT INTO partman_test.time_static_table (col1, col3) VALUES (generate_series(26,30), CURRENT_TIMESTAMP + '90 secs'::interval);
INSERT INTO partman_test.time_static_table (col1, col3) VALUES (generate_series(31,37), CURRENT_TIMESTAMP + '120 secs'::interval);
INSERT INTO partman_test.time_static_table (col1, col3) VALUES (generate_series(40,49), CURRENT_TIMESTAMP - '30 secs'::interval);
INSERT INTO partman_test.time_static_table (col1, col3) VALUES (generate_series(50,70), CURRENT_TIMESTAMP - '60 secs'::interval);
INSERT INTO partman_test.time_static_table (col1, col3) VALUES (generate_series(71,85), CURRENT_TIMESTAMP - '90 secs'::interval);
INSERT INTO partman_test.time_static_table (col1, col3) VALUES (generate_series(86,100), CURRENT_TIMESTAMP - '120 secs'::interval);
...
SELECT results_eq('SELECT count(*)::int FROM partman_test.time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)+'60 secs'::interval, 'YYYY_MM_DD_HH24MISS'), 
    ARRAY[5], 'Check count from time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)+'60 secs'::interval, 'YYYY_MM_DD_HH24MISS'));
SELECT results_eq('SELECT count(*)::int FROM partman_test.time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)+'90 secs'::interval, 'YYYY_MM_DD_HH24MISS'), 
    ARRAY[5], 'Check count from time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
...
SELECT results_eq('SELECT count(*)::int FROM partman_test.time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)+'120 secs'::interval, 'YYYY_MM_DD_HH24MISS'), 
    ARRAY[7], 'Check count from time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)+'120 secs'::interval, 'YYYY_MM_DD_HH24MISS'));
SELECT results_eq('SELECT count(*)::int FROM partman_test.time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)-'30 secs'::interval, 'YYYY_MM_DD_HH24MISS'), 
    ARRAY[10], 'Check count from time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
...
SELECT results_eq('SELECT count(*)::int FROM partman_test.time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)-'60 secs'::interval, 'YYYY_MM_DD_HH24MISS'), 
    ARRAY[21], 'Check count from time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)-'60 secs'::interval, 'YYYY_MM_DD_HH24MISS'));
SELECT results_eq('SELECT count(*)::int FROM partman_test.time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)-'90 secs'::interval, 'YYYY_MM_DD_HH24MISS'), 
    ARRAY[15], 'Check count from time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)-'90 secs'::interval, 'YYYY_MM_DD_HH24MISS'));
SELECT results_eq('SELECT count(*)::int FROM partman_test.time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)-'120 secs'::interval, 'YYYY_MM_DD_HH24MISS'), 
    ARRAY[15], 'Check count from time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
...
SELECT run_maintenance();
INSERT INTO partman_test.time_static_table (col1, col3) VALUES (generate_series(101,122), CURRENT_TIMESTAMP + '150 secs'::interval);
...
SELECT results_eq('SELECT count(*)::int FROM partman_test.time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)+'150 secs'::interval, 'YYYY_MM_DD_HH24MISS'), 
    ARRAY[22], 'Check count from time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)+'150 secs'::interval, 'YYYY_MM_DD_HH24MISS'));

SELECT table_privs_are('partman_test', 'time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0), 'YYYY_MM_DD_HH24MISS'), 'partman_basic', ARRAY['SELECT','INSERT','UPDATE'], 
    'Check partman_basic privileges of time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0), 'YYYY_MM_DD_HH24MISS'));
SELECT table_privs_are('partman_test', 'time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)+'30 secs'::interval, 'YYYY_MM_DD_HH24MISS'), 'partman_basic', 
...
SELECT table_privs_are('partman_test', 'time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
    ...
    ARRAY['SELECT'], 'Check partman_revoke privileges of time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)+'150 secs'::interval, 'YYYY_MM_DD_HH24MISS'));
...
SELECT run_maintenance();
INSERT INTO partman_test.time_static_table (col1, col3) VALUES (generate_series(123,150), CURRENT_TIMESTAMP + '180 secs'::interval);

SELECT is_empty('SELECT * FROM ONLY partman_test.time_static_table', 'Check that parent table has had no data inserted to it');
SELECT results_eq('SELECT count(*)::int FROM partman_test.time_static_table', ARRAY[148], 'Check count from parent table');
SELECT results_eq('SELECT count(*)::int FROM partman_test.time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)+'180 secs'::interval, 'YYYY_MM_DD_HH24MISS'), 
    ARRAY[28], 'Check count from time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)+'180 secs'::interval, 'YYYY_MM_DD_HH24MISS'));
...
SELECT has_table('partman_test', 'time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
    ...
    'Check time_static_table_'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)+'180 secs'::interval, 'YYYY_MM_DD_HH24MISS')||' exists');
SELECT hasnt_table('partman_test', 'time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)+'210 mins'::interval, 'YYYY_MM_DD_HH24MISS'), 
    'Check time_static_table_'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)+'210 mins'::interval, 'YYYY_MM_DD_HH24MISS')||' exists');
SELECT col_is_pk('partman_test', 'time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
...
SELECT table_privs_are('partman_test', 'time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
    ...
    '{}'::text[], 'Check partman_revoke privileges of time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)+'180 secs'::interval, 'YYYY_MM_DD_HH24MISS'));
...
SELECT table_privs_are('partman_test', 'time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
    ...
    'Check partman_basic privileges of time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)+'180 secs'::interval, 'YYYY_MM_DD_HH24MISS'));
SELECT table_owner_is ('partman_test', 'time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)+'180 secs'::interval, 'YYYY_MM_DD_HH24MISS'), 'partman_owner', 
    'Check that ownership change worked for time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)+'180 secs'::interval, 'YYYY_MM_DD_HH24MISS'));

INSERT INTO partman_test.time_static_table (col1, col3) VALUES (generate_series(200,210), CURRENT_TIMESTAMP + '600 mins'::interval);
...
SELECT drop_partition_time('partman_test.time_static_table', '90 secs', p_keep_table := false);
SELECT hasnt_table('partman_test', 'time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)-'120 secs'::interval, 'YYYY_MM_DD_HH24MISS'), 
    'Check time_static_table_'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)-'120 secs'::interval, 'YYYY_MM_DD_HH24MISS')||' does not exist');

UPDATE part_config SET retention = '60 secs'::interval WHERE parent_table = 'partman_test.time_static_table';
...
SELECT has_table('partman_retention_test', 'time_static_table_p'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
                '30sec'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)-'90 secs'::interval, 'YYYY_MM_DD_HH24MISS'), 
    'Check time_static_table_'||to_char(date_trunc('minute', CURRENT_TIMESTAMP) + 
