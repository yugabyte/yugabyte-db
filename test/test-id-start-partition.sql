...
SELECT create_parent('partman_test.id_taptest_table', 'col1', 'id', '10', p_start_partition := '150');
...
SELECT hasnt_table('partman_test', 'id_taptest_table_p210', 'Check id_taptest_table_p210 doesn''t exists yet');
...
SELECT hasnt_table('partman_test', 'id_taptest_table_p240', 'Check id_taptest_table_p240 doesn''t exists yet');
