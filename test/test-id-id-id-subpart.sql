...
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p0_p0'', 20, p_keep_table := false)', ARRAY[999], 'Undo partitioning for parent table partman_test.id_taptest_table_p0_p0');

SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p0_p1000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p0_p1000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p0_p2000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p0_p2000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p0_p3000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p0_p3000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p0_p4000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p0_p4000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p0_p5000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p0_p5000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p0_p6000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p0_p6000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p0_p7000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p0_p7000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p0_p8000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p0_p8000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p0_p9000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p0_p9000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p10000_p10000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p10000_p10000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p10000_p11000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p10000_p11000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p10000_p12000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p10000_p12000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p10000_p13000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p10000_p13000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p10000_p14000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p10000_p14000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p10000_p15000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p10000_p15000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p10000_p16000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p10000_p16000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p10000_p17000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p10000_p17000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p10000_p18000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p10000_p18000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p10000_p19000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p10000_p19000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p20000_p20000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p20000_p20000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p20000_p21000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p20000_p21000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p20000_p22000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p20000_p22000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p20000_p23000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p20000_p23000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p20000_p24000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p20000_p24000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p20000_p25000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p20000_p25000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p20000_p26000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p20000_p26000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p20000_p27000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p20000_p27000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p20000_p28000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p20000_p28000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p20000_p29000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p20000_p29000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p30000_p30000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p30000_p30000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p30000_p31000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p30000_p31000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p30000_p32000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p30000_p32000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p30000_p33000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p30000_p33000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p30000_p34000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p30000_p34000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p30000_p35000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p30000_p35000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p30000_p36000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p30000_p36000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p30000_p37000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p30000_p37000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p30000_p38000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p30000_p38000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p30000_p39000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p30000_p39000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p40000_p40000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p40000_p40000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p40000_p41000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p40000_p41000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p40000_p42000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p40000_p42000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p40000_p43000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p40000_p43000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p40000_p44000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p40000_p44000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p40000_p45000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p40000_p45000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p40000_p46000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p40000_p46000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p40000_p47000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p40000_p47000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p40000_p48000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p40000_p48000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p40000_p49000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p40000_p49000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p50000_p50000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p50000_p50000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p50000_p51000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p50000_p51000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p50000_p52000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p50000_p52000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p50000_p53000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p50000_p53000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p50000_p54000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p50000_p54000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p50000_p55000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p50000_p55000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p50000_p56000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p50000_p56000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p50000_p57000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p50000_p57000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p50000_p58000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p50000_p58000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p50000_p59000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p50000_p59000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p60000_p60000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p60000_p60000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p60000_p61000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p60000_p61000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p60000_p62000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p60000_p62000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p60000_p63000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p60000_p63000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p60000_p64000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p60000_p64000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p60000_p65000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p60000_p65000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p60000_p66000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p60000_p66000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p60000_p67000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p60000_p67000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p60000_p68000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p60000_p68000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p60000_p69000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p60000_p69000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p70000_p70000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p70000_p70000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p70000_p71000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p70000_p71000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p70000_p72000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p70000_p72000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p70000_p73000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p70000_p73000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p70000_p74000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p70000_p74000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p70000_p75000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p70000_p75000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p70000_p76000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p70000_p76000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p70000_p77000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p70000_p77000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p70000_p78000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p70000_p78000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p70000_p79000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p70000_p79000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p80000_p80000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p80000_p80000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p80000_p81000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p80000_p81000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p80000_p82000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p80000_p82000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p80000_p83000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p80000_p83000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p80000_p84000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p80000_p84000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p80000_p85000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p80000_p85000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p80000_p86000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p80000_p86000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p80000_p87000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p80000_p87000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p80000_p88000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p80000_p88000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p80000_p89000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p80000_p89000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p90000_p90000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p90000_p90000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p90000_p91000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p90000_p91000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p90000_p92000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p90000_p92000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p90000_p93000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p90000_p93000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p90000_p94000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p90000_p94000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p90000_p95000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p90000_p95000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p90000_p96000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p90000_p96000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p90000_p97000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p90000_p97000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p90000_p98000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p90000_p98000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p90000_p99000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p90000_p99000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p100000_p100000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p100000_p100000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p100000_p101000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p100000_p101000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p100000_p102000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p100000_p102000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p100000_p103000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p100000_p103000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p100000_p104000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p100000_p104000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p100000_p105000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p100000_p105000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p100000_p106000'', 20, p_keep_table := false)', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p100000_p106000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p100000_p107000'', 20, p_keep_table := false)', ARRAY[501], 'Undo partitioning for parent table partman_test.id_taptest_table_p100000_p107000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p100000_p108000'', 20, p_keep_table := false)', ARRAY[0], 'Undo partitioning for parent table partman_test.id_taptest_table_p100000_p108000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p100000_p109000'', 20, p_keep_table := false)', ARRAY[0], 'Undo partitioning for parent table partman_test.id_taptest_table_p100000_p109000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p110000_p110000'', 20, p_keep_table := false)', ARRAY[0], 'Undo partitioning for parent table partman_test.id_taptest_table_p110000_p110000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p120000_p120000'', 20, p_keep_table := false)', ARRAY[0], 'Undo partitioning for parent table partman_test.id_taptest_table_p120000_p120000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p130000_p130000'', 20, p_keep_table := false)', ARRAY[0], 'Undo partitioning for parent table partman_test.id_taptest_table_p130000_p130000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p140000_p140000'', 20, p_keep_table := false)', ARRAY[0], 'Undo partitioning for parent table partman_test.id_taptest_table_p140000_p140000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p150000_p150000'', 20, p_keep_table := false)', ARRAY[0], 'Undo partitioning for parent table partman_test.id_taptest_table_p150000_p150000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p160000_p160000'', 20, p_keep_table := false)', ARRAY[0], 'Undo partitioning for parent table partman_test.id_taptest_table_p160000_p160000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p170000_p170000'', 20, p_keep_table := false)', ARRAY[0], 'Undo partitioning for parent table partman_test.id_taptest_table_p170000_p170000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p180000_p180000'', 20, p_keep_table := false)', ARRAY[0], 'Undo partitioning for parent table partman_test.id_taptest_table_p180000_p180000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p190000_p190000'', 20, p_keep_table := false)', ARRAY[0], 'Undo partitioning for parent table partman_test.id_taptest_table_p190000_p190000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p200000_p200000'', 20, p_keep_table := false)', ARRAY[0], 'Undo partitioning for parent table partman_test.id_taptest_table_p200000_p200000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p210000_p210000'', 20, p_keep_table := false)', ARRAY[0], 'Undo partitioning for parent table partman_test.id_taptest_table_p210000_p210000');
...
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p0'', 20, p_keep_table := false)', ARRAY[9999], 'Undo partitioning for parent table partman_test.id_taptest_table_p0');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p10000'', 20, p_keep_table := false)', ARRAY[10000], 'Undo partitioning for parent table partman_test.id_taptest_table_p10000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p20000'', 20, p_keep_table := false)', ARRAY[10000], 'Undo partitioning for parent table partman_test.id_taptest_table_p20000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p30000'', 20, p_keep_table := false)', ARRAY[10000], 'Undo partitioning for parent table partman_test.id_taptest_table_p30000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p40000'', 20, p_keep_table := false)', ARRAY[10000], 'Undo partitioning for parent table partman_test.id_taptest_table_p40000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p50000'', 20, p_keep_table := false)', ARRAY[10000], 'Undo partitioning for parent table partman_test.id_taptest_table_p50000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p60000'', 20, p_keep_table := false)', ARRAY[10000], 'Undo partitioning for parent table partman_test.id_taptest_table_p60000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p70000'', 20, p_keep_table := false)', ARRAY[10000], 'Undo partitioning for parent table partman_test.id_taptest_table_p70000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p80000'', 20, p_keep_table := false)', ARRAY[10000], 'Undo partitioning for parent table partman_test.id_taptest_table_p80000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p90000'', 20, p_keep_table := false)', ARRAY[10000], 'Undo partitioning for parent table partman_test.id_taptest_table_p90000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p100000'', 20, p_keep_table := false)', ARRAY[7501], 'Undo partitioning for parent table partman_test.id_taptest_table_p100000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p110000'', 20, p_keep_table := false)', ARRAY[0], 'Undo partitioning for parent table partman_test.id_taptest_table_p110000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p120000'', 20, p_keep_table := false)', ARRAY[0], 'Undo partitioning for parent table partman_test.id_taptest_table_p120000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p130000'', 20, p_keep_table := false)', ARRAY[0], 'Undo partitioning for parent table partman_test.id_taptest_table_p130000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p140000'', 20, p_keep_table := false)', ARRAY[0], 'Undo partitioning for parent table partman_test.id_taptest_table_p140000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p150000'', 20, p_keep_table := false)', ARRAY[0], 'Undo partitioning for parent table partman_test.id_taptest_table_p150000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p160000'', 20, p_keep_table := false)', ARRAY[0], 'Undo partitioning for parent table partman_test.id_taptest_table_p160000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p170000'', 20, p_keep_table := false)', ARRAY[0], 'Undo partitioning for parent table partman_test.id_taptest_table_p170000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p180000'', 20, p_keep_table := false)', ARRAY[0], 'Undo partitioning for parent table partman_test.id_taptest_table_p180000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p190000'', 20, p_keep_table := false)', ARRAY[0], 'Undo partitioning for parent table partman_test.id_taptest_table_p190000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p200000'', 20, p_keep_table := false)', ARRAY[0], 'Undo partitioning for parent table partman_test.id_taptest_table_p200000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table_p210000'', 20, p_keep_table := false)', ARRAY[0], 'Undo partitioning for parent table partman_test.id_taptest_table_p210000');
...
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_id(''partman_test.id_taptest_table'', 20, p_keep_table := false)', ARRAY[107500], 'Undo partitioning for final parent table partman_test.id_taptest_table');
