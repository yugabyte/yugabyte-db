...
CREATE TABLE partman_test.time_taptest_table (col1 int, col2 text default 'stuff', col3 timestamptz NOT NULL DEFAULT now()) PARTITION BY RANGE (col3) TABLESPACE mytablespace;
...
CREATE INDEX ON partman_test.time_taptest_table (col1, col2) TABLESPACE mytablespace;
...
INSERT INTO partman_test.time_taptest_table (col1, col2, col3) VALUES (generate_series(200,210), 'stuff'||generate_series(200,210), CURRENT_TIMESTAMP + '20 days'::interval);
