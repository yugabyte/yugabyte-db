...
-- Checks for primary keys have been commented out until native support is added
...
SELECT partman.create_parent('partman_test.id_taptest_table', 'col1', 'native', '10', '{"col3"}', p_jobmon := false);
