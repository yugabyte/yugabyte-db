...
#define __SINGLE_QUOTED_FUNCTION__(PREFIX, x, SUFFIX) __CONCAT_3__(PREFIX, x, SUFFIX)

#define __SINGLE_QUOTED_STRING__(x) __SINGLE_QUOTED_FUNCTION__(__SINGLE_QUOTE_CHAR__, x, __SINGLE_QUOTE_CHAR__)