...
|[Geo-partitioning support](https://github.com/yugabyte/yugabyte-db/issues/9980) for the transaction status table |PROGRESS| v2.13 |[Track](https://github.com/yugabyte/yugabyte-db/issues/9980)|Allows creating multiple transaction status tables|
