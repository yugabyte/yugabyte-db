...
EXTRA_CLEAN = core.c sql/fdw.sql expected/init.out expected/base_plan.out expected/pg_hint_plan.out expected/prepare.out expected/fdw.out expected/ut-A.out expected/ut-A2.out expected/ut-S.out expected/ut-J.out expected/ut-L.out expected/ut-G.out
...
installcheck: expected/init.out expected/base_plan.out expected/pg_hint_plan.out expected/prepare.out expected/ut-A.out expected/ut-A2.out expected/ut-S.out expected/ut-J.out expected/ut-L.out expected/ut-G.out
