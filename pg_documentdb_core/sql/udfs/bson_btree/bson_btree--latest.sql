...
CREATE OR REPLACE FUNCTION bson_in_range_numeric(bson, bson, bson, bool, bool)
 RETURNS bool
 LANGUAGE C
 IMMUTABLE PARALLEL SAFE STRICT
AS 'MODULE_PATHNAME', $function$bson_in_range_numeric$function$;

CREATE OR REPLACE FUNCTION bson_in_range_interval(bson, bson, interval, bool, bool)
 RETURNS bool
 LANGUAGE C
 IMMUTABLE PARALLEL SAFE STRICT
