...
class PerTableLoadState {
 public:
  ...
  Status AddRunningTablet(const TabletId& tablet_id, TabletServerId ts_uuid) {
  ...
  Status RemoveRunningTablet(const TabletId& tablet_id, TabletServerId ts_uuid) {
    SCHECK(per_ts_meta_.find(ts_uuid) != per_ts_meta_.end(), IllegalState,
           Format(uninitialized_ts_meta_format_msg, ts_uuid, table_id_));
  ...
  Status AddStartingTablet(const TabletId& tablet_id, TabletServerId ts_uuid) {
    SCHECK(per_ts_meta_.find(ts_uuid) != per_ts_meta_.end(), IllegalState,
           Format(uninitialized_ts_meta_format_msg, ts_uuid, table_id_));
  ...
  Status AddLeaderTablet(const TabletId& tablet_id, TabletServerId ts_uuid) {
    SCHECK(per_ts_meta_.find(ts_uuid) != per_ts_meta_.end(), IllegalState,
           Format(uninitialized_ts_meta_format_msg, ts_uuid, table_id_));
  ...
  Status RemoveLeaderTablet(const TabletId& tablet_id, TabletServerId ts_uuid) {
    SCHECK(per_ts_meta_.find(ts_uuid) != per_ts_meta_.end(), IllegalState,
           Format(uninitialized_ts_meta_format_msg, ts_uuid, table_id_));
