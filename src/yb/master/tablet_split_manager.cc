...
DEFINE_NON_RUNTIME_int32(process_split_tablet_candidates_interval_msec, 0,
...
DEFINE_NON_RUNTIME_uint64(outstanding_tablet_split_limit, 1,
              "Limit of the number of outstanding tablet splits. Limitation is disabled if this "
              "value is set to 0.");

DEFINE_NON_RUNTIME_uint64(outstanding_tablet_split_limit_per_tserver, 1,
...
DEFINE_NON_RUNTIME_uint64(tablet_split_limit_per_table, 256,
              "Limit of the number of tablets per table for tablet splitting. Limitation is "
              "disabled if this value is set to 0.");

DEFINE_NON_RUNTIME_uint64(prevent_split_for_ttl_tables_for_seconds, 86400,
              "Seconds between checks for whether to split a table with TTL. Checks are disabled "
              "if this value is set to 0.");

DEFINE_NON_RUNTIME_uint64(prevent_split_for_small_key_range_tablets_for_seconds, 300,
...
DEFINE_NON_RUNTIME_bool(sort_automatic_tablet_splitting_candidates, true,
