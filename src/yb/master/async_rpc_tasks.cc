...
DEFINE_NON_RUNTIME_int32(unresponsive_ts_rpc_timeout_ms, 15 * 60 * 1000,  // 15 minutes
...
DEFINE_NON_RUNTIME_int32(unresponsive_ts_rpc_retry_limit, 20,
...
DEFINE_NON_RUNTIME_int32(retrying_ts_rpc_max_delay_ms, 60 * 1000,
