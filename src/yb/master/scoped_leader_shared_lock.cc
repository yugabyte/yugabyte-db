...
DEFINE_NON_RUNTIME_int32(master_log_lock_warning_ms, kMasterLogLockWarningMsDefault,
...
DEFINE_NON_RUNTIME_int32(master_leader_lock_stack_trace_ms, kMasterLeaderLockStackTraceMsDefault,
