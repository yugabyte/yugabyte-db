...
Schema YQLFunctionsVTable::CreateSchema() const {
  ...
  CHECK_OK(builder.AddKeyColumn("argument_types", QLType::CreateTypeFrozen(QLType::CreateTypeList(DataType::STRING))));
  CHECK_OK(builder.AddColumn("argument_names", QLType::CreateTypeFrozen(QLType::CreateTypeList(DataType::STRING))));
