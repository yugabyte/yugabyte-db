...
DEFINE_NON_RUNTIME_int32(tasks_tracker_num_tasks, 100,
             "Number of most recent tasks to track for displaying in utilities UI.");

DEFINE_NON_RUNTIME_int32(tasks_tracker_keep_time_multiplier, 300,
...
DEFINE_NON_RUNTIME_int32(tasks_tracker_num_long_term_tasks, 20,
             "Number of most recent tasks to track for displaying in utilities UI.");

DEFINE_NON_RUNTIME_int32(long_term_tasks_tracker_keep_time_multiplier, 86400,
