...
DEFINE_NON_RUNTIME_bool(notify_peer_of_removal_from_cluster, true,
...
DEFINE_NON_RUNTIME_int32(sys_catalog_write_timeout_ms, 60000,
    "Timeout for writes into system catalog");
DEFINE_NON_RUNTIME_uint64(copy_tables_batch_bytes, 500_KB,
