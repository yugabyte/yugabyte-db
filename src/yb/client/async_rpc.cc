...
DEFINE_NON_RUNTIME_bool(forward_redis_requests, true,
...
DEFINE_NON_RUNTIME_bool(detect_duplicates_for_retryable_requests, true,
            "Enable tracking of write requests that prevents the same write from being applied "
                "twice.");

DEFINE_NON_RUNTIME_bool(ysql_forward_rpcs_to_local_tserver, false,
