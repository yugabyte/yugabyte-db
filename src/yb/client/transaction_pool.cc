...
DEFINE_NON_RUNTIME_int32(transaction_pool_cleanup_interval_ms, 5000,
             "How frequently we should cleanup transaction pool");

DEFINE_NON_RUNTIME_double(transaction_pool_reserve_factor, 2,
...
DEFINE_NON_RUNTIME_bool(force_global_transactions, false,
