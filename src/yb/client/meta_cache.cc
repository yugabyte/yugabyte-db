...
DEFINE_NON_RUNTIME_int32(max_concurrent_master_lookups, 500,
...
DEFINE_NON_RUNTIME_int32(retry_failed_replica_ms, 60 * 1000,
             "Time in milliseconds to wait for before retrying a failed replica");

DEFINE_NON_RUNTIME_int64(meta_cache_lookup_throttling_step_ms, 5,
             "Step to increment delay between calls during lookup throttling.");

DEFINE_NON_RUNTIME_int64(meta_cache_lookup_throttling_max_delay_ms, 1000,
