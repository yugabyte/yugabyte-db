...
class TestFrontiers : public rocksdb::UserFrontiersBase<TestFrontier> {
 public:
...
TEST_P(VectorLSMTest, OpenAfterChunkedCompaction) {
  ...
  ASSERT_OK(OpenVectorLSM(
      lsm, kDimensions, kDefaultChunkSize,
      /* distance_kind = */ vector_index::DistanceKind::kL2Squared, compaction.storage_dir));
