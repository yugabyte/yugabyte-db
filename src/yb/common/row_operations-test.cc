...
class RowOperationsTest : public YBTest {
 public:
  RowOperationsTest()
...
TEST_F(RowOperationsTest, FuzzTest) {
  ...
  YBPartialRow row(&schema_without_ids_);
...
void AddFuzzedColumn(SchemaBuilder* builder,
  ...
  CHECK_OK(builder->AddColumn(name, t, nullable, false, false, false,
...
TEST_F(RowOperationsTest, TestFuzz1) {
  ...
  ASSERT_OK(client_schema_builder.AddColumn("c1", INT32, false, false, false, false,
                                            ColumnSchema::SortingType::kNotSpecified, nullptr,
                                            nullptr));
  ASSERT_OK(client_schema_builder.AddColumn("c2", STRING, false, false, false, false,
                                            ColumnSchema::SortingType::kNotSpecified, nullptr,
                                            nullptr));
  Schema client_schema = client_schema_builder.BuildWithoutIds();
  SchemaBuilder server_schema_builder;
  ASSERT_OK(server_schema_builder.AddColumn("c1", INT32, false, false, false, false,
                                            ColumnSchema::SortingType::kNotSpecified, nullptr,
                                            nullptr));
  ASSERT_OK(server_schema_builder.AddColumn("c2", STRING, false, false, false, false,
                                            ColumnSchema::SortingType::kNotSpecified, nullptr,
                                            nullptr));
...
TEST_F(RowOperationsTest, TestFuzz2) {
  SchemaBuilder client_schema_builder;
  ASSERT_OK(client_schema_builder.AddColumn("c1", STRING, true, false, false, false,
                                            ColumnSchema::SortingType::kNotSpecified, nullptr,
                                            nullptr));
  ASSERT_OK(client_schema_builder.AddColumn("c2", STRING, false, false, false, false,
                                            ColumnSchema::SortingType::kNotSpecified, nullptr,
  ...
  Schema client_schema = client_schema_builder.BuildWithoutIds();
  SchemaBuilder server_schema_builder;
  ASSERT_OK(server_schema_builder.AddColumn("c1", STRING, true, false, false, false,
                                            ColumnSchema::SortingType::kNotSpecified, nullptr,
                                            nullptr));
  ASSERT_OK(server_schema_builder.AddColumn("c2", STRING, false, false, false, false,
                                            ColumnSchema::SortingType::kNotSpecified, nullptr,
...
TEST_F(RowOperationsTest, ProjectionTestWithDefaults) {
  ...
  CHECK_OK(b.AddColumn("nullable_with_default", INT32, true, false, false, false,
                       ColumnSchema::SortingType::kNotSpecified, &nullable_default,
                       &nullable_default));
  CHECK_OK(b.AddColumn("non_null_with_default", INT32, false, false, false, false,
...
TEST_F(RowOperationsTest, ProjectionTestWithClientHavingValidSubset) {
  ...
  CHECK_OK(b.AddColumn("new_int_with_default", INT32, false, false, false, false,
                       ColumnSchema::SortingType::kNotSpecified, &nullable_default,
                       &nullable_default));
...
TEST_F(RowOperationsTest, SplitKeyRoundTrip) {
  ...
  const shared_ptr<YBPartialRow>& row2 = ops[0].split_row;
