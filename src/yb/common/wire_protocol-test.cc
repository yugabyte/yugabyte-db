...
TEST_F(WireProtocolTest, TestColumnDefaultValue) {
  ...
  ColumnSchema col2("col2", STRING, false, false, ColumnSchema::SortingType::kNotSpecified,
                    &read_default_str);
  ...
  ColumnSchema col3("col3", STRING, false, false, ColumnSchema::SortingType::kNotSpecified,
  ...
  ColumnSchema col4("col4", UINT32, false, false, ColumnSchema::SortingType::kNotSpecified,
                    &read_default_u32);
  ...
  ColumnSchema col5("col5", UINT32, false, false, ColumnSchema::SortingType::kNotSpecified,
