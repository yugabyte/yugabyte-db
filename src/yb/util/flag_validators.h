...
//
// This branch does not have delayed validators, so FLAG_DELAYED_* validators are the same as
// non-delayed validators, but the DELAYED macros are kept for ease of backport.
//
