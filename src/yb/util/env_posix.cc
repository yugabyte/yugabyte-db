...
DEFINE_NON_RUNTIME_bool(writable_file_use_fsync, false,
...
DEFINE_NON_RUNTIME_bool(never_fsync, FLAGS_never_fsync_default,
...
DEFINE_NON_RUNTIME_int32(o_direct_block_size_bytes, 4096,
             "Size of the block to use when flag durable_wal_write is set.");
TAG_FLAG(o_direct_block_size_bytes, advanced);

DEFINE_NON_RUNTIME_int32(o_direct_block_alignment_bytes, 4096,
