...
#define YB_DEFINE_ENUM_IMPL_IMPL(enum_name, prefix, list) \
...
#define YB_DEFINE_ENUM_IMPL(enum_name, prefix, list) \
  ...
  YB_DEFINE_ENUM_IMPL_IMPL(enum_name, prefix, list)
...
#define YB_DEFINE_ENUM_TYPE(enum_name, type, list) YB_DEFINE_ENUM_IMPL_TYPE(enum_name, type, BOOST_PP_NIL, list)
