...
//   - "+" is a YQL function, a builtin method.
//   - STRING of type yb::DataType represents the return type of the YQL "+" function.
//   - { STRING, STRING } represents the signature of the YQL "+" function.
...
#ifndef YB_UTIL_BFYQL_DIRECTORY_H_
#define YB_UTIL_BFYQL_DIRECTORY_H_
...
#include "yb/util/bfyql/bfdecl.h"
...
#endif  // YB_UTIL_BFYQL_DIRECTORY_H_
