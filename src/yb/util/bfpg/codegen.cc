 ...
 public:
  ...
  void GenerateOpcodeTable(string build_dir) {
    ...
    fopcode << kFileStart
            ...
            << "#include <unordered_map>" << endl
            << "#include \"yb/util/bfpg/gen_opcodes.h\"" << endl
            << endl
            // Use namespaces.
  ...
  void GenerateOperators(string build_dir) {
    ...
    foper_h << kFileStart
            ...
            << endl
            << "#include \"yb/util/bfpg/base_operator.h\"" << endl
            << "#include \"yb/util/bfpg/bfunc.h\"" << endl
            << endl
            << "#include <vector>" << endl
            << endl
            // Use namespaces.
  ...
  void GenerateOpspecTable(string build_dir) {
    ...
    ftable << kFileStart
           << "#include \"yb/util/bfpg/base_operator.h\"" << endl
           << "#include \"yb/util/bfpg/gen_operator.h\"" << endl
           << endl
           << "#include <iostream>" << endl
           << "#include <vector>" << endl
