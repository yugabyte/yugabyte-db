...
DEFINE_NON_RUNTIME_int32(memory_limit_warn_threshold_percentage, 98,
             "Percentage of the hard memory limit that this daemon may "
...
DEFINE_NON_RUNTIME_int64(tserver_tcmalloc_max_total_thread_cache_bytes, -1,
    "Total number of bytes to "
...
#ifdef TCMALLOC_ENABLED
DEFINE_NON_RUNTIME_int32(tcmalloc_max_free_bytes_percentage, 10,
...
DEFINE_NON_RUNTIME_int64(mem_tracker_update_consumption_interval_us, 2000000,
