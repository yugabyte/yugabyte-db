...
DEFINE_NON_RUNTIME_bool(enable_log_cache_gc, true,
            "Set to true to enable log cache garbage collector.");

DEFINE_NON_RUNTIME_bool(log_cache_gc_evict_only_over_allocated, true,
            ...
            "of bytes.");
DEFINE_NON_RUNTIME_int64(global_memstore_size_percentage, 10,
...
DEFINE_NON_RUNTIME_int64(global_memstore_size_mb_max, 2048,
...
DEFINE_NON_RUNTIME_bool(enable_block_based_table_cache_gc, false,
            "Set to true to enable block based table garbage collector.");

DEFINE_NON_RUNTIME_int64(db_block_cache_size_bytes, kDbCacheSizeUsePercentage,
...
DEFINE_NON_RUNTIME_int32(db_block_cache_size_percentage, kDbCacheSizeUseDefault,
...
DEFINE_NON_RUNTIME_int32(db_block_cache_num_shard_bits, 4,
