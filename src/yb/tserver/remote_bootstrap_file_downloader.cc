...
DEFINE_NON_RUNTIME_int32(remote_bootstrap_max_chunk_size, 64_MB,
...
DEFINE_NON_RUNTIME_int64(remote_bootstrap_rate_limit_bytes_per_sec, 256_MB,
...
DEFINE_NON_RUNTIME_int32(bytes_remote_bootstrap_durable_write_mb, 1024,
