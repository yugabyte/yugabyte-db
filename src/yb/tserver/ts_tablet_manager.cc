...
DEFINE_NON_RUNTIME_int32(tablet_start_warn_threshold_ms, 500,
...
DEFINE_NON_RUNTIME_int32(send_wait_for_report_interval_ms, 60000,
             "The tick interval time to trigger updating all transaction coordinators with wait-for"
             " relationships.");

DEFINE_NON_RUNTIME_bool(skip_tablet_data_verification, false,
            "Skip checking tablet data for corruption.");

DEFINE_NON_RUNTIME_int32(read_pool_max_threads, 128,
             ...
             "in parallel.");
DEFINE_NON_RUNTIME_int32(read_pool_max_queue_size, 128,
...
DEFINE_NON_RUNTIME_int32(post_split_trigger_compaction_pool_max_threads, 1,
             "DEPRECATED. Use full_compaction_pool_max_threads.");
DEFINE_NON_RUNTIME_int32(post_split_trigger_compaction_pool_max_queue_size, 16,
...
DEFINE_NON_RUNTIME_bool(enable_restart_transaction_status_tablets_first, true,
