...
DEFINE_NON_RUNTIME_int32(tserver_heartbeat_metrics_interval_ms, 5000,
             "Interval (in milliseconds) at which tserver sends its metrics in a heartbeat to "
             "master.");

DEFINE_NON_RUNTIME_bool(tserver_heartbeat_metrics_add_drive_data, true,
            "Add drive data to metrics which tserver sends to master");

DEFINE_NON_RUNTIME_bool(tserver_heartbeat_metrics_add_replication_status, true,
