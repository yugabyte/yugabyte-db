...
DEFINE_NON_RUNTIME_int32(metrics_snapshotter_interval_ms, 30 * 1000,
             "Interval at which the metrics are snapshotted.");
TAG_FLAG(metrics_snapshotter_interval_ms, advanced);

DEFINE_NON_RUNTIME_string(metrics_snapshotter_tserver_metrics_whitelist,
...
DEFINE_NON_RUNTIME_string(metrics_snapshotter_table_metrics_whitelist,
...
DEFINE_NON_RUNTIME_int32(tserver_metrics_snapshotter_yb_client_default_timeout_ms,
...
DEFINE_NON_RUNTIME_uint64(metrics_snapshotter_ttl_ms, 7 * 24 * 60 * 60 * 1000 /* 1 week */,
