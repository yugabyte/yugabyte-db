...
DEFINE_NON_RUNTIME_bool(durable_wal_write, false,
            "Whether the Log/WAL should explicitly call fsync() after each write.");
TAG_FLAG(durable_wal_write, stable);

DEFINE_NON_RUNTIME_int32(interval_durable_wal_write_ms, 1000,
