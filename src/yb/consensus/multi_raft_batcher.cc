...
DEFINE_NON_RUNTIME_bool(enable_multi_raft_heartbeat_batcher, false,
            "If true, enables multi-Raft batching of raft heartbeats.");

DEFINE_NON_RUNTIME_uint64(multi_raft_heartbeat_interval_ms, 50,
              "The heartbeat interval for batch Raft replication.");
TAG_FLAG(multi_raft_heartbeat_interval_ms, advanced);

DEFINE_NON_RUNTIME_uint64(multi_raft_batch_size, 0,
