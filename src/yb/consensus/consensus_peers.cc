...
DEFINE_int32(consensus_stuck_peer_call_threshold_ms, 10000,
...
TAG_FLAG(consensus_stuck_peer_call_threshold_ms, runtime);

DEFINE_bool(consensus_force_recover_from_stuck_peer_call, false,
...
TAG_FLAG(consensus_force_recover_from_stuck_peer_call, runtime);
