...
DEFINE_NON_RUNTIME_double(leader_failure_max_missed_heartbeat_periods, 6.0,
...
DEFINE_NON_RUNTIME_int32(leader_failure_exp_backoff_max_delta_ms, 20 * 1000,
...
DEFINE_NON_RUNTIME_bool(enable_leader_failure_detection, true,
...
DEFINE_NON_RUNTIME_bool(evict_failed_followers, true,
...
DEFINE_NON_RUNTIME_int32(after_stepdown_delay_election_multiplier, 5,
...
DEFINE_NON_RUNTIME_int32(ht_lease_duration_ms, 2000,
...
DEFINE_NON_RUNTIME_int32(min_leader_stepdown_retry_interval_ms,
             20 * 1000,
...
DEFINE_NON_RUNTIME_bool(use_preelection, true,
    "Whether to use pre election, before doing actual election.");

DEFINE_NON_RUNTIME_int32(temporary_disable_preelections_timeout_ms, 10 * 60 * 1000,
...
DEFINE_NON_RUNTIME_bool(enable_lease_revocation, false, "Enables lease revocation mechanism");

DEFINE_NON_RUNTIME_bool(quick_leader_election_on_create, false,
...
DEFINE_NON_RUNTIME_int64(protege_synchronization_timeout_ms, 1000,
