...
DEFINE_NON_RUNTIME_int32(follower_unavailable_considered_failed_sec, 900,
...
DEFINE_NON_RUNTIME_int32(consensus_inject_latency_ms_in_notifications, 0,
...
DEFINE_NON_RUNTIME_int32(cdc_checkpoint_opid_interval_ms, 60 * 1000,
