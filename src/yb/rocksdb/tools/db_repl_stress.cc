...
DEFINE_NON_RUNTIME_uint64(num_inserts, 1000, "the num of inserts the first thread should"
    " perform.");
DEFINE_NON_RUNTIME_uint64(wal_ttl_seconds, 1000, "the wal ttl for the run(in seconds)");
DEFINE_NON_RUNTIME_uint64(wal_size_limit_MB, 10, "the wal size limit for the run"
    "(in MB)");
