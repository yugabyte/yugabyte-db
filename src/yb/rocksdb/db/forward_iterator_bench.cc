...
DEFINE_NON_RUNTIME_int32(writers, 8, "");
DEFINE_NON_RUNTIME_int32(readers, 8, "");
DEFINE_NON_RUNTIME_int64(rate, 100000, "");
DEFINE_NON_RUNTIME_int64(value_size, 300, "");
DEFINE_NON_RUNTIME_int64(shards, 1000, "");
DEFINE_NON_RUNTIME_int64(memtable_size, 500000000, "");
DEFINE_NON_RUNTIME_int64(block_cache_size, 300000000, "");
DEFINE_NON_RUNTIME_int64(block_size, 65536, "");
DEFINE_NON_RUNTIME_double(runtime, 300.0, "");
DEFINE_NON_RUNTIME_bool(cache_only_first, true, "");
DEFINE_NON_RUNTIME_bool(iterate_upper_bound, true, "");
