...
DEFINE_NON_RUNTIME_string(benchmarks, "fillrandom",
...
DEFINE_NON_RUNTIME_string(memtablerep, "skiplist",
...
DEFINE_NON_RUNTIME_int64(bucket_count, 1000000,
...
DEFINE_NON_RUNTIME_int32(bucket_entries_logging_threshold, 4096,
             "bucket_entries_logging_threshold parameter to pass into "
             "NewHashLinkListRepFactory");

DEFINE_NON_RUNTIME_bool(if_log_bucket_dist_when_flash, true,
...
DEFINE_NON_RUNTIME_int32(num_operations, 1000000,
             "Number of operations to do for write and random read benchmarks");

DEFINE_NON_RUNTIME_int32(num_scans, 10,
             "Number of times for each thread to scan the memtablerep for "
             "sequential read "
             "benchmarks");

DEFINE_NON_RUNTIME_int32(item_size, 100, "Number of bytes each item should be");

DEFINE_NON_RUNTIME_int32(prefix_length, 8,
             "Prefix length to pass into NewFixedPrefixTransform");

/* VectorRep settings */
DEFINE_NON_RUNTIME_int64(vectorrep_count, 0,
             "Number of entries to reserve on VectorRep initialization");

DEFINE_NON_RUNTIME_int64(seed, 0,
