...
DEFINE_NON_RUNTIME_int32(rocksdb_nothing_in_memtable_to_flush_sleep_ms, 10,
...
DEFINE_NON_RUNTIME_bool(rocksdb_release_mutex_during_wait_for_memtables_to_flush, true,
