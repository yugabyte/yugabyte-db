...
static std::unordered_map<std::string, OptionTypeInfo> db_options_type_info = {
    ...
    {"num_reserved_small_compaction_threads",
     {offsetof(struct DBOptions, num_reserved_small_compaction_threads), OptionType::kInt,
      OptionVerificationType::kNormal}},
    {"compaction_size_threshold_bytes",
     {offsetof(struct DBOptions, compaction_size_threshold_bytes), OptionType::kUInt64T,
      OptionVerificationType::kNormal}},
    ...
    {"allow_concurrent_memtable_write",
     {offsetof(struct DBOptions, allow_concurrent_memtable_write),
      OptionType::kBoolean, OptionVerificationType::kNormal}},
    {"in_memory_erase",
     {offsetof(struct DBOptions, in_memory_erase),
      OptionType::kBoolean, OptionVerificationType::kNormal}},
    {"wal_recovery_mode",
...
static std::unordered_map<std::string,
    ...
    {"block_size",
     {offsetof(struct BlockBasedTableOptions, block_size), OptionType::kSizeT,
      OptionVerificationType::kNormal}},
    {"filter_block_size",
     {offsetof(struct BlockBasedTableOptions, filter_block_size), OptionType::kSizeT,
      OptionVerificationType::kNormal}},
