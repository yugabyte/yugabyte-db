...
DEFINE_NON_RUNTIME_int32(threads, 16, "Number of concurrent threads to run.");
DEFINE_NON_RUNTIME_int64(cache_size, 8 * KB * KB,
             "Number of bytes to use as a cache of uncompressed data.");
DEFINE_NON_RUNTIME_int32(num_shard_bits, 4, "shard_bits.");

DEFINE_NON_RUNTIME_int64(max_key, 1 * KB * KB * KB, "Max number of key to place in cache");
DEFINE_NON_RUNTIME_uint64(ops_per_thread, 1200000, "Number of operations per thread.");

DEFINE_NON_RUNTIME_bool(populate_cache, false, "Populate cache before operations");
DEFINE_NON_RUNTIME_int32(insert_percent, 40,
             "Ratio of insert to total workload (expressed as a percentage)");
DEFINE_NON_RUNTIME_int32(lookup_percent, 50,
             "Ratio of lookup to total workload (expressed as a percentage)");
DEFINE_NON_RUNTIME_int32(erase_percent, 10,
