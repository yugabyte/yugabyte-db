...
void DocRowwiseIteratorTest::TestClusteredFilterDiscreteScan() {
...
void DocRowwiseIteratorTest::TestClusteredFilterRangeScan() {
  FLAGS_disable_hybrid_scan = true;
  InsertPopulationData();
  auto doc_read_context = DocReadContext::TEST_Create(population_schema);
...
void DocRowwiseIteratorTest::TestSimpleRangeScan() {
  FLAGS_disable_hybrid_scan = true;
  InsertPopulationData();
  auto doc_read_context = DocReadContext::TEST_Create(population_schema);
...
void DocRowwiseIteratorTest::TestLargeKeys() {
  ...
  QLTableRow row;
  QLValue value;
  DocReadContext doc_read_context = DocReadContext::TEST_Create(schema);
...
TEST_F(DocRowwiseIteratorTest, ClusteredFilterDiscreteScanTest) {
    TestClusteredFilterDiscreteScan();
}

TEST_F(DocRowwiseIteratorTest, ClusteredFilterRangeScanTest) {
    TestClusteredFilterRangeScan();
}
