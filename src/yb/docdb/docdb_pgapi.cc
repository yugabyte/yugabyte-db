...
Status SetValueFromQLBinaryHelper(
  ...
  switch (pg_data_type) {
    ...
    case ABSTIMEARRAYOID: {
      ...
      set_array_string_value(ql_value, arg_type, ABSTIMEOID, func_name, datum_message);
      break;
    }

    case RELTIMEARRAYOID: {
      func_name = "reltimeout";
      set_array_string_value(ql_value, arg_type, RELTIMEOID, func_name, datum_message);
      break;
    }

    case TINTERVALARRAYOID: {
      func_name = "tintervalout";
      set_array_string_value(ql_value, arg_type, TINTERVALOID, func_name, datum_message);
      break;
    }
