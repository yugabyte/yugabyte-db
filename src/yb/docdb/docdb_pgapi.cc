...
void set_decoded_string_value(QLValuePB* decoded_ql_value,
                              uint64_t datum,
                              const char* func_name,
                              const bool is_proto_record,
  ...
  if (!is_proto_record) {
    decoded_ql_value->set_string_value(decoded_str, strlen(decoded_str));
  } else {
    if (cdc_datum_message != nullptr)
      cdc_datum_message->set_datum_string(decoded_str, strlen(decoded_str));
  }

}

void set_decoded_string_range(const QLValuePB ql_value,
  ...
  if (func_name != nullptr) {
    decoded_str = DecodeRangeDatum("range_out", (uintptr_t) datum,
                                  elmlen, elmbyval, elmalign, option, from_YB,
                                  func_name, arg_type->type_oid, timezone);
...
void set_decoded_string_array(const QLValuePB ql_value,
  ...
  if (func_name != nullptr) {
    decoded_str = DecodeArrayDatum("array_out", (uintptr_t) datum,
                                  elmlen, elmbyval, elmalign, elmdelim, from_YB,
                                  func_name, timezone, option);
...
void set_decoded_string_range_array(const QLValuePB ql_value,
                                    const YBCPgTypeEntity *arg_type,
                                    const int elem_type,
                                    const char* func_name,
                                    QLValuePB* decoded_ql_value,
  ...
  if (func_name != nullptr) {
    decoded_str = DecodeRangeArrayDatum("array_out", (uintptr_t)datum,
                                  elmlen, range_elmlen, elmbyval, range_elmbyval, elmalign,
                                  range_elmalign, elmdelim, option, range_option, from_YB,
                                  "range_out", func_name, elem_type, timezone);
...
void set_string_value(bool is_proto_record,
                      QLValuePB *decoded_ql_value,
                      uint64_t datum,
                      char const *func_name,
                      DatumMessagePB *cdc_datum_message) {
  if (!is_proto_record) {
    set_decoded_string_value(decoded_ql_value, datum, func_name, is_proto_record);
  } else {
    if (cdc_datum_message != nullptr)
      set_decoded_string_value(decoded_ql_value, datum, func_name,
                               is_proto_record, cdc_datum_message);
  }
}

void set_range_string_value(bool is_proto_record,
  ...
  if (!is_proto_record) {
    set_decoded_string_range(
      ql_value, arg_type, type_oid, func_name, decoded_ql_value, is_proto_record);
  } else {
    if (cdc_datum_message != nullptr)
      set_decoded_string_range(ql_value, arg_type, type_oid,
                               func_name, decoded_ql_value,
                               is_proto_record, cdc_datum_message);
  }
}

void set_array_string_value(bool is_proto_record,
                            const QLValuePB ql_value,
                            const YBCPgTypeEntity *arg_type,
                            const int type_oid,
                            QLValuePB *decoded_ql_value,
  ...
  if (!is_proto_record) {
    ...
    if (cdc_datum_message != nullptr)
      set_decoded_string_array(ql_value, arg_type, type_oid,
                               func_name, decoded_ql_value,
                               is_proto_record, cdc_datum_message);
  }
}

void set_range_array_string_value(bool is_proto_record,
                                  const QLValuePB ql_value,
                                  const YBCPgTypeEntity *arg_type,
                                  const int type_oid,
                                  QLValuePB *decoded_ql_value,
  ...
  if (!is_proto_record) {
    ...
    if (cdc_datum_message != nullptr)
      set_decoded_string_range_array(ql_value, arg_type, type_oid,
                                     func_name, decoded_ql_value,
                                     is_proto_record, cdc_datum_message);
  }
}
  ...
  switch (arg_type->type_oid) {
    case BOOLOID: {
      ...
      if (is_proto_record) {
        ...
        uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<bool *>(&bool_val),
                                               size, &type_attrs);
        set_decoded_string_value(decoded_ql_value, datum, func_name, is_proto_record);
      }
      break;
    ...
    case BYTEAOID: {
      ...
      set_string_value(is_proto_record, decoded_ql_value, datum, func_name, cdc_datum_message);
      break;
    }
    case CHAROID: {
      func_name = "charout";
      ...
      size = sizeof(int);
      uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<char *>(&char_val),
                                             size, &type_attrs);
      set_string_value(is_proto_record, decoded_ql_value, datum, func_name, cdc_datum_message);
      break;
    }
    ...
    case INT8OID: {
      ...
      if (!is_proto_record) {
        size = arg_type->datum_fixed_size;
        uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<int64 *>(&int8_val),
                                               size, &type_attrs);
        set_decoded_string_value(decoded_ql_value, datum, func_name, is_proto_record);
      }
      break;
    ...
    case INT2OID: {
      ...
      if (!is_proto_record) {
        size = arg_type->datum_fixed_size;
        uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<int16 *>(&int2_val),
                                               size, &type_attrs);
        set_decoded_string_value(decoded_ql_value, datum, func_name, is_proto_record);
      }
      break;
    ...
    case INT4OID: {
      ...
      if (!is_proto_record) {
        size = arg_type->datum_fixed_size;
        uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<int32 *>(&int4_val),
                                               size, &type_attrs);
        set_decoded_string_value(decoded_ql_value, datum, func_name, is_proto_record);
      }
      break;
    ...
    case REGPROCOID: {
      ...
      size = arg_type->datum_fixed_size;
      uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<uint32 *>(&regproc_val),
                                             size, &type_attrs);
      set_string_value(is_proto_record, decoded_ql_value, datum, func_name, cdc_datum_message);
      break;
    }
    ...
    case OIDOID: {
      ...
      if (!is_proto_record) {
        size = arg_type->datum_fixed_size;
        uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<uint32 *>(&oid_val),
                                               size, &type_attrs);
        set_decoded_string_value(decoded_ql_value, datum, func_name, is_proto_record);
      }
      break;
    ...
    case XIDOID: {
      ...
      size = arg_type->datum_fixed_size;
      uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<uint32 *>(&xid_val),
                                             size, &type_attrs);
      set_string_value(is_proto_record, decoded_ql_value, datum, func_name, cdc_datum_message);
      break;
    }
    case CIDOID: {
      ...
      size = arg_type->datum_fixed_size;
      uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<uint32 *>(&cid_val),
                                             size, &type_attrs);
      set_string_value(is_proto_record, decoded_ql_value, datum, func_name, cdc_datum_message);
      break;
    }
    ...
    case PGDDLCOMMANDOID: {
      ...
      size = arg_type->datum_fixed_size;
      uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<int64 *>(&pg_ddl_command_val),
                                             size, &type_attrs);
      set_string_value(is_proto_record, decoded_ql_value, datum, func_name, cdc_datum_message);
      break;
    }
    case SMGROID: {
      ...
      size = arg_type->datum_fixed_size;
      uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<int16 *>(&smgr_val),
                                             size, &type_attrs);
      set_string_value(is_proto_record, decoded_ql_value, datum, func_name, cdc_datum_message);
      break;
    }
    ...
    case FLOAT4OID: {
      ...
      if (!is_proto_record) {
        size = arg_type->datum_fixed_size;
        uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<float *>(&float4_val),
                                               size, &type_attrs);
        set_decoded_string_value(decoded_ql_value, datum, func_name, is_proto_record);
      }
      break;
    ...
    case FLOAT8OID: {
      ...
      if (!is_proto_record) {
        size = arg_type->datum_fixed_size;
        uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<double *>(&float8_val),
                                               size, &type_attrs);
        set_decoded_string_value(decoded_ql_value, datum, func_name, is_proto_record);
      }
      break;
    ...
    case CASHOID: {
      ...
      uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<int64 *>(&cash_val),
                                             size, &type_attrs);
      set_string_value(is_proto_record, decoded_ql_value, datum, func_name, cdc_datum_message);
      break;
    }
    ...
    case DATEOID: {
      ...
      size = arg_type->datum_fixed_size;
      uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<int32 *>(&date_val),
                                             size, &type_attrs);
      set_string_value(is_proto_record, decoded_ql_value, datum, func_name, cdc_datum_message);
      break;
    }
    case TIMEOID: {
      ...
      size = arg_type->datum_fixed_size;
      uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<int64 *>(&time_val),
                                             size, &type_attrs);
      set_string_value(is_proto_record, decoded_ql_value, datum, func_name, cdc_datum_message);
      break;
    }
    case TIMESTAMPOID: {
      ...
      size = arg_type->datum_fixed_size;
      uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<int64 *>(&timestamp_val),
                                             size, &type_attrs);
      set_string_value(is_proto_record, decoded_ql_value, datum, func_name, cdc_datum_message);
      break;
    }
    case TIMESTAMPTZOID: {
      ...
      size = arg_type->datum_fixed_size;
      uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<int64 *>(&timestamptz_val),
                                             size, &type_attrs);

      if (!is_proto_record) {
        set_decoded_string_value(decoded_ql_value, datum, func_name,
                                 is_proto_record, nullptr, timezone);
      } else {
        if (cdc_datum_message != nullptr)
          set_decoded_string_value(decoded_ql_value, datum, func_name,
                                   is_proto_record, cdc_datum_message, timezone);
      }
      break;
    }
    case INTERVALOID: {
    ...
    case NUMERICOID: {
      ...
      if (!is_proto_record) {
        size = numeric_val.size();
        val = const_cast<char *>(numeric_val.c_str());
        uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<char *>(val), size, &type_attrs);
        set_decoded_string_value(decoded_ql_value, datum, func_name, is_proto_record);
      }
      break;
    ...
    case REGPROCEDUREOID: {
      ...
      size = arg_type->datum_fixed_size;
      uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<uint32 *>(&regprocedure_val),
                                             size, &type_attrs);
      set_string_value(is_proto_record, decoded_ql_value, datum, func_name, cdc_datum_message);
      break;
    }
    case REGOPEROID: {
      ...
      size = arg_type->datum_fixed_size;
      uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<uint32 *>(&regoper_val),
                                             size, &type_attrs);
      set_string_value(is_proto_record, decoded_ql_value, datum, func_name, cdc_datum_message);
      break;
    }
    case REGOPERATOROID: {
      ...
      size = arg_type->datum_fixed_size;
      uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<uint32 *>(&regoperator_val),
                                             size, &type_attrs);
      set_string_value(is_proto_record, decoded_ql_value, datum, func_name, cdc_datum_message);
      break;
    }
    case REGCLASSOID: {
      ...
      size = arg_type->datum_fixed_size;
      uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<uint32 *>(&regclass_val),
                                             size, &type_attrs);
      set_string_value(is_proto_record, decoded_ql_value, datum, func_name, cdc_datum_message);
      break;
    }
    case REGTYPEOID: {
      ...
      size = arg_type->datum_fixed_size;
      uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<uint32 *>(&regtype_val),
                                             size, &type_attrs);
      set_string_value(is_proto_record, decoded_ql_value, datum, func_name, cdc_datum_message);
      break;
    }
    case REGROLEOID: {
      ...
      size = arg_type->datum_fixed_size;
      uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<uint32 *>(&regrole_val),
                                             size, &type_attrs);
      set_string_value(is_proto_record, decoded_ql_value, datum, func_name, cdc_datum_message);
      break;
    }
    case REGNAMESPACEOID: {
      ...
      size = arg_type->datum_fixed_size;
      uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<uint32 *>(&regnamespace_val),
                                             size, &type_attrs);
      set_string_value(is_proto_record, decoded_ql_value, datum, func_name, cdc_datum_message);
      break;
    }
    case UUIDOID: {
      ...
      uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<unsigned char *>(val),
                                             size, &type_attrs);
      set_string_value(is_proto_record, decoded_ql_value, datum, func_name, cdc_datum_message);
      break;
    }
    case LSNOID: {
      ...
      size = arg_type->datum_fixed_size;
      uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<uint64 *>(&pg_lsn_val),
                                             size, &type_attrs);
      set_string_value(is_proto_record, decoded_ql_value, datum, func_name, cdc_datum_message);
      break;
    }
    ...
    case REGCONFIGOID: {
      ...
      size = arg_type->datum_fixed_size;
      uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<uint32 *>(&regconfig_val),
                                             size, &type_attrs);
      set_string_value(is_proto_record, decoded_ql_value, datum, func_name, cdc_datum_message);
      break;
    }
    case REGDICTIONARYOID: {
      ...
      size = arg_type->datum_fixed_size;
      uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<uint32 *>(&regdictionary_val),
                                             size, &type_attrs);
      set_string_value(is_proto_record, decoded_ql_value, datum, func_name, cdc_datum_message);
      break;
    }
    ...
    case RECORDOID: {
      ...
      if (!is_proto_record) {
        decoded_ql_value->set_string_value("");
      } else {
        if (cdc_datum_message != nullptr)
    ...
    case ANYOID: {
      ...
      size = arg_type->datum_fixed_size;
      uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<int32 *>(&any_val),
                                             size, &type_attrs);
      set_string_value(is_proto_record, decoded_ql_value, datum, func_name, cdc_datum_message);
      break;
    }
    case VOIDOID: {
      ...
      size = arg_type->datum_fixed_size;
      uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<int64 *>(&void_val),
                                             size, &type_attrs);
      set_string_value(is_proto_record, decoded_ql_value, datum, func_name, cdc_datum_message);
      break;
    }
    case TRIGGEROID: {
      ...
      size = arg_type->datum_fixed_size;
      uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<uint32 *>(&trigger_val),
                                             size, &type_attrs);
      set_string_value(is_proto_record, decoded_ql_value, datum, func_name, cdc_datum_message);
      break;
    }
    case EVTTRIGGEROID: {
      ...
      size = arg_type->datum_fixed_size;
      uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<uint32 *>(&event_trigger_val),
                                             size, &type_attrs);
      set_string_value(is_proto_record, decoded_ql_value, datum, func_name, cdc_datum_message);
      break;
    }
    case LANGUAGE_HANDLEROID: {
      ...
      size = arg_type->datum_fixed_size;
      uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<uint32 *>(&language_handler_val),
                                             size, &type_attrs);
      set_string_value(is_proto_record, decoded_ql_value, datum, func_name, cdc_datum_message);
      break;
    }
    case INTERNALOID: {
      ...
      size = arg_type->datum_fixed_size;
      uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<int64 *>(&internal_val),
                                             size, &type_attrs);
      set_string_value(is_proto_record, decoded_ql_value, datum, func_name, cdc_datum_message);
      break;
    }
    case OPAQUEOID: {
      ...
      size = arg_type->datum_fixed_size;
      uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<int32 *>(&opaque_val),
                                             size, &type_attrs);
      set_string_value(is_proto_record, decoded_ql_value, datum, func_name, cdc_datum_message);
      break;
    }
    case ANYELEMENTOID: {
      ...
      size = arg_type->datum_fixed_size;
      uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<int32 *>(&anyelement_val),
                                             size, &type_attrs);
      set_string_value(is_proto_record, decoded_ql_value, datum, func_name, cdc_datum_message);
      break;
    }
    case ANYNONARRAYOID: {
      ...
      size = arg_type->datum_fixed_size;
      uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<int32 *>(&anynonarray_val),
                                             size, &type_attrs);
      set_string_value(is_proto_record, decoded_ql_value, datum, func_name, cdc_datum_message);
      break;
    }
    case ANYENUMOID: {
      ...
      size = arg_type->datum_fixed_size;
      uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<int64 *>(&anyenum_val),
                                             size, &type_attrs);
      set_string_value(is_proto_record, decoded_ql_value, datum, func_name, cdc_datum_message);
      break;
    }
    case FDW_HANDLEROID: {
      ...
      size = arg_type->datum_fixed_size;
      uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<uint32 *>(&fdw_handler_val),
                                             size, &type_attrs);
      set_string_value(is_proto_record, decoded_ql_value, datum, func_name, cdc_datum_message);
      break;
    }
    case INDEX_AM_HANDLEROID: {
      ...
      size = arg_type->datum_fixed_size;
      uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<uint32 *>(&index_am_handler_val),
                                             size, &type_attrs);
      set_string_value(is_proto_record, decoded_ql_value, datum, func_name, cdc_datum_message);
      break;
    }
    case TSM_HANDLEROID: {
      ...
      size = arg_type->datum_fixed_size;
      uint64_t datum = arg_type->yb_to_datum(reinterpret_cast<uint32 *>(&tsm_handler_val),
                                             size, &type_attrs);
      set_string_value(is_proto_record, decoded_ql_value, datum, func_name, cdc_datum_message);
      break;
    }
    ...
    case INT4RANGEOID: {
      func_name = "int4out";
      set_range_string_value(is_proto_record, ql_value, arg_type, INT4OID,
                             decoded_ql_value, func_name, cdc_datum_message);
      break;
    }

    case NUMRANGEOID: {
      func_name = "numeric_out";
      set_range_string_value(is_proto_record, ql_value, arg_type, NUMERICOID,
                             decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case TSRANGEOID: {
      func_name = "timestamp_out";
      set_range_string_value(is_proto_record, ql_value, arg_type, TIMESTAMPOID,
                             decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case TSTZRANGEOID: {
      ...
      if (!is_proto_record) {
        set_decoded_string_range(
            ql_value, arg_type, TIMESTAMPTZOID, func_name, decoded_ql_value, is_proto_record,
            nullptr, timezone);
      } else {
        if (cdc_datum_message != nullptr)
          set_decoded_string_range(ql_value, arg_type, TIMESTAMPTZOID,
                                   func_name, decoded_ql_value,
                                   is_proto_record, cdc_datum_message, timezone);
      }
      break;
    ...
    case DATERANGEOID: {
      func_name = "date_out";
      set_range_string_value(is_proto_record, ql_value, arg_type, DATEOID,
                             decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case INT8RANGEOID: {
      func_name = "int8out";
      set_range_string_value(is_proto_record, ql_value, arg_type, INT8OID,
                             decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case XMLARRAYOID: {
      func_name = "xml_out";
      set_array_string_value (is_proto_record, ql_value, arg_type, XMLOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case LINEARRAYOID: {
      func_name = "line_out";
      set_array_string_value (is_proto_record, ql_value, arg_type, LINEOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case CIRCLEARRAYOID: {
      func_name = "circle_out";
      set_array_string_value (is_proto_record, ql_value, arg_type, CIRCLEOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case MONEYARRAYOID: {
      func_name = "cash_out";
      set_array_string_value (is_proto_record, ql_value, arg_type, CASHOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case BOOLARRAYOID: {
      func_name = "boolout";
      set_array_string_value (is_proto_record, ql_value, arg_type, BOOLOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case BYTEAARRAYOID: {
      func_name = "byteaout";
      set_array_string_value (is_proto_record, ql_value, arg_type, BYTEAOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case CHARARRAYOID: {
      func_name = "charout";
      set_array_string_value (is_proto_record, ql_value, arg_type, CHAROID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case NAMEARRAYOID: {
      func_name = "nameout";
      set_array_string_value (is_proto_record, ql_value, arg_type, NAMEOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case INT2ARRAYOID: {
      func_name = "int2out";
      set_array_string_value (is_proto_record, ql_value, arg_type, INT2OID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case INT2VECTORARRAYOID: {
      func_name = "int2vectorout";
      set_array_string_value (is_proto_record, ql_value, arg_type, INT2VECTOROID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case INT4ARRAYOID: {
      func_name = "int4out";
      set_array_string_value (is_proto_record, ql_value, arg_type, INT4OID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case REGPROCARRAYOID: {
      func_name = "regprocout";
      set_array_string_value (is_proto_record, ql_value, arg_type, REGPROCOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case TEXTARRAYOID: {
      func_name = "textout";
      set_array_string_value (is_proto_record, ql_value, arg_type, TEXTOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case OIDARRAYOID: {
      func_name = "oidout";
      set_array_string_value (is_proto_record, ql_value, arg_type, OIDOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case CIDRARRAYOID: {
      func_name = "cidr_out";
      set_array_string_value (is_proto_record, ql_value, arg_type, CIDROID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case TIDARRAYOID: {
      func_name = "tidout";
      set_array_string_value (is_proto_record, ql_value, arg_type, TIDOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case XIDARRAYOID: {
      func_name = "xidout";
      set_array_string_value (is_proto_record, ql_value, arg_type, XIDOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case CIDARRAYOID: {
      func_name = "cidout";
      set_array_string_value (is_proto_record, ql_value, arg_type, CIDOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case OIDVECTORARRAYOID: {
      func_name = "oidvectorout";
      set_array_string_value (is_proto_record, ql_value, arg_type, OIDVECTOROID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case BPCHARARRAYOID: {
      func_name = "bpcharout";
      set_array_string_value (is_proto_record, ql_value, arg_type, BPCHAROID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case VARCHARARRAYOID: {
      func_name = "varcharout";
      set_array_string_value (is_proto_record, ql_value, arg_type, VARCHAROID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case INT8ARRAYOID: {
      func_name = "int8out";
      set_array_string_value (is_proto_record, ql_value, arg_type, INT8OID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case POINTARRAYOID: {
      func_name = "point_out";
      set_array_string_value (is_proto_record, ql_value, arg_type, POINTOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case LSEGARRAYOID: {
      func_name = "lseg_out";
      set_array_string_value (is_proto_record, ql_value, arg_type, LSEGOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case PATHARRAYOID: {
      func_name = "path_out";
      set_array_string_value (is_proto_record, ql_value, arg_type, PATHOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case BOXARRAYOID: {
      func_name = "box_out";
      set_array_string_value (is_proto_record, ql_value, arg_type, BOXOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case FLOAT4ARRAYOID: {
      func_name = "float4out";
      set_array_string_value (is_proto_record, ql_value, arg_type, FLOAT4OID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case FLOAT8ARRAYOID: {
      func_name = "float8out";
      set_array_string_value (is_proto_record, ql_value, arg_type, FLOAT8OID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case ABSTIMEARRAYOID: {
      ...
      set_array_string_value (is_proto_record, ql_value, arg_type, ABSTIMEOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case RELTIMEARRAYOID: {
      ...
      set_array_string_value (is_proto_record, ql_value, arg_type, RELTIMEOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case TINTERVALARRAYOID: {
      ...
      set_array_string_value (is_proto_record, ql_value, arg_type, TINTERVALOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case ACLITEMARRAYOID: {
      func_name = "aclitemout";
      set_array_string_value (is_proto_record, ql_value, arg_type, ACLITEMOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case MACADDRARRAYOID: {
      func_name = "macaddr_out";
      set_array_string_value (is_proto_record, ql_value, arg_type, MACADDROID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case MACADDR8ARRAYOID: {
      func_name = "macaddr8_out";
      set_array_string_value (is_proto_record, ql_value, arg_type, MACADDR8OID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case INETARRAYOID: {
      func_name = "inet_out";
      set_array_string_value (is_proto_record, ql_value, arg_type, INETOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case CSTRINGARRAYOID: {
      func_name = "cstring_out";
      set_array_string_value (is_proto_record, ql_value, arg_type, CSTRINGOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case TIMESTAMPARRAYOID: {
      func_name = "timestamp_out";
      set_array_string_value (is_proto_record, ql_value, arg_type, TIMESTAMPOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case DATEARRAYOID: {
      func_name = "date_out";
      set_array_string_value (is_proto_record, ql_value, arg_type, DATEOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case TIMEARRAYOID: {
      func_name = "time_out";
      set_array_string_value (is_proto_record, ql_value, arg_type, TIMEOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case TIMESTAMPTZARRAYOID: {
      ...
      if (!is_proto_record) {
        ...
        if (cdc_datum_message != nullptr)
          set_decoded_string_array(ql_value, arg_type, TIMESTAMPTZOID,
                                   func_name, decoded_ql_value,
                                   is_proto_record, cdc_datum_message, timezone);
      }
      break;
    ...
    case INTERVALARRAYOID: {
      func_name = "interval_out";
      set_array_string_value (is_proto_record, ql_value, arg_type, INTERVALOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case NUMERICARRAYOID: {
      func_name = "numeric_out";
      set_array_string_value (is_proto_record, ql_value, arg_type, NUMERICOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case TIMETZARRAYOID: {
      func_name = "timetz_out";
      set_array_string_value (is_proto_record, ql_value, arg_type, TIMETZOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case BITARRAYOID: {
      func_name = "bit_out";
      set_array_string_value (is_proto_record, ql_value, arg_type, BITOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case VARBITARRAYOID: {
      func_name = "varbit_out";
      set_array_string_value (is_proto_record, ql_value, arg_type, VARBITOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case REGPROCEDUREARRAYOID: {
      func_name = "regprocedureout";
      set_array_string_value (is_proto_record, ql_value, arg_type, REGPROCEDUREOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case REGOPERARRAYOID: {
      func_name = "regoperout";
      set_array_string_value (is_proto_record, ql_value, arg_type, REGOPEROID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case REGOPERATORARRAYOID: {
      func_name = "regoperatorout";
      set_array_string_value (is_proto_record, ql_value, arg_type, REGOPERATOROID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case REGCLASSARRAYOID: {
      func_name = "regclassout";
      set_array_string_value (is_proto_record, ql_value, arg_type, REGCLASSOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case REGTYPEARRAYOID: {
      func_name = "regtypeout";
      set_array_string_value (is_proto_record, ql_value, arg_type, REGTYPEOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case REGROLEARRAYOID: {
      func_name = "regroleout";
      set_array_string_value (is_proto_record, ql_value, arg_type, REGROLEOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case REGNAMESPACEARRAYOID: {
      func_name = "regnamespaceout";
      set_array_string_value (is_proto_record, ql_value, arg_type, REGNAMESPACEOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case UUIDARRAYOID: {
      func_name = "uuid_out";
      set_array_string_value (is_proto_record, ql_value, arg_type, UUIDOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case PG_LSNARRAYOID: {
      func_name = "pg_lsn_out";
      set_array_string_value (is_proto_record, ql_value, arg_type, LSNOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case TSVECTORARRAYOID: {
      func_name = "tsvectorout";
      set_array_string_value (is_proto_record, ql_value, arg_type, TSVECTOROID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case GTSVECTORARRAYOID: {
      func_name = "gtsvectorout";
      set_array_string_value (is_proto_record, ql_value, arg_type, GTSVECTOROID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case TSQUERYARRAYOID: {
      func_name = "tsqueryout";
      set_array_string_value (is_proto_record, ql_value, arg_type, TSQUERYOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case REGCONFIGARRAYOID: {
      func_name = "regconfigout";
      set_array_string_value (is_proto_record, ql_value, arg_type, REGCONFIGOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case REGDICTIONARYARRAYOID: {
      func_name = "regdictionaryout";
      set_array_string_value (is_proto_record, ql_value, arg_type, REGDICTIONARYOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case JSONARRAYOID: {
      func_name = "json_out";
      set_array_string_value (is_proto_record, ql_value, arg_type, JSONOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case JSONBARRAYOID: {
      func_name = "jsonb_out";
      set_array_string_value (is_proto_record, ql_value, arg_type, JSONBOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case TXID_SNAPSHOTARRAYOID: {
      func_name = "txid_snapshot_out";
      set_array_string_value (is_proto_record, ql_value, arg_type, TXID_SNAPSHOTOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case ANYARRAYOID: {
      func_name = "any_out";
      set_array_string_value (is_proto_record, ql_value, arg_type, ANYOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case POLYGONARRAYOID: {
      func_name = "poly_out";
      set_array_string_value (is_proto_record, ql_value, arg_type, POLYGONOID,
                              decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case INT4RANGEARRAYOID: {
      func_name = "int4out";
      set_range_array_string_value (is_proto_record, ql_value, arg_type, INT4RANGEOID,
                                    decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case NUMRANGEARRAYOID: {
      func_name = "numeric_out";
      set_range_array_string_value (is_proto_record, ql_value, arg_type, NUMRANGEOID,
                                    decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case TSRANGEARRAYOID: {
      func_name = "timestamp_out";
      set_range_array_string_value (is_proto_record, ql_value, arg_type, TSRANGEOID,
                                    decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case TSTZRANGEARRAYOID: {
      ...
      if (!is_proto_record) {
        set_decoded_string_range_array(
            ql_value, arg_type, TSTZRANGEOID, func_name, decoded_ql_value, is_proto_record, nullptr,
            timezone);
      } else {
        if (cdc_datum_message != nullptr)
          set_decoded_string_range_array(ql_value, arg_type, TSTZRANGEOID,
                                         func_name, decoded_ql_value,
                                         is_proto_record, cdc_datum_message, timezone);
      }
      break;
    ...
    case DATERANGEARRAYOID: {
      func_name = "date_out";
      set_range_array_string_value (is_proto_record, ql_value, arg_type, DATERANGEOID,
                                    decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
    ...
    case INT8RANGEARRAYOID: {
      func_name = "int8out";
      set_range_array_string_value (is_proto_record, ql_value, arg_type, INT8RANGEOID,
                                    decoded_ql_value, func_name, cdc_datum_message);
      break;
    }
