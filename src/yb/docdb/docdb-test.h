...
// other).
const DocKey DocDBTest::kDocdbTestDocKey1(KeyEntryValues("row1", 11111));
const DocKey DocDBTest::kDocdbTestDocKey2(KeyEntryValues("row2", 22222));
const KeyBytes DocDBTest::kEncodedDocdbTestDocKey1(DocKey(KeyEntryValues("row1", 11111)).Encode());
const KeyBytes DocDBTest::kEncodedDocdbTestDocKey2(DocKey(KeyEntryValues("row2", 22222)).Encode());
