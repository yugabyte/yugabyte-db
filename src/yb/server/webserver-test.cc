...
TEST_F(WebserverSSLConfigTest, TestTLSMinVersion) {
  curl_.set_ssl_version(
    static_cast<int64>(CURL_SSLVERSION_TLSv1_2) |
    static_cast<int64>(CURL_SSLVERSION_MAX_TLSv1_2));
  ASSERT_OK(curl_.FetchURL(url_, &buf_, EasyCurl::kDefaultTimeoutSec, {}));

  curl_.set_ssl_version(
    static_cast<int64>(CURL_SSLVERSION_TLSv1_1) |
    static_cast<int64>(CURL_SSLVERSION_MAX_TLSv1_1));
