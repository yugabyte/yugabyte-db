...
DEFINE_bool(
    callhome_enabled, true, "Enables callhome feature that sends analytics data to yugabyte");
...
DEFINE_string(callhome_url, "http://diagnostics.yugabyte.com", "URL of callhome server");
