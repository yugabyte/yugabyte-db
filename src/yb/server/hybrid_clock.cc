...
DEFINE_NON_RUNTIME_bool(use_hybrid_clock, true,
...
DEFINE_NON_RUNTIME_bool(fail_on_out_of_range_clock_skew, true,
            "In case transactional tables are present, crash the process if clock skew greater "
            "than the configured maximum.");

DEFINE_NON_RUNTIME_uint64(clock_skew_force_crash_bound_usec, 60000000,
