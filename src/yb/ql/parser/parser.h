...
#ifndef YB_QL_PARSER_PARSER_H_
#define YB_QL_PARSER_PARSER_H_

#include <cstddef>

#include "yb/ql/parser/parse_context.h"
#include "yb/ql/parser/scanner.h"
...
class Parser {
 public:
  ...
  // "yb/ql/errcodes.h", and the caller (QL API) should stop the compiling process.
