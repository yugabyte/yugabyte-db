...
DEFINE_NON_RUNTIME_int32(cdc_min_replicated_index_considered_stale_secs, 900,
...
DEFINE_NON_RUNTIME_bool(propagate_safe_time, true,
    "Propagate safe time to read from leader to followers");

DEFINE_NON_RUNTIME_int32(wait_queue_poll_interval_ms, 1000,
