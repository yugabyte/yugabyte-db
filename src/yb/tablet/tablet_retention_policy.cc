...
DEFINE_NON_RUNTIME_int32(timestamp_history_retention_interval_sec, 900,
...
DEFINE_NON_RUNTIME_int32(timestamp_syscatalog_history_retention_interval_sec, 4 * 3600,
...
DEFINE_NON_RUNTIME_bool(enable_history_cutoff_propagation, false,
            "Should we use history cutoff propagation (true) or calculate it locally (false).");

DEFINE_NON_RUNTIME_int32(history_cutoff_propagation_interval_ms, 180000,
