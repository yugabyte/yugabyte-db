...
DEFINE_NON_RUNTIME_int64(transaction_abort_check_interval_ms, 5000 * yb::kTimeMultiplier,
             "Interval to check whether running transaction was aborted.");

DEFINE_NON_RUNTIME_int64(transaction_abort_check_timeout_ms, 30000 * yb::kTimeMultiplier,
