...
DEFINE_NON_RUNTIME_uint64(transaction_min_running_check_delay_ms, 50,
...
DEFINE_NON_RUNTIME_uint64(transaction_min_running_check_interval_ms, 250,
...
DEFINE_NON_RUNTIME_int32(max_transactions_in_status_request, 128,
             "Request status for at most specified number of transactions at once. "
                 "0 disables load time transaction status resolution.");

DEFINE_NON_RUNTIME_uint64(transactions_cleanup_cache_size, 256, "Transactions cleanup cache size.");

DEFINE_NON_RUNTIME_uint64(transactions_status_poll_interval_ms, 500 * yb::kTimeMultiplier,
              "Transactions poll interval.");

DEFINE_NON_RUNTIME_bool(transactions_poll_check_aborted, true,
