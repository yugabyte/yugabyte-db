...
METRIC_DEFINE_gauge_uint64(cdc, last_checkpoint_physicaltime, "CDC Last Committed Physical Time.",
    yb::MetricUnit::kMicroseconds, "Physical Time of the Last Committed Operation on Consumer.",
    {0, yb::AggregationFunction::kSum, yb::AggregationMetricLevel::kStream} /* optional_args */);
...
METRIC_DEFINE_gauge_int64(cdc, async_replication_sent_lag_micros, "CDC Physical Time Lag Last Sent",
    ...
    "producer.",
    {0, yb::AggregationFunction::kMax, yb::AggregationMetricLevel::kStream} /* optional_args */);
...
METRIC_DEFINE_gauge_uint64(cdcsdk, cdcsdk_last_sent_physicaltime, "CDCSDK Last Read Physical TIme.",
    ...
    {0, yb::AggregationFunction::kMax, yb::AggregationMetricLevel::kStream});
...
METRIC_DEFINE_gauge_uint64(cdc, last_caughtup_physicaltime, "CDC Last Caught-up Physical Time.",
    yb::MetricUnit::kMicroseconds, "Physical Time till which consumer has caught-up with producer.",
    {0, yb::AggregationFunction::kSum, yb::AggregationMetricLevel::kStream} /* optional_args */);
