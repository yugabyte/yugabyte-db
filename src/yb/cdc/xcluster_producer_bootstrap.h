...
class XClusterProducerBootstrap {
 public:
  XClusterProducerBootstrap(
      ...
      CDCServiceContext* cdc_service_context)
 ...
 private:
  ...
  using BootstrapTabletPair = std::pair<CDCStreamId, TabletId>;
  ...
  std::vector<CDCStreamId> bootstrap_ids_;
  std::vector<std::pair<CDCStreamId, TableId>> bootstrap_ids_and_tables_;
