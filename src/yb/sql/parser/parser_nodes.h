// PostgreSQL C-sytle parsing nodes are kept here for compilation purpose.
// We'll replace these with our C++ classes and structs later.
 ...
 *-------------------------------------------------------------------------
 */
#ifndef YB_SQL_PARSER_PARSER_NODES_H
#define YB_SQL_PARSER_PARSER_NODES_H

#include <stdint.h>
#include <limits.h>

#include "yb/sql/parser/parser.h"
#include "yb/sql/parser/parser_node_types.h"

typedef int64_t FromExpr;
typedef int64_t OnConflictExpr;
typedef int64_t Alias;
typedef int64_t LockClauseStrength;
typedef int64_t LockWaitPolicy;
typedef int64_t XmlOptionType;
typedef int64_t Oid;
typedef int64_t Index;
typedef int64_t Bitmapset;
typedef int64_t Expr;
typedef int64_t LockWaitPolicy;
typedef int64_t RangeVar;
typedef int64_t IntoClause;
typedef int64_t Value;
typedef int64_t bits32;
typedef int64_t OnCommitAction;
typedef int64_t CoercionContext;
typedef int64_t JoinExpr;
...
#endif   /* YB_SQL_PARSER_PARSER_NODES_H */
