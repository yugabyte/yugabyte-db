...
const std::unordered_map<ErrorCode, const char*, EnumHash> kQLErrorMessage {
  ...
  { ErrorCode::ILLEGAL_NAME, "Cannot use system-reserved name" },
  ...
  { ErrorCode::INVALID_TABLE_TYPE, "Invalid Table Type" },
  { ErrorCode::INVALID_DATATYPE, "Invalid Datatype" },
  { ErrorCode::SYSTEM_NAMESPACE_READONLY, "System Database is Read-Only" },
  { ErrorCode::INVALID_FUNCTION_CALL, "Invalid Function Call" },
  { ErrorCode::NO_NAMESPACE_USED, "No database connected" },
  ...
  { ErrorCode::SCHEMA_ALREADY_EXISTS, "Schema Already Exists" },
