...
//--------------------------------------------------------------------------------------------------
#ifndef YB_YQL_PGSQL_SYN_PG_SCANNER_H_
#define YB_YQL_PGSQL_SYN_PG_SCANNER_H_
...
#include "yb/yql/pgsql/syn/pg_gram.y.final.hh"
...
#undef yyFlexLexer
#define yyFlexLexer PgFlexLexer
#include <FlexLexer.h>
#endif
...
constexpr int NAMEDATALEN = pgapi::NAMEDATALEN;

// UTF bit.
constexpr int UTF_HIGHBIT = pgapi::HIGHBIT;
...
class LexProcessor : public yyFlexLexer {
 public:
  ...
  void ScanInit(PgCompileContext *compile_context);
...
#endif  // YB_YQL_PGSQL_SYN_PG_SCANNER_H_
