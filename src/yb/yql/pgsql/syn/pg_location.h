...
//
//
// Wrapper for BISON location.hh. This module implements the abstract interface PgTLocation, which
...
#ifndef YB_YQL_PGSQL_SYN_PG_LOCATION_H_
#define YB_YQL_PGSQL_SYN_PG_LOCATION_H_

#include "yb/yql/pgsql/ptree/pg_tlocation.h"
#include "yb/yql/pgsql/syn/location.hh"

namespace yb {
namespace pgsql {

class Location : public PgTLocation {
 public:
  //------------------------------------------------------------------------------------------------
  // Public types.
...
#endif // YB_YQL_PGSQL_SYN_PG_LOCATION_H_
