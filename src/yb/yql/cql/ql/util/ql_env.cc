...
DEFINE_NON_RUNTIME_bool(use_cassandra_authentication, false,
    "If to require authentication on startup.");
DEFINE_NON_RUNTIME_bool(ycql_cache_login_info, false,
    "Use authentication information cached locally.");
DEFINE_NON_RUNTIME_bool(ycql_require_drop_privs_for_truncate, false,
            "Require DROP TABLE permission in order to truncate table");
DEFINE_NON_RUNTIME_bool(ycql_use_local_transaction_tables, false,
