...
void prepareAndCheck(TestQLProcessor* processor,
  ...
  ASSERT_OK(stmt.Prepare(
      processor, nullptr /* mem_tracker */, false /* internal */, &result));
...
TEST_F(TestQLStatement, TestBindVarPositions) {
  ...
  // The feature is not supported yet in the branch: "(r1, r2)".
  // See: https://github.com/yugabyte/yugabyte-db/issues/13837
