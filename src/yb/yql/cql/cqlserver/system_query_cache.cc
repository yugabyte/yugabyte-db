...
DEFINE_NON_RUNTIME_int32(cql_update_system_query_cache_msecs, 0,
             "How often the system query cache should be updated. <= 0 disables caching.");
DEFINE_NON_RUNTIME_int32(cql_system_query_cache_stale_msecs, 60000,
             "Maximum permitted staleness for the system query cache. "
             "<= 0 permits infinite staleness.");
DEFINE_NON_RUNTIME_string(cql_system_query_cache_tables, "",
...
DEFINE_NON_RUNTIME_bool(cql_system_query_cache_empty_responses, true,
