...
// LDAP specific flags
DEFINE_NON_RUNTIME_bool(ycql_use_ldap, false, "Use LDAP for user logins");
DEFINE_NON_RUNTIME_string(ycql_ldap_users_to_skip_csv, "",
