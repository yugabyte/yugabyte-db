...
DEFINE_NON_RUNTIME_int64(cql_service_max_prepared_statement_size_bytes, 128_MB,
             "The maximum amount of memory the CQL proxy should use to maintain prepared "
             "statements. 0 or negative means unlimited.");
DEFINE_NON_RUNTIME_int32(cql_ybclient_reactor_threads, 24,
             "The number of reactor threads to be used for processing ybclient "
             "requests originating in the cql layer");
DEFINE_NON_RUNTIME_int32(password_hash_cache_size, 64, "Number of password hashes to cache. 0 or "
             "negative disables caching.");
DEFINE_NON_RUNTIME_int64(cql_processors_limit, -4000,
             ...
             "0 - unlimited.");
DEFINE_NON_RUNTIME_bool(cql_check_table_schema_in_paging_state, true,
