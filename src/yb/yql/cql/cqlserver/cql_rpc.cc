...
DEFINE_NON_RUNTIME_int32(rpcz_max_cql_query_dump_size, 4_KB,
             "The maximum size of the CQL query string in the RPCZ dump.");
DEFINE_NON_RUNTIME_int32(rpcz_max_cql_batch_dump_count, 4_KB,
             "The maximum number of CQL batch elements in the RPCZ dump.");
DEFINE_NON_RUNTIME_bool(throttle_cql_calls_on_soft_memory_limit, true,
            "Whether to reject CQL calls when soft memory limit is reached.");
DEFINE_NON_RUNTIME_bool(display_bind_params_in_cql_details, true,
...
DEFINE_NON_RUNTIME_int32(throttle_cql_calls_policy, kRejectPolicy,
...
// and overheads
DEFINE_NON_RUNTIME_int32(max_message_length, 254_MB,
...
DEFINE_NON_RUNTIME_bool(cql_server_always_send_events, false,
