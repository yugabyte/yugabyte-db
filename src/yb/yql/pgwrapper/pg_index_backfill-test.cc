...
class PgIndexBackfillFastSessionExpiry : public PgIndexBackfillTest {
 public:
  void UpdateMiniClusterOptions(ExternalMiniClusterOptions* options) override {
    PgIndexBackfillTest::UpdateMiniClusterOptions(options);
    options->extra_tserver_flags.push_back(
...
INSTANTIATE_TEST_CASE_P(, PgIndexBackfillFastSessionExpiry, ::testing::Bool());

TEST_P(
    PgIndexBackfillFastSessionExpiry,
