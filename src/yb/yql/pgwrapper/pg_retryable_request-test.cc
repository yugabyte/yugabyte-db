...
TEST_F(PgRetryableRequestTest, YsqlRequestTimeoutSecs) {
  ...
  ASSERT_EQ(ASSERT_RESULT(peer->GetRaftConsensus())->TEST_RetryableRequestTimeoutSecs(), 5);
  ...
  ASSERT_EQ(ASSERT_RESULT(peer->GetRaftConsensus())->TEST_RetryableRequestTimeoutSecs(), 15);
  ASSERT_OK(conn.Execute("DROP TABLE t"));
  ...
  ASSERT_OK(conn.Execute(
      "CREATE TABLE t (key INT PRIMARY KEY, v1 TEXT, v2 TEXT) SPLIT INTO 1 TABLETS"));
  peer = ASSERT_RESULT(GetOnlyTablePeer());
  ASSERT_EQ(ASSERT_RESULT(peer->GetRaftConsensus())->TEST_RetryableRequestTimeoutSecs(), 360);
  ASSERT_OK(conn.Execute("DROP TABLE t"));
  ...
  ASSERT_OK(conn.Execute(
      "CREATE TABLE t (key INT PRIMARY KEY, v1 TEXT, v2 TEXT) SPLIT INTO 1 TABLETS"));
  peer = ASSERT_RESULT(GetOnlyTablePeer());
  ASSERT_EQ(ASSERT_RESULT(peer->GetRaftConsensus())->TEST_RetryableRequestTimeoutSecs(), 660);
  ASSERT_OK(conn.Execute("DROP TABLE t"));
  ...
  ASSERT_OK(conn.Execute(
      "CREATE TABLE t (key INT PRIMARY KEY, v1 TEXT, v2 TEXT) SPLIT INTO 1 TABLETS"));
  peer = ASSERT_RESULT(GetOnlyTablePeer());
  ASSERT_EQ(ASSERT_RESULT(peer->GetRaftConsensus())->TEST_RetryableRequestTimeoutSecs(), 620);
  ASSERT_OK(conn.Execute("DROP TABLE t"));
  ...
  ASSERT_OK(conn.Execute(
      "CREATE TABLE t (key INT PRIMARY KEY, v1 TEXT, v2 TEXT) SPLIT INTO 1 TABLETS"));
  peer = ASSERT_RESULT(GetOnlyTablePeer());
  ASSERT_EQ(ASSERT_RESULT(peer->GetRaftConsensus())->TEST_RetryableRequestTimeoutSecs(), 600);
  ASSERT_OK(conn.Execute("DROP TABLE t"));
}
