...
INSERT INTO pg_catalog.pg_proc (
  ...
  (8043, 'yb_server_region', 11, 10, 12, 1, 0, 0, '-', 'f', false, false, true, false,
   's', 's', 0, 0, 1043, '', NULL, NULL, NULL,
   NULL, NULL, 'yb_server_region', NULL, NULL, NULL),
  -- implementation of yb_server_cloud
  (8044, 'yb_server_cloud', 11, 10, 12, 1, 0, 0, '-', 'f', false, false, true, false,
   's', 's', 0, 0, 1043, '', NULL, NULL, NULL,
   NULL, NULL, 'yb_server_cloud', NULL, NULL, NULL),
  -- implementation of yb_server_zone
  (8045, 'yb_server_zone', 11, 10, 12, 1, 0, 0, '-', 'f', false, false, true, false,
   's', 's', 0, 0, 1043, '', NULL, NULL, NULL,
...
BEGIN
  IF NOT EXISTS (
    SELECT FROM pg_catalog.pg_depend
      WHERE refclassid = 1255 AND refobjid = 8043
  ) THEN
