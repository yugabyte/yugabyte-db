BEGIN;
  ...
  INSERT INTO pg_catalog.pg_proc (
    ...
    false, true, true, 'v', 'r', 0, 0, 2249, '', '{1184,2950,20,25,25,25,2950,20,20,25,25,700,25,26}',
    ...
    wait_event_aux,sample_weight,wait_event_type,ysql_dbid}',
