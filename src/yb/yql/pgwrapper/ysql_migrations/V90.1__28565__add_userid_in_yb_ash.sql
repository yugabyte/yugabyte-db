BEGIN;
    ...
    -- Add a column for ysql_userid in yb_active_session_history
    ...
    INSERT INTO pg_catalog.pg_proc (
      ...
      false, true, true, 'v', 'r', 0, 0, 2249, '',
      '{1184,2950,20,25,25,25,2950,20,23,25,25,700,25,26,20,20,26}',
      '{o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o}',
      '{sample_time,root_request_id,rpc_request_id,wait_event_component,
      wait_event_class,wait_event,top_level_node_id,query_id,pid,client_node_ip,
      wait_event_aux,sample_weight,wait_event_type,ysql_dbid,wait_event_code,pss_mem_bytes,ysql_userid}',
