...
DEFINE_NON_RUNTIME_int32(redis_svc_queue_length, 5000,
             "RPC queue length for redis service");
TAG_FLAG(redis_svc_queue_length, advanced);

DEFINE_NON_RUNTIME_int64(redis_rpc_block_size, 1_MB, "Redis RPC block size");
DEFINE_NON_RUNTIME_int64(redis_rpc_memory_limit, 0, "Redis RPC memory limit");
