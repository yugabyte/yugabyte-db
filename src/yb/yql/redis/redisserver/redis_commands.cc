...
DEFINE_NON_RUNTIME_bool(yedis_enable_flush, true,
    "Enables FLUSHDB and FLUSHALL commands in yedis.");
DEFINE_NON_RUNTIME_bool(use_hashed_redis_password, true,
...
DEFINE_NON_RUNTIME_int32(redis_keys_threshold, 10000,
