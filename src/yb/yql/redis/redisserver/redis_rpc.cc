...
DEFINE_NON_RUNTIME_uint64(redis_max_concurrent_commands, 1,
              "Max number of redis commands received from single connection, "
              "that could be processed concurrently");
DEFINE_NON_RUNTIME_uint64(redis_max_batch, 500, "Max number of redis commands that forms batch");
DEFINE_NON_RUNTIME_int32(rpcz_max_redis_query_dump_size, 4_KB,
             "The maximum size of the Redis query string in the RPCZ dump.");
DEFINE_NON_RUNTIME_uint64(redis_max_read_buffer_size, 128_MB,
              "Max read buffer size for Redis connections.");

DEFINE_NON_RUNTIME_uint64(redis_max_queued_bytes, 128_MB,
