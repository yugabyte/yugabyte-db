...
DEFINE_NON_RUNTIME_int32(redis_service_yb_client_timeout_millis, kDefaultRedisServiceTimeoutMs,
...
DEFINE_NON_RUNTIME_uint64(redis_max_command_size, 253_MB, "Maximum size of the command in redis");

// Maximum value size is 64MB
DEFINE_NON_RUNTIME_uint64(redis_max_value_size, 64_MB, "Maximum size of the value in redis");
DEFINE_NON_RUNTIME_int32(redis_callbacks_threadpool_size, 64,
             "The maximum size for the threadpool which handles callbacks from the ybclient layer");

DEFINE_NON_RUNTIME_int32(redis_password_caching_duration_ms, 5000,
             "The duration for which we will cache the redis passwords. 0 to disable.");

DEFINE_NON_RUNTIME_bool(redis_safe_batch, true, "Use safe batching with Redis service");
DEFINE_NON_RUNTIME_bool(enable_redis_auth, true, "Enable AUTH for the Redis service");
