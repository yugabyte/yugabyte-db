...
DEFINE_NON_RUNTIME_int32(pgsql_rpc_keepalive_time_ms, 0,
...
DEFINE_NON_RUNTIME_int32(pggate_rpc_timeout_secs, 60,
...
DEFINE_NON_RUNTIME_int32(pggate_tserver_shm_fd, -1,
...
DEFINE_NON_RUNTIME_int32(ysql_request_limit, 1024,
             "Maximum number of requests to be sent at once");

DEFINE_NON_RUNTIME_uint64(ysql_prefetch_limit, 1024,
              "Maximum number of rows to prefetch");

DEPRECATE_FLAG(double, ysql_backward_prefetch_scale_factor, "11_2022");

DEFINE_NON_RUNTIME_uint64(ysql_session_max_batch_size, 3072,
...
DEFINE_NON_RUNTIME_bool(ysql_non_txn_copy, false,
            "Execute COPY inserts non-transactionally.");

DEFINE_NON_RUNTIME_int32(ysql_max_read_restart_attempts, 20,
...
DEFINE_NON_RUNTIME_bool(ysql_beta_feature_tablespace_alteration, false,
...
DEFINE_NON_RUNTIME_bool(ysql_serializable_isolation_for_ddl_txn, false,
...
DEFINE_NON_RUNTIME_int32(ysql_select_parallelism, -1,
            "Number of read requests to issue in parallel to tablets of a table "
            "for SELECT.");

DEFINE_NON_RUNTIME_int32(ysql_max_write_restart_attempts, 20,
             "Max number of restart attempts made for writes on transaction conflicts.");

DEFINE_NON_RUNTIME_bool(ysql_sleep_before_retry_on_txn_conflict, true,
...
DEFINE_NON_RUNTIME_bool(ysql_disable_portal_run_context, false,
    "Whether to use portal ybRunContext.");

DEFINE_NON_RUNTIME_bool(yb_enable_read_committed_isolation, false,
