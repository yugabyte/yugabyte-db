...
CREATE UNIQUE INDEX idx_name ON test(v1);

begin transaction isolation level xxx;

insert into test values ('1', '2', '3', '4', null, 'b');

select * from test where v1 = null;

update test set v1=null where h1 = '1' and h2 = '2' and r1 = '3' and r2 = '4';
