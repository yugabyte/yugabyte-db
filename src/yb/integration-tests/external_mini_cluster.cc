...
Status ExternalMiniCluster::AddTabletServer(
  ...
  scoped_refptr<ExternalTabletServer> ts = new ExternalTabletServer(
      ...
      redis_http_port, cql_rpc_port, cql_http_port, pgsql_rpc_port, ysql_conn_mgr_rpc_port,
      pgsql_http_port, master_hostports, SubstituteInFlags(flags, idx));
