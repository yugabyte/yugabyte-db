...
DEFINE_NON_RUNTIME_bool(allow_insecure_connections, true,
    "Whether we should allow insecure connections.");
DEFINE_NON_RUNTIME_bool(dump_certificate_entries, false,
    "Whether we should dump certificate entries.");
DEFINE_NON_RUNTIME_bool(verify_client_endpoint, false,
    "Whether client endpoint should be verified.");
DEFINE_NON_RUNTIME_bool(verify_server_endpoint, true,
    "Whether server endpoint should be verified.");
DEFINE_NON_RUNTIME_string(ssl_protocols, "",
              "List of allowed SSL protocols (ssl2, ssl3, tls10, tls11, tls12). "
                  "Empty to allow TLS only.");

DEFINE_NON_RUNTIME_string(cipher_list, "",
              "Define the list of available ciphers (TLSv1.2 and below).");

DEFINE_NON_RUNTIME_string(ciphersuites, "",
