...
DEFINE_NON_RUNTIME_int64(rpcs_shutdown_timeout_ms, 15000 * yb::kTimeMultiplier,
             "Timeout for a batch of multiple RPCs invoked in parallel to shutdown.");
DEFINE_NON_RUNTIME_int64(rpcs_shutdown_extra_delay_ms, 5000 * yb::kTimeMultiplier,
             "Extra allowed time for a single RPC command to complete after its deadline.");
DEFINE_NON_RUNTIME_int32(min_backoff_ms_exponent, 7,
...
DEFINE_NON_RUNTIME_int32(max_backoff_ms_exponent, 16,
...
DEFINE_NON_RUNTIME_int32(linear_backoff_ms, 1,
