...
DEFINE_NON_RUNTIME_int32(rpc_default_keepalive_time_ms, 65000,
             "If an RPC connection from a client is idle for this amount of time, the server "
             "will disconnect the client. Setting flag to 0 disables this clean up.");
TAG_FLAG(rpc_default_keepalive_time_ms, advanced);
DEFINE_NON_RUNTIME_uint64(io_thread_pool_size, 4, "Size of allocated IO Thread Pool.");

DEFINE_NON_RUNTIME_int64(outbound_rpc_memory_limit, 0, "Outbound RPC memory limit");
...
DEFINE_NON_RUNTIME_int32(socket_receive_buffer_size, 0,
    "Socket receive buffer size, 0 to use default");
