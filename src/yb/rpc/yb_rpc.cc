...
DEFINE_NON_RUNTIME_bool(enable_rpc_keepalive, true, "Whether to enable RPC keepalive mechanism");

DEFINE_NON_RUNTIME_uint64(min_sidecar_buffer_size, 16_KB, "Minimal buffer to allocate for sidecar");
