...
class Connection final : public StreamContext, public std::enable_shared_from_this<Connection> {
 public:
  ...
  bool Idle(std::string* reason_not_idle = nullptr) const ON_REACTOR_THREAD;
 ...
 private:
  ...
  std::vector<OutboundDataPtr> outbound_data_being_processed_ GUARDED_BY_REACTOR_THREAD;
