...
- **Data in tests** — replace real emails with `user@example.com`, real names with `Alice`/`Bob`, real IPs with `192.0.2.1`, real phone numbers with `555-0100`–`555-0199` (the documentation range), real UUIDs with `10000000-2000-30000-4000-000000000005`.
