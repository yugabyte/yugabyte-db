...
int yb_backend_update_prep_stmt(od_server_t *, char *, char *, uint32_t,
				YbParseType *);
void yb_backend_handle_close_complete(od_server_t *, char *);
void yb_backend_handle_query_ack(od_server_t *, char *);
