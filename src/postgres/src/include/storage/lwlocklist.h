...
/* YB tranches */
PG_LWLOCKTRANCHE(YB_ASH_CIRCULAR_BUFFER, YbAshCircularBuffer)
PG_LWLOCKTRANCHE(YB_ASH_METADATA, YbAshMetadata)
PG_LWLOCKTRANCHE(YB_QUERY_DIAGNOSTICS, YbQueryDiagnostics)
PG_LWLOCKTRANCHE(YB_QUERY_DIAGNOSTICS_CIRCULAR_BUFFER, YbQueryDiagnosticsCircularBuffer)
PG_LWLOCKTRANCHE(YB_TERMINATED_QUERIES, YbTerminatedQueries)
