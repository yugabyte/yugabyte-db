...
#define YB_PARAM_STATUS_USERSET_SOURCE_RESET   (1 << 1)
#define YB_PARAM_STATUS_USERSET_OR_SUSET_SOURCE_STARTUP (1 << 2)
#define YB_PARAM_STATUS_USERSET_OR_SUSET_SOURCE_SESSION (1 << 3)
#define YB_PARAM_STATUS_CONTEXT_BACKEND		   (1 << 4)
