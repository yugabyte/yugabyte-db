...
/* NEIL NEIL NEIL
 * Define Yugabyte statement tag here
 */
...
PG_CMDTAG(CMDTAG_ALTER_YBTABLEGROUP, "ALTER YBTABLEGROUP", false, false, false)
...
PG_CMDTAG(CMDTAG_CREATE_YBPROFILE, "CREATE PROFILE", false, false, false)
PG_CMDTAG(CMDTAG_CREATE_YBTABLEGROUP, "CREATE TABLEGROUP", false, false, false)
...
PG_CMDTAG(CMDTAG_DROP_YBPROFILE, "DROP PROFILE", false, false, false)
PG_CMDTAG(CMDTAG_DROP_YBTABLEGROUP, "DROP TABLEGROUP", false, false, false)
