...
PG_KEYWORD("account", ACCOUNT, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("colocation", COLOCATION, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("failed_login_attempts", FAILED_LOGIN_ATTEMPTS, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("noprofile", NOPROFILE, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("unlock", UNLOCK, UNRESERVED_KEYWORD, BARE_LABEL)
