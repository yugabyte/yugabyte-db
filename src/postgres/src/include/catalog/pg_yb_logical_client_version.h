 ...
 * ----------------
 */
CATALOG(pg_yb_logical_client_version,8073,YBLogicalClientVersionRelationId) BKI_SHARED_RELATION BKI_WITHOUT_OIDS BKI_ROWTYPE_OID(8074,YBLogicalClientVersionRelation_Rowtype_Id) BKI_SCHEMA_MACRO
{
