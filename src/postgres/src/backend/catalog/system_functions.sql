...
REVOKE EXECUTE ON FUNCTION pg_replication_origin_session_reset_shared() FROM public;

REVOKE EXECUTE ON FUNCTION pg_replication_origin_session_setup(text) FROM public;

REVOKE EXECUTE ON FUNCTION pg_replication_origin_session_setup_shared(text) FROM public;
