			  ...
			  Bitmapset *scan_params)
{
	...
	switch (nodeTag(plan))
	{
		...
		case T_YbSeqScan:
			finalize_primnode((Node *) ((YbSeqScan *) plan)->remote.qual,
							  &context);
			context.paramids = bms_add_members(context.paramids, scan_params);
			break;
		...
		case T_IndexScan:
			...
			finalize_primnode((Node *) ((IndexScan *) plan)->indexorderby,
							  &context);
			finalize_primnode((Node *) ((IndexScan *) plan)->rel_remote.qual,
							  &context);
			finalize_primnode((Node *) ((IndexScan *) plan)->index_remote.qual,
							  &context);
		...
		case T_IndexOnlyScan:
			...
			finalize_primnode((Node *) ((IndexOnlyScan *) plan)->indexorderby,
							  &context);
			finalize_primnode((Node *) ((IndexOnlyScan *) plan)->remote.qual,
							  &context);
