...
YbPreloadRelCacheImpl(YbRunWithPrefetcherContext* ctx)
{
	...
	bool is_using_response_cache = ctx->is_using_response_cache;
	...
	YBUpdateRelationsPartitioning(
		relations_result.sys_relations_update_required);
