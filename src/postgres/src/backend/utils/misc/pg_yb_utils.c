...
YBPgTypeOidToStr(Oid type_id) {
	switch (type_id) {
		...
		case LSEGARRAYOID: return "LESGARRAY";
		case PATHARRAYOID: return "PATHARRAY";
		case BOXARRAYOID: return "BOXARRAY";
		case ABSTIMEARRAYOID: return "ABSTIMEARRAY";
		case RELTIMEARRAYOID: return "RELTIMEARRAY";
		case TINTERVALARRAYOID: return "TINTERVALARRAY";
