...
static void col_to_jsonb_repr(JsonbInState *pstate, TupleTableSlot *outslot,
 ...
 */
static void
col_to_jsonb_repr(JsonbInState *pstate, TupleTableSlot *outslot,
				  int slot_attno, Form_pg_attribute attr)
{
...
populate_table_cols_data(TupleTableSlot *outslot, Relation indexrel)
{
	...
	return JsonbPGetDatum(JsonbValueToJsonb(pstate.result));
}
