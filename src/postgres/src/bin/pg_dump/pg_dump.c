...
getBlobs(Archive *fout)
{
	...
	if (fout->remoteVersion >= 90600)
	{
		...
		buildACLQueries(acl_subquery, racl_subquery, init_acl_subquery,
						...
						"pip.initprivs", "'L'", dopt->binary_upgrade || dopt->include_yb_metadata);
...
getNamespaces(Archive *fout, int *numNamespaces)
{
	...
	if (fout->remoteVersion >= 90600)
	{
		...
		buildACLQueries(acl_subquery, racl_subquery, init_acl_subquery,
						...
						"'n'", dopt->binary_upgrade || dopt->include_yb_metadata);
...
getTypes(Archive *fout, int *numTypes)
{
	...
	if (fout->remoteVersion >= 90600)
	{
		...
		buildACLQueries(acl_subquery, racl_subquery, initacl_subquery,
						...
						"pip.initprivs", "'T'", dopt->binary_upgrade || dopt->include_yb_metadata);
...
getAggregates(Archive *fout, int *numAggs)
{
	...
	if (fout->remoteVersion >= 90600)
	{
		...
		buildACLQueries(acl_subquery, racl_subquery, initacl_subquery,
						...
						"pip.initprivs", "'f'", dopt->binary_upgrade || dopt->include_yb_metadata);
...
getTables(Archive *fout, int *numTables)
{
	...
	if (fout->remoteVersion >= 90600)
	{
		...
		buildACLQueries(attacl_subquery, attracl_subquery, attinitacl_subquery,
						...
						"pip.initprivs", "'c'", dopt->binary_upgrade || dopt->include_yb_metadata);
	...
	for (i = 0; i < numTables; i++)
	{
		...
		else if (fout->remoteVersion >= 90000)
		{
			...
			appendPQExpBuffer(query,
							  ...
							  "i.indnatts AS indnatts, "
							  "i.indkey, i.indisclustered, "
							  "false AS indisreplident, i.indoption, "
							  "c.contype, c.conname, "
							  "c.condeferrable, c.condeferred, "
							  "c.tableoid AS contableoid, "
							  "c.oid AS conoid, "
...
getForeignServers(Archive *fout, int *numForeignServers)
{
	...
	if (fout->remoteVersion >= 90600)
	{
		...
		buildACLQueries(acl_subquery, racl_subquery, initacl_subquery,
						...
						"pip.initprivs", "'S'", dopt->binary_upgrade || dopt->include_yb_metadata);
