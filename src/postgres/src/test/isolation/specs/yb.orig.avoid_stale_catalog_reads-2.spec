...
step s1_drop_parent { drop table parent; }
...
# new column is added.
permutation s1_create_table s2_select_parent s1_begin_rr s2_begin_rr s1_alter_table_add_col s2_create_child_table_via_partioning s1_commit s2_commit s3_select_child s1_drop_parent

# Misc case that results in a deadlock
# TODO: Mask the txn_start_us in the error string in the .out file
# permutation s1_create_table s1_begin_rr s2_begin_rr s2_select_parent s1_alter_table_add_col s2_create_child_table_via_partioning s1_commit s2_commit s3_select_child s3_select_parent s1_drop_parent
