...
# TODO: Uncomment when this test is reliable.
# permutation "max1" "0secold" "s1lock" "s2lock" "wait5s" "totalrows" "totaltxns"

# (5) Take 2 locks. Here, set the min_age to 6s. Make sure nothing is
#   returned after 2s. But then after 5s more, we should see 4 total and 2
#   transactions.
permutation "6secold" "s1lock" "s2lock" "wait2s" "totalrows" "totaltxns" "wait5s" "totalrows" "totaltxns"
