...
SET yb_non_ddl_txn_for_sys_tables_allowed=1; -- YB: allow update to pg_proc system table
UPDATE pg_proc SET proacl = null WHERE proname LIKE 'testagg_';
SET yb_non_ddl_txn_for_sys_tables_allowed=0; -- YB: disable update to pg_proc system table
