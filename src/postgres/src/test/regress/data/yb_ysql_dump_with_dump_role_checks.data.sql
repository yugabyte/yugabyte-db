...
CREATE UNIQUE INDEX NONCONCURRENTLY part_uniq_const_unique ON ONLY public.part_uniq_const USING lsm (v1 HASH, v2 ASC) SPLIT INTO 3 TABLETS;

ALTER TABLE ONLY public.part_uniq_const
    ADD CONSTRAINT part_uniq_const_unique UNIQUE USING INDEX part_uniq_const_unique;
...
CREATE UNIQUE INDEX NONCONCURRENTLY part_uniq_const_30_50_v1_v2_key ON public.part_uniq_const_30_50 USING lsm (v1 HASH, v2 ASC) SPLIT INTO 3 TABLETS;

ALTER TABLE ONLY public.part_uniq_const_30_50
    ADD CONSTRAINT part_uniq_const_30_50_v1_v2_key UNIQUE USING INDEX part_uniq_const_30_50_v1_v2_key;
...
CREATE UNIQUE INDEX NONCONCURRENTLY part_uniq_const_50_100_v1_v2_key ON public.part_uniq_const_50_100 USING lsm (v1 HASH, v2 ASC) SPLIT INTO 3 TABLETS;

ALTER TABLE ONLY public.part_uniq_const_50_100
    ADD CONSTRAINT part_uniq_const_50_100_v1_v2_key UNIQUE USING INDEX part_uniq_const_50_100_v1_v2_key;
...
CREATE UNIQUE INDEX NONCONCURRENTLY part_uniq_const_default_v1_v2_key ON public.part_uniq_const_default USING lsm (v1 HASH, v2 ASC) SPLIT INTO 3 TABLETS;

ALTER TABLE ONLY public.part_uniq_const_default
    ADD CONSTRAINT part_uniq_const_default_v1_v2_key UNIQUE USING INDEX part_uniq_const_default_v1_v2_key;
