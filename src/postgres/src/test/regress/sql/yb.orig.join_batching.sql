...
--------------------------------------------------------
-- Try some queries from yb.port.join with BNL forced --
--------------------------------------------------------
...
/*+Set(enable_hashjoin OFF) Set(enable_mergejoin OFF) Set(enable_material OFF) Leading((ss2 (ss1 ss3_1)))
