...
insert into test1 (id, t) values (1, 'a');
insert into test1 (id, t) values (2, 'b');
insert into test1 (id,t) values (3, 'c');
insert into test1 (id,t) values (4, 'd');
insert into test1 (id,t) values (5, 'e');

create table test2 (id int, t text);
insert into test2 (id, t) values (1, 'A');
insert into test2 (id, t) values (2, 'B');
insert into test2 (id, t) values (3, 'C');
insert into test2 (id, t) values (4, 'D');
insert into test2 (id, t) values (5, 'E');
...
-- Test COPY table TO
--
copy (select * from test1 order by id) to stdout;
--
-- This should fail
--
...
--
copy (select t from test1 where id=3) to stdout;
--
-- This should fail
--
