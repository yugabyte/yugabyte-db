...
SELECT ~b                       FROM macaddr8_data ORDER BY a;
SELECT  b & '00:00:00:ff:ff:ff' FROM macaddr8_data ORDER BY a;
SELECT  b | '01:02:03:04:05:06' FROM macaddr8_data ORDER BY a;
