...
--   bare.
\set query 'SELECT i2, i4, n, v, t::varchar FROM tv_tbl WHERE v = ''1'' AND t = ''1'' ORDER BY i2, i4, n LIMIT 5'
:explain2run2

\set query 'SELECT i2, i4, n, v, t::varchar FROM tv_tbl WHERE v IN (''1'', ''1'') AND t IN (''1'', ''1'') ORDER BY i2, i4, n LIMIT 5'
:explain2run2
...
\set query 'SELECT i2, i4, n, v::text, t::varchar FROM tv_tbl WHERE v::text = ''1'' AND t::varchar = ''1'' ORDER BY i2, i4, n LIMIT 5'
:explain2run2

\set query 'SELECT i2, i4, n, v::text, t::varchar FROM tv_tbl WHERE v::text IN (''1'', ''1'') AND t::varchar IN (''1'', ''1'') ORDER BY i2, i4, n LIMIT 5'
:explain2run2
...
--   only.
\set query 'SELECT i2, i4, n, v, t FROM tv_tbl WHERE v = ''1'' AND t = ''1'' ORDER BY i2, i4, n LIMIT 5'
:explain2run2

\set query 'SELECT i2, i4, n, v, t FROM tv_tbl WHERE v IN (''1'', ''1'') AND t IN (''1'', ''1'') ORDER BY i2, i4, n LIMIT 5'
:explain2run2
...
\set query 'SELECT i2, i4, n, v FROM tv_tbl WHERE v = ''1'' ORDER BY i2, i4, n LIMIT 5'
:explain2run2

\set query 'SELECT i2, i4, n, v FROM tv_tbl WHERE v IN (''1'', ''1'') ORDER BY i2, i4, n LIMIT 5'
:explain2run2

\set query 'SELECT i2, i4, n, v FROM tv_tbl WHERE v = ''1''::varchar ORDER BY i2, i4, n LIMIT 5'
:explain2run2

\set query 'SELECT i2, i4, n, v FROM tv_tbl WHERE v IN (''1''::varchar, ''1''::varchar) ORDER BY i2, i4, n LIMIT 5'
:explain2run2
