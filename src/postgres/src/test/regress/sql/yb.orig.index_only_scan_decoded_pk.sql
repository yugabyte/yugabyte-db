...
SELECT $$
SELECT id FROM t_hash WHERE v = 'val_1'
$$ AS query \gset
:explain1run1

SELECT $$
SELECT id, v FROM t_hash WHERE v = 'val_3'
$$ AS query \gset
:explain1run1
...
SELECT $$
SELECT id FROM t_range WHERE v = 'val_5'
$$ AS query \gset
:explain1run1

SELECT $$
SELECT id, v FROM t_range WHERE v >= 'val_10' AND v < 'val_15' ORDER BY v
$$ AS query \gset
:explain1run1

SELECT $$
SELECT id FROM t_range WHERE id = 5
$$ AS query \gset
:explain1run1
...
SELECT $$
SELECT a, b FROM t_composite WHERE v = 'v_15'
$$ AS query \gset
:explain1run1

SELECT $$
SELECT a, b, v FROM t_composite WHERE v = 'v_15'
$$ AS query \gset
:explain1run1
...
SELECT $$
SELECT id FROM t_pk_in_idx WHERE v1 = 100
$$ AS query \gset
:explain1run1
...
SELECT $$
SELECT id FROM t_uniq WHERE email = 'user5@test.com'
$$ AS query \gset
:explain1run1
...
SELECT $$
SELECT id FROM t_multi_col WHERE a = 2 AND b = 2
$$ AS query \gset
:explain1run1
...
SELECT $$
SELECT h1, h2 FROM t_hash_comp WHERE v = 50
$$ AS query \gset
:explain1run1

SELECT $$
SELECT h1, h2, v FROM t_hash_comp WHERE v = 50
$$ AS query \gset
:explain1run1
...
SELECT $$
SELECT h, r FROM t_mixed_pk WHERE v = 'v_7'
$$ AS query \gset
:explain1run1

-- Test: filter on decoded PK column (pushdown disabled)
SELECT $$
SELECT id FROM t_range WHERE v = 'val_5' AND id % 2 = 1
$$ AS query \gset
:explain1run1

SELECT $$
SELECT id, v FROM t_range WHERE v >= 'val_10' AND v < 'val_20' AND id % 3 = 1 ORDER BY v
$$ AS query \gset
:explain1run1

-- Test: aggregates on decoded PK columns (pushdown disabled)
SELECT $$
SELECT COUNT(id) FROM t_range WHERE v >= 'val_10' AND v < 'val_20'
$$ AS query \gset
:explain1run1

SELECT $$
SELECT MIN(id), MAX(id) FROM t_range WHERE v >= 'val_10' AND v < 'val_20'
$$ AS query \gset
:explain1run1

-- Test: filters on physical columns still push down
SELECT $$
SELECT id FROM t_range WHERE v >= 'val_10' AND v < 'val_15'
$$ AS query \gset
:explain1run1

-- Test: aggregates on physical index columns still push down
SELECT $$
SELECT COUNT(*) FROM t_range WHERE v >= 'val_10' AND v < 'val_20'
$$ AS query \gset
:explain1run1
...
SELECT $$
SELECT id FROM t_null_idx WHERE v = 10
$$ AS query \gset
:explain1run1
...
SELECT $$
SELECT id FROM t_text_pk WHERE v = 3
$$ AS query \gset
:explain1run1
...
SELECT $$
SELECT id FROM t_float_pk WHERE v = 3
$$ AS query \gset
:explain1run1
...
SELECT $$
SELECT id FROM t_double_pk WHERE v = 3
$$ AS query \gset
:explain1run1
...
SELECT $$
SELECT id FROM t_ts_pk WHERE v = 3
$$ AS query \gset
:explain1run1
...
SELECT $$
SELECT id, extra FROM t_bool_pk WHERE v = 3
$$ AS query \gset
:explain1run1
...
SELECT $$
SELECT i.item_id, t.label FROM t_join_child i JOIN t_join_parent t ON i.item_id = t.tag_id WHERE i.tag = 1 ORDER BY i.item_id
$$ AS query \gset
:explain1run1

-- Test: join with filter on decoded PK column (pushdown disabled)
SELECT $$
SELECT i.item_id, t.label FROM t_join_child i JOIN t_join_parent t ON i.item_id = t.tag_id WHERE i.tag = 1 AND i.item_id % 500 = 1 ORDER BY i.item_id
$$ AS query \gset
:explain1run1
...
SELECT $$
SELECT id FROM t_include_cmp WHERE v = 50 AND id > 5000
$$ AS query \gset
:explain1run1

SELECT $$
SELECT COUNT(id) FROM t_include_cmp WHERE v = 50
$$ AS query \gset
:explain1run1

SELECT $$
SELECT COUNT(id) FROM t_include_cmp WHERE v >= 20 AND v < 80
$$ AS query \gset
:explain1run1
...
SELECT $$
SELECT h1, h2 FROM t_partial_include WHERE v = 25 AND h1 > 5 AND h2 > 800 ORDER BY h2
$$ AS query \gset
:explain1run1

SELECT $$
SELECT COUNT(h1), COUNT(h2) FROM t_partial_include WHERE v >= 20 AND v < 30
$$ AS query \gset
:explain1run1

-- Test: join on table with included pk column
SELECT $$
SELECT c.h1, c.h2, p.label FROM t_partial_include c JOIN t_join_parent p ON c.h1 = p.tag_id WHERE c.v = 25 ORDER BY c.h2
$$ AS query \gset
:explain1run1
...
SELECT $$
SELECT id FROM t_expr WHERE lower(name) = 'name_5'
$$ AS query \gset
:explain1run1

SELECT $$
SELECT id, lower(name) FROM t_expr WHERE lower(name) = 'name_3'
$$ AS query \gset
:explain1run1

-- Test: IN queries with decoded PK
SELECT $$
SELECT id FROM t_range WHERE v IN ('val_3', 'val_7', 'val_15') ORDER BY id
$$ AS query \gset
:explain1run1

SELECT $$
SELECT id FROM t_multi_col WHERE a IN (1, 3) AND b = 2 ORDER BY id
$$ AS query \gset
:explain1run1

-- Test: LIKE queries with decoded PK
SELECT $$
SELECT id FROM t_range WHERE v LIKE 'val_1%' ORDER BY v
$$ AS query \gset
:explain1run1
...
SELECT $$
SELECT id FROM t_partial_comp WHERE cat = 'A' AND sub = 2 AND val > 10 ORDER BY id
$$ AS query \gset
:explain1run1
...
SELECT $$
SELECT id FROM t_jsonb_expr WHERE (data->>'key')::int = 5
$$ AS query \gset
:explain1run1
...
SELECT $$
SELECT id FROM t_temp WHERE v = 50
$$ AS query \gset
:explain1run1
...
SELECT $$
SELECT id FROM t_colocated WHERE v = 5
$$ AS query \gset
:explain1run1

-- Test: range scan on colocated table.
SELECT $$
SELECT id, v FROM t_colocated WHERE v >= 10 AND v < 15 ORDER BY v
$$ AS query \gset
:explain1run1
