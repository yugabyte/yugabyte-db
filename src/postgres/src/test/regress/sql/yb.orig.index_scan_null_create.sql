...
CREATE TABLE nulltest (a int, b int, s serial PRIMARY KEY) SPLIT INTO 3 TABLETS;
INSERT INTO nulltest VALUES (null, null), (null, 1), (1, null), (1, 1);

CREATE TABLE nulltest2 (x int, y int, s serial PRIMARY KEY) SPLIT INTO 3 TABLETS;
