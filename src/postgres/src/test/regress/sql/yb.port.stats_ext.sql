...
/* YB: uncomment when text value TOASTing is supported (#2003)
DO $$
DECLARE
...
drop schema stts_s1, stts_s2 cascade; -- YB: fails because dropping multiple schemas is not supported (#880)
drop schema stts_s1 cascade; -- YB: workaround for above
