...
INSERT INTO varlen VALUES ('a', bytea('a')), ('a', bytea('a')) ON CONFLICT (t) DO UPDATE SET t = 'b', b = bytea('b');
INSERT INTO varlen VALUES ('a', bytea('a')), ('a', bytea('a')) ON CONFLICT (t) DO UPDATE SET t = EXCLUDED.t || 'z', b = bytea(EXCLUDED.t || 'z');
INSERT INTO varlen VALUES ('az', bytea('az')), ('az', bytea('az')) ON CONFLICT (t) DO UPDATE SET t = varlen.t || 'z', b = bytea(varlen.t || 'z');
