...
-- sort.
\set query 'SELECT a FROM mod_null_tbl ORDER BY a LIMIT 5'
\set hint2 '/*+IndexOnlyScan(mod_null_tbl mod_null_tbl_bkt_a_idx) Set(enable_sort off) Set(yb_max_merge_scan_streams 64)*/'
\set hint3 '/*+IndexOnlyScan(mod_null_tbl mod_null_tbl_expr_a_idx) Set(enable_sort off) Set(yb_max_merge_scan_streams 64)*/'
:explain3
...
-- Third hint is to encourage merge scan of the expression index by disabling
-- sort.
\set query 'SELECT a FROM mod_zero_tbl ORDER BY a LIMIT 5'
\set hint2 '/*+IndexOnlyScan(mod_zero_tbl mod_zero_tbl_bkt_a_idx) Set(enable_sort off) Set(yb_max_merge_scan_streams 64)*/'
\set hint3 '/*+IndexOnlyScan(mod_zero_tbl mod_zero_tbl_expr_a_idx) Set(enable_sort off) Set(yb_max_merge_scan_streams 64)*/'
:explain3
...
-- Third hint is to encourage merge scan of the expression index by disabling
-- sort.
\set query 'SELECT a FROM mod_neg_tbl ORDER BY a LIMIT 5'
\set hint2 '/*+IndexOnlyScan(mod_neg_tbl mod_neg_tbl_bkt_a_idx) Set(enable_sort off) Set(yb_max_merge_scan_streams 64)*/'
\set hint3 '/*+IndexOnlyScan(mod_neg_tbl mod_neg_tbl_expr_a_idx) Set(enable_sort off) Set(yb_max_merge_scan_streams 64)*/'
:explain3
...
-- Third hint is to encourage merge scan of the expression index by disabling
-- sort.
\set query 'SELECT a FROM mod_min_tbl ORDER BY a LIMIT 5'
\set hint2 '/*+IndexOnlyScan(mod_min_tbl mod_min_tbl_bkt_a_idx) Set(enable_sort off) Set(yb_max_merge_scan_streams 64)*/'
\set hint3 '/*+IndexOnlyScan(mod_min_tbl mod_min_tbl_expr_a_idx) Set(enable_sort off) Set(yb_max_merge_scan_streams 64)*/'
:explain3
