...
insert into queries values
    ...
    (DEFAULT, true, 'select * from r where a = 10 and e = 10'),
    (DEFAULT, true, 'select 0 from r group by a, e'),
    (DEFAULT, true, 'select distinct a, e from r'),
    (DEFAULT, true, 'select * from r where b % 5 = 0'),
    (DEFAULT, true, 'select distinct b % 5 from r'),
    (DEFAULT, true, 'select 0 from r group by b % 5'),
