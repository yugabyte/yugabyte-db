...
/* YB: CREATE TABLE AS EXECUTE not supported yet
...
/* YB: OIDS not supported for user tables
...
/* YB : savepoints for DDL are not supported
...
/* YB: exclude using GIST not suppored
...
CREATE OPERATOR CLASS test_int4_ops FOR TYPE int4 USING lsm AS /* YB: btree access method doesn't apply */
...
DROP OPERATOR CLASS test_int4_ops USING lsm; /* YB: btree access method doesn't apply */
