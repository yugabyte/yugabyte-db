...
\set hint3 '/*+HashJoin(a b) Set(yb_max_merge_scan_streams 64)*/'
\set hint4 '/*+MergeJoin(a b) Set(yb_max_merge_scan_streams 64)*/'
\set hint5 '/*+MergeJoin(a b) Leading((b a)) Set(yb_max_merge_scan_streams 64)*/'
:explain5
...
\set hint3 '/*+Leading((h3r2n r5n)) Set(yb_max_merge_scan_streams 64)*/'
\set hint4 '/*+MergeJoin(h3r2n r5n) Set(yb_max_merge_scan_streams 64)*/'
\set hint5 '/*+MergeJoin(h3r2n r5n) Leading((h3r2n r5n)) Set(yb_max_merge_scan_streams 64)*/'
:explain5run5
...
\set hint3 '/*+Leading(((h3r2n r5n) parent)) Set(yb_max_merge_scan_streams 64)*/'
:explain3run3
