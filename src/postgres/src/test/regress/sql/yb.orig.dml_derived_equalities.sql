...
\set hint1 '/*+ IndexScan(t_const_expr t_const_expr_idx) */'
\set query 'SELECT * FROM t_const_expr ORDER BY a'
:explain1run1
...
\set hint1 '/*+ IndexScan(t_mixed_expr t_mixed_expr_idx) */'
\set query 'SELECT * FROM t_mixed_expr WHERE b = 4 ORDER BY a'
:explain1run1
