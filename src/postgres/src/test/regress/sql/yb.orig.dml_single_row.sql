...
EXPLAIN (COSTS OFF) UPDATE pk_nn SET b = NULL WHERE k = 5;
EXPLAIN (COSTS OFF) UPDATE pk_nn SET b = NULL WHERE k = 105;
EXPLAIN (COSTS OFF) UPDATE pk_nn SET a = 11 WHERE k = 5;
EXPLAIN (COSTS OFF) UPDATE pk_nn SET a = 11 WHERE k = 105;
UPDATE pk_nn SET b = NULL WHERE k = 5;
UPDATE pk_nn SET b = NULL WHERE k = 105;
UPDATE pk_nn SET a = 11 WHERE k = 5;
UPDATE pk_nn SET a = 11 WHERE k = 105;
...
EXPLAIN (COSTS OFF) UPDATE pk_nn_drop SET b = NULL WHERE k = 5;
EXPLAIN (COSTS OFF) UPDATE pk_nn_drop SET a = 11 WHERE k = 5;
UPDATE pk_nn_drop SET b = NULL WHERE k = 5;
UPDATE pk_nn_drop SET a = 11 WHERE k = 5;
