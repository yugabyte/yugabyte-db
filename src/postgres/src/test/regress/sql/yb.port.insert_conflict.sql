...
WITH ybtmp AS (DELETE FROM capitals WHERE name = 'Sacramento' RETURNING *)
    	INSERT INTO capitals SELECT * FROM ybtmp; -- YB: imitate PG ctid reallocation for the following update
