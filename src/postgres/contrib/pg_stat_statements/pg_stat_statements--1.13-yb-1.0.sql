...
/*NESTED*/
/* Sourced from contrib/pg_stat_statements/pg_stat_statements--1.10-yb-2.1--1.13-yb-1.0.sql */
...
DROP VIEW IF EXISTS pg_stat_statements;
DROP FUNCTION IF EXISTS pg_stat_statements(boolean);
DROP FUNCTION IF EXISTS pg_stat_statements_reset(Oid, Oid, bigint);
...
RETURNS SETOF record
AS 'MODULE_PATHNAME', 'yb_pg_stat_statements_1_13'
LANGUAGE C STRICT VOLATILE PARALLEL SAFE;
