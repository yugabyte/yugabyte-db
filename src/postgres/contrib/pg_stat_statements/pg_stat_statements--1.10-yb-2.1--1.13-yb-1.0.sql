/* contrib/pg_stat_statements/pg_stat_statements--1.10-yb-2.1--1.13-yb-1.0.sql */

-- complain if script is sourced in psql, rather than via ALTER EXTENSION
\echo Use "ALTER EXTENSION pg_stat_statements UPDATE TO '1.13-yb-1.0'" to load this file. \quit
