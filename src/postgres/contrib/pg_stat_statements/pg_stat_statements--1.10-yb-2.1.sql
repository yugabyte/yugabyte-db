...
/*NESTED*/
/* Sourced from contrib/pg_stat_statements/pg_stat_statements--1.10-yb-2.0--1.10-yb-2.1.sql */
...
CREATE OR REPLACE FUNCTION pg_stat_statements(IN showtext boolean,
    ...
    OUT read_restart_retries int8,
    OUT total_retries int8,
    OUT docdb_obsolete_rows_scanned int8,
    OUT docdb_seeks int8,
    OUT docdb_nexts int8,
    OUT docdb_prevs int8,
    OUT docdb_read_time float8,
    OUT docdb_write_time float8
)
RETURNS SETOF record
AS 'MODULE_PATHNAME', 'yb_2_1_pg_stat_statements_1_10'
LANGUAGE C STRICT VOLATILE PARALLEL SAFE;
