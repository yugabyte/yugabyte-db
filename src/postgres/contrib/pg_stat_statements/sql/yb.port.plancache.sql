...
-- YB note: YB EXPLAIN labels the constant-folded Result node "Result *RESULT*" (vs upstream
-- "Result"); cosmetic. generic_plan_calls / custom_plan_calls match upstream exactly.
