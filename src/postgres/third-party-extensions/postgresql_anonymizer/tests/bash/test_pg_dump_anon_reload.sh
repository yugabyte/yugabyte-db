...
createdb $DB_TARGET
$PSQL $DB_TARGET -c "ALTER DATABASE $DB_TARGET SET session_preload_libraries = 'anon';"
$PSQL $DB_TARGET -c "CREATE EXTENSION anon CASCADE;"
$PSQL $DB_TARGET -c "SELECT anon.init();"
