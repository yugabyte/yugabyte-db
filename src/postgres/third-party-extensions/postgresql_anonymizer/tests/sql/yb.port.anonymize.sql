...
BEGIN; -- YB: anon.anonymize_table('employee') is incorrect, transaction block masks the issue
...
DROP TABLE stock CASCADE; -- YB: workaround for lack of transactional DDL
DROP TABLE call_history CASCADE; -- YB: workaround for lack of transactional DDL
DROP TABLE profile CASCADE; -- YB: workaround for lack of transactional DDL
