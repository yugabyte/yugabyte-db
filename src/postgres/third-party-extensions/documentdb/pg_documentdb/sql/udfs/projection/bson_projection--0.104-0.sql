...
CREATE OR REPLACE FUNCTION __API_SCHEMA_INTERNAL_V2__.bson_dollar_project(document __CORE_SCHEMA_V2__.bson, pathSpec __CORE_SCHEMA_V2__.bson, variableSpec __CORE_SCHEMA_V2__.bson, collationString text)
 RETURNS __CORE_SCHEMA_V2__.bson
 LANGUAGE c
...
CREATE OR REPLACE FUNCTION __API_SCHEMA_INTERNAL_V2__.bson_dollar_add_fields(document __CORE_SCHEMA_V2__.bson, pathSpec __CORE_SCHEMA_V2__.bson, letVariableSpec __CORE_SCHEMA_V2__.bson, collationString text)
 RETURNS __CORE_SCHEMA_V2__.bson
 LANGUAGE c
 IMMUTABLE PARALLEL SAFE CALLED ON NULL INPUT
AS 'MODULE_PATHNAME', $function$bson_dollar_add_fields$function$;
...
CREATE OR REPLACE FUNCTION __API_SCHEMA_INTERNAL_V2__.bson_dollar_replace_root(document __CORE_SCHEMA_V2__.bson, pathSpec __CORE_SCHEMA_V2__.bson, variableSpec __CORE_SCHEMA_V2__.bson, collationString text)
 RETURNS __CORE_SCHEMA_V2__.bson
 LANGUAGE c
 IMMUTABLE PARALLEL SAFE CALLED ON NULL INPUT
AS 'MODULE_PATHNAME', $function$bson_dollar_replace_root$function$;
...
-- DROP bson_dollar_merge_documents(bson, bson) in favor of bson_merge_documents(bson, bson, bool)
DROP FUNCTION IF EXISTS __API_SCHEMA_INTERNAL_V2__.bson_dollar_merge_documents(__CORE_SCHEMA__.bson, __CORE_SCHEMA__.bson);

CREATE OR REPLACE FUNCTION __API_SCHEMA_INTERNAL_V2__.bson_dollar_merge_documents(document __CORE_SCHEMA__.bson, pathSpec __CORE_SCHEMA__.bson, overrideArray bool)
 RETURNS __CORE_SCHEMA__.bson
 LANGUAGE c
 IMMUTABLE PARALLEL SAFE STRICT
