 ...
 */
DROP FUNCTION IF EXISTS __API_SCHEMA_V2__.empty_data_table;
...
AS $fn$
BEGIN
		RETURN QUERY EXECUTE format($$SELECT 0::bigint, null::__CORE_SCHEMA_V2__.bson, null::__CORE_SCHEMA_V2__.bson, null::timestamptz WHERE false$$);
END;
$fn$ LANGUAGE plpgsql;
