...
SELECT partman.create_parent('partman_test.time_taptest_table', 'col3', 'partman', 'daily');
...
SELECT partman.undo_partition('partman_test.time_taptest_table', 20, p_keep_table := false);
