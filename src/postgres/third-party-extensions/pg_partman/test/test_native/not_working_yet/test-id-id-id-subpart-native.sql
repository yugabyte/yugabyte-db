-- ########## NATIVE ID PARENT / ID SUBPARENT / ID SUB-SUB-PARENT ##########
-- May have to increase max_locks_per_transaction above the default 64 for this test to run properly
--TODO comment out cluster index stuff until native supports it
...
SELECT create_parent('partman_test.id_taptest_table', 'col1', 'native', '10000', p_jobmon := false, p_premake := 10);
...
-- Restore when native supports cluster
...
SELECT create_sub_parent('partman_test.id_taptest_table', 'col1', 'native', '1000', p_jobmon := false, p_premake := 2, p_native_check := 'yes');
...
SELECT has_partition('partman_test', 'id_taptest_table_p100000', 'Check id_taptest_table_p100000 is natively partitioned');
SELECT has_partition('partman_test', 'id_taptest_table_p110000', 'Check id_taptest_table_p110000 is natively partitioned');
SELECT has_partition('partman_test', 'id_taptest_table_p120000', 'Check id_taptest_table_p120000 is natively partitioned');
SELECT has_partition('partman_test', 'id_taptest_table_p90000', 'Check id_taptest_table_p90000 is natively partitioned');
SELECT has_partition('partman_test', 'id_taptest_table_p80000', 'Check id_taptest_table_p80000 is natively partitioned');
...
SELECT create_sub_parent('partman_test.id_taptest_table_p0', 'col1', 'partman', '100', p_jobmon := false, p_premake := 2, p_native_check := 'yes');
SELECT create_sub_parent('partman_test.id_taptest_table_p10000', 'col1', 'partman', '100', p_jobmon := false, p_premake := 2, p_native_check := 'yes');
SELECT create_sub_parent('partman_test.id_taptest_table_p20000', 'col1', 'partman', '100', p_jobmon := false, p_premake := 2, p_native_check := 'yes');
SELECT create_sub_parent('partman_test.id_taptest_table_p30000', 'col1', 'partman', '100', p_jobmon := false, p_premake := 2, p_native_check := 'yes');
SELECT create_sub_parent('partman_test.id_taptest_table_p40000', 'col1', 'partman', '100', p_jobmon := false, p_premake := 2, p_native_check := 'yes');
SELECT create_sub_parent('partman_test.id_taptest_table_p50000', 'col1', 'partman', '100', p_jobmon := false, p_premake := 2, p_native_check := 'yes');
SELECT create_sub_parent('partman_test.id_taptest_table_p60000', 'col1', 'partman', '100', p_jobmon := false, p_premake := 2, p_native_check := 'yes');
SELECT create_sub_parent('partman_test.id_taptest_table_p70000', 'col1', 'partman', '100', p_jobmon := false, p_premake := 2, p_native_check := 'yes');
SELECT create_sub_parent('partman_test.id_taptest_table_p80000', 'col1', 'partman', '100', p_jobmon := false, p_premake := 2, p_native_check := 'yes');
SELECT create_sub_parent('partman_test.id_taptest_table_p90000', 'col1', 'partman', '100', p_jobmon := false, p_premake := 2, p_native_check := 'yes');
SELECT create_sub_parent('partman_test.id_taptest_table_p100000', 'col1', 'partman', '100', p_jobmon := false, p_premake := 2, p_native_check := 'yes');
SELECT create_sub_parent('partman_test.id_taptest_table_p110000', 'col1', 'partman', '100', p_jobmon := false, p_premake := 2, p_native_check := 'yes');
SELECT create_sub_parent('partman_test.id_taptest_table_p120000', 'col1', 'partman', '100', p_jobmon := false, p_premake := 2, p_native_check := 'yes');
...
-- TODO Add has_partition check for all new sub-partitions
SELECT has_partition('partman_test', 'id_taptest_table_p100000_p100000', 'Check id_taptest_table_p100000_p100000 is natively partitioned');
SELECT has_table('partman_test', 'id_taptest_table_p110000_p110000', 'Check id_taptest_table_p110000_p110000 exists');
SELECT has_table('partman_test', 'id_taptest_table_p120000_p120000', 'Check id_taptest_table_p120000_p120000 exists');
SELECT has_table('partman_test', 'id_taptest_table_p90000_p90000', 'Check id_taptest_table_p90000_p90000 exists');
SELECT has_table('partman_test', 'id_taptest_table_p80000_p80000', 'Check id_taptest_table_p80000_p80000 exists');
...
UPDATE part_config SET premake = 11 WHERE parent_table LIKE 'partman_test.id_taptest_table%' AND partition_type = 'native';
SELECT run_maintenance();
...
-- UNDO ALL THE THINGS!!
SELECT throws_matching('SELECT rows_undone::int FROM undo_partition_native(''partman_test.id_taptest_table'', ''partman_test.undo_taptest'', 20, p_keep_table := false)',
...
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_native(''partman_test.id_taptest_table_p0_p0'', ''partman_test.undo_taptest'', 20, p_keep_table := false)::int', ARRAY[999], 'Undo partitioning for parent table partman_test.id_taptest_table_p0_p0');

SELECT results_eq('SELECT rows_undone::int FROM undo_partition_native(''partman_test.id_taptest_table_p0_p1000'', ''partman_test.undo_taptest'', 20, p_keep_table := false)::int', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p0_p1000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_native(''partman_test.id_taptest_table_p0_p2000'', ''partman_test.undo_taptest'', 20, p_keep_table := false)::int', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p0_p2000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_native(''partman_test.id_taptest_table_p0_p3000'', ''partman_test.undo_taptest'', 20, p_keep_table := false)::int', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p0_p3000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_native(''partman_test.id_taptest_table_p0_p4000'', ''partman_test.undo_taptest'', 20, p_keep_table := false)::int', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p0_p4000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_native(''partman_test.id_taptest_table_p0_p5000'', ''partman_test.undo_taptest'', 20, p_keep_table := false)::int', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p0_p5000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_native(''partman_test.id_taptest_table_p0_p6000'', ''partman_test.undo_taptest'', 20, p_keep_table := false)::int', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p0_p6000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_native(''partman_test.id_taptest_table_p0_p7000'', ''partman_test.undo_taptest'', 20, p_keep_table := false)::int', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p0_p7000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_native(''partman_test.id_taptest_table_p0_p8000'', ''partman_test.undo_taptest'', 20, p_keep_table := false)::int', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p0_p8000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_native(''partman_test.id_taptest_table_p0_p9000'', ''partman_test.undo_taptest'', 20, p_keep_table := false)::int', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p0_p9000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_native(''partman_test.id_taptest_table_p10000_p10000'', ''partman_test.undo_taptest'', 20, p_keep_table := false)::int', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p10000_p10000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_native(''partman_test.id_taptest_table_p10000_p11000'', ''partman_test.undo_taptest'', 20, p_keep_table := false)::int', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p10000_p11000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_native(''partman_test.id_taptest_table_p10000_p12000'', ''partman_test.undo_taptest'', 20, p_keep_table := false)::int', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p10000_p12000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_native(''partman_test.id_taptest_table_p10000_p13000'', ''partman_test.undo_taptest'', 20, p_keep_table := false)::int', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p10000_p13000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_native(''partman_test.id_taptest_table_p10000_p14000'', ''partman_test.undo_taptest'', 20, p_keep_table := false)::int', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p10000_p14000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_native(''partman_test.id_taptest_table_p10000_p15000'', ''partman_test.undo_taptest'', 20, p_keep_table := false)::int', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p10000_p15000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_native(''partman_test.id_taptest_table_p10000_p16000'', ''partman_test.undo_taptest'', 20, p_keep_table := false)::int', ARRAY[1000], 'Undo partitioning for parent table partman_test.id_taptest_table_p10000_p16000');
SELECT results_eq('SELECT rows_undone::int FROM undo_partition_native(''partman_test.id_taptest_table_p10000_