                                            ...
                                            char *schema_name, char *seq_name)
{
    ...
    label_id_func_name = list_make2(makeString("mag_catalog"), /* YB */
     ...
     */
    graphid_func_name = list_make2(makeString("mag_catalog"), /* YB */
                                   makeString("_graphid"));
...
static Constraint *build_properties_default(void)
{
    ...
    func_name = list_make2(makeString("mag_catalog"), /* YB */
