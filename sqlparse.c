...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_X_IDENT = 3,                    /* X_IDENT  */
  YYSYMBOL_X_NCONST = 4,                   /* X_NCONST  */
  YYSYMBOL_X_SCONST = 5,                   /* X_SCONST  */
  YYSYMBOL_X_OP = 6,                       /* X_OP  */
  YYSYMBOL_X_PARAM = 7,                    /* X_PARAM  */
  YYSYMBOL_X_COMMENT = 8,                  /* X_COMMENT  */
  YYSYMBOL_X_WHITESPACE = 9,               /* X_WHITESPACE  */
  YYSYMBOL_X_KEYWORD = 10,                 /* X_KEYWORD  */
  YYSYMBOL_X_OTHERS = 11,                  /* X_OTHERS  */
  YYSYMBOL_X_TYPECAST = 12,                /* X_TYPECAST  */
  YYSYMBOL_YYACCEPT = 13,                  /* $accept  */
  YYSYMBOL_root = 14,                      /* root  */
  YYSYMBOL_elements = 15,                  /* elements  */
  YYSYMBOL_anyelement = 16                 /* anyelement  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "X_IDENT", "X_NCONST",
  "X_SCONST", "X_OP", "X_PARAM", "X_COMMENT", "X_WHITESPACE", "X_KEYWORD",
  "X_OTHERS", "X_TYPECAST", "$accept", "root", "elements", "anyelement", YY_NULLPTR
};
  ...
  for (;;)
    {
      ...
      yydestruct ("Error: popping",
                  YY_ACCESSING_SYMBOL (yystate), yyvsp, yylsp, result);
      YYPOPSTACK (1);
      yystate = *yyssp;
      YY_STACK_PRINT (yyss, yyssp);
    }
  ...
  while (yyssp != yyss)
    {
      yydestruct ("Cleanup: popping",
                  YY_ACCESSING_SYMBOL (+*yyssp), yyvsp, yylsp, result);
      YYPOPSTACK (1);
    }
#ifndef yyoverflow
  if (yyss != yyssa)
