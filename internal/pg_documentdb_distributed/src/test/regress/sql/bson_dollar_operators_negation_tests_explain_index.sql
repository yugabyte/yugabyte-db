...
SET helio_api.next_collection_id TO 5140;
SET helio_api.next_collection_index_id TO 5140;
...
SELECT helio_api_internal.create_indexes_non_concurrently('db', '{ "createIndexes": "negation_tests_explain", "indexes": [{ "key": { "$**": 1 }, "name": "myIdx1" }] }'::helio_core.bson, true);
