...
-- 2d and 2d with pfe
SELECT helio_api_internal.create_indexes_non_concurrently('db', '{"createIndexes": "geoquerytest", "indexes": [{"key": {"a.b": "2d"}, "name": "my_2d_ab_idx" }]}', true);
SELECT helio_api_internal.create_indexes_non_concurrently('db', '{"createIndexes": "geoquerytest", "indexes": [{"key": {"d": "2d"}, "name": "my_2d_idx_pfe", "partialFilterExpression" : {"e": { "$gte": 5} } }]}', true);

-- 2dsphere and 2dsphere with pfe
SELECT helio_api_internal.create_indexes_non_concurrently('db', '{"createIndexes": "geoquerytest", "indexes": [{"key": {"geo.loc": "2dsphere"}, "name": "my_2ds_geoloc_idx" }]}', true);
SELECT helio_api_internal.create_indexes_non_concurrently('db', '{"createIndexes": "geoquerytest", "indexes": [{"key": {"largeGeo": "2dsphere"}, "name": "my_2ds_largegeo_idx" }]}', true);
SELECT helio_api_internal.create_indexes_non_concurrently('db', '{"createIndexes": "geoquerytest", "indexes": [{"key": {"d": "2dsphere"}, "name": "my_2ds_idx_pfe", "partialFilterExpression" : {"e": { "$gte": 5} } }]}', true);
SELECT helio_api_internal.create_indexes_non_concurrently('db', '{"createIndexes": "geoquerytest", "indexes": [{"key": {"geoA": "2dsphere", "geoB": "2dsphere"}, "name": "my_2dsgeo_a_or_b_idx" }]}', true);
...
SELECT helio_api_internal.create_indexes_non_concurrently('db', '{"createIndexes": "geoquerytest", "indexes": [{"key": {"geo.loc": 1}, "name": "my_regular_geo.loc_idx" }]}', true);
...
SELECT helio_api.insert_one('db','geoquerytest','{ "_id" : 401, "a" : { "b": [70, 70] } }', NULL);
SELECT helio_api.insert_one('db','geoquerytest','{ "_id" : 402, "a" : { "b": [80, 80] } }', NULL);
SELECT helio_api.insert_one('db','geoquerytest','{ "_id" : 403, "a" : { "b": [90, 90] } }', NULL);
